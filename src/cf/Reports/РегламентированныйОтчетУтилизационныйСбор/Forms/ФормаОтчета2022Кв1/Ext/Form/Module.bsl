...
Процедура ВывестиНаПечатьДанныеМногоуровневогоРаздела(СтруктураПараметров, ОбщиеРеквизитыРазделов, СтрПоля)
	...
	Если ИмяТекРаздела = "Сведения" ИЛИ ИмяТекРаздела = "Раздел1" Тогда
		...
		МакетР = ОбъектОтчета(ЭтаФорма.ИмяФормы).ПолучитьМакет(Сред(
	...
	ИначеЕсли ИмяТекРаздела = "Раздел2" Тогда
		...
		ЭтаФорма.ИмяФормы, СтрНайти(ЭтаФорма.ИмяФормы, "ФормаОтчета")) + "_Раздел3");;
...
Процедура ПроверкаКС_2_12()
	...
	Заголовки.Вставить("Описание"			, "Идентификационный номер транспортного средства (VIN) в стр.050 Раздела 3 " +
		"должен быть уникальным для всех страниц Раздела 3 Расчета");
	...
	Заголовки.Вставить("Рекомендации"		, "Удалите/исправьте дубли идентификационных номеров");
	Заголовки.Вставить("Основание"			, НСтр("ru='Письмо ФНС России от 04.03.2024 № СД-4-3/2448@'"));
	Заголовки.Вставить("ШаблонДопСведений"	, "Страница %1 Раздела 3");
	ПодготовитьНастройки(Заголовки);
...
Процедура ПроверкаКС_2_15()
	...
	Заголовки.Вставить("Описание"			, "Серия и номер паспорта транспортного средства в стр.180 Раздела 3 " +
		"должны быть уникальными для всех страниц Раздела 3 Расчета");
	Заголовки.Вставить("ШаблонДетализации"	, "Неуникальное значение %1");
	Заголовки.Вставить("Нарушение"			, "Повторяющиеся значения серии и номера паспорта ТС");
	Заголовки.Вставить("Рекомендации"		, "Удалите/исправьте дубли серии и номера паспорта ТС");
	Заголовки.Вставить("Основание"			, НСтр("ru='Письмо ФНС России от 04.03.2024 № СД-4-3/2448@'"));
	Заголовки.Вставить("ШаблонДопСведений"	, "Страница %1 Раздела 3");
	ПодготовитьНастройки(Заголовки);
