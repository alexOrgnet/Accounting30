...
Процедура ПриОткрытии(Отказ)
	...
	ИначеЕсли Не ИнформационнаяБазаФайловая И Не Отчет.РежимРасшифровки Тогда
...
Функция СформироватьОтчетНаСервере() Экспорт
	...
	ПараметрыОтчета = Отчеты.АнализФинансовыхРезультатов.ПустыеПараметрыКомпоновкиОтчета();
	Отчеты.АнализФинансовыхРезультатов.ЗаполнитьПараметрыИзФормы(ПараметрыОтчета, ЭтотОбъект);
...
&НаСервере
Функция ПодготовитьПараметрыОтчетаНаСервере(ПараметрыОтчета)
...
Функция НастройкиОтчетаДляСтатистики(ПараметрыОтчета)
	...
	ПодготовитьПараметрыОтчетаНаСервере(ПараметрыОтчета);
