...
Функция ТаблицаФормОтчета() Экспорт
	...
	НоваяФорма.ОписаниеОтчета     = "Письмо ФНС России от 26.01.2024 № СД-4-3/740@.";
	НоваяФорма.РедакцияФормы      = "от 26.01.2024 № СД-4-3/740@.";
...
Функция ДеревоФормИФорматов() Экспорт
	...
	"1151165", '2024-01-26', "СД-4-3/740@", "ФормаОтчета2024Кв1");
