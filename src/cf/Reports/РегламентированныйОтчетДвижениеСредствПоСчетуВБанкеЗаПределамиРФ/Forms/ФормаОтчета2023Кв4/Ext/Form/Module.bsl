...
Процедура ТабличныйДокументПриИзмененииСодержимогоОбласти(Элемент, Область)
	...
	Если СтрНачинаетсяС(ИмяПоказателя, "П000Л5М100001") ИЛИ СтрНачинаетсяС(ИмяПоказателя, "П000Л7М100001") Тогда
...
Процедура ОчисткаРегламентированногоОтчетаНаСервере(ИмяСтраницы) Экспорт
	...
	Иначе
		...
		Если ИмяСтраницы = "Лист2" ИЛИ ИмяСтраницы = "Лист9" Тогда
