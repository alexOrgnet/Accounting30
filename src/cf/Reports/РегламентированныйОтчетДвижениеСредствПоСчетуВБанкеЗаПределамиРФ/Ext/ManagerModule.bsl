...
Функция ТаблицаФормОтчета() Экспорт
	...
	// С 01.03.2024 применяется только редакция "ФормаОтчета2023Кв4".
	//
	НоваяФорма = ТаблицаФормОтчета.Добавить();
	НоваяФорма.ФормаОтчета        = "ФормаОтчета2023Кв4";
	НоваяФорма.ОписаниеОтчета
	= "Постановление Правительства РФ от 28.12.2005 № 819 (в ред. постановления Правительства РФ от 14.11.2023 № 1911).";
	НоваяФорма.РедакцияФормы      = "от 14.11.2023 № 1911.";
