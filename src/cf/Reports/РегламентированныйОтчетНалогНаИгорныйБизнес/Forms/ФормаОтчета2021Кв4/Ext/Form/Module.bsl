...
Процедура ПроверитьСтавкуНалогаНаВхождениеВДопустимыйИнтервал(Область)
	...
	ИначеЕсли Область.Имя = "П000020013003" ИЛИ Область.Имя = "П000020014003" Тогда
	...
	Если ЗначениеЗаполнено(СтавкаМинимальная) И ЗначениеЗаполнено(СтавкаМаксимальная)
