...
Функция ПроверитьДокумент(Объект, ИмяФормы, УникальныйИдентификатор) Экспорт
	Если ИмяФормы = "Форма2014_1" Тогда
		РегламентированнаяОтчетность.СообщитьПользователюОбОшибкеВУведомлении(
			"Устаревшая редакция формы.", УникальныйИдентификатор);
	ИначеЕсли ИмяФормы = "Форма2020_4" Или ИмяФормы = "Форма2024_1" Тогда
		Попытка
...
Функция ПолучитьТаблицуФорм() Экспорт
	...
	ПолноеОписаниеФормы.ДатаКонца  = '2024-02-17';
