...
Процедура СформироватьСтруктуруРеквизитовФормы()
	...
	РегламентированнаяОтчетность.ДополнитьРеквизитыСтатистическогоОтчетаДляЗагрузкиСправочников(ЭтотОбъект);
...
Процедура СформироватьСпискиВыбора()
	...
	РегламентированнаяОтчетность.ДобавитьСтрокуОписанияВвода(СвойстваПоказателей, "s_okpd2_ei_50_2024", 512, , "Выбор кода");
	...
	ИначеЕсли Не СтруктураРеквизитовФормы.мАвтоВыборКодов Тогда
		...
		ИначеЕсли СтрНайти(Область.Имя, "П000500103_") = 1 Тогда
			...
			Если НомСтр = "50" Тогда
				ИмяСправочника = "s_okpd2_ei_50_2024";
