...
Процедура ПроверкаКС_1_01()
	...
	Заголовки.Вставить("Описание"			, НСтр("ru='Сумма налога к уплате в стр.030 Раздела 1 = '") +
		НСтр("ru='стр.(031 + 032 + 033 + 034 + 035) Раздела 1 + стр.070 Раздела 1.1, в рублях, '") +
		НСтр("ru='если левая часть < правой'"));
	...
	Заголовки.Вставить("Рекомендации"		, НСтр("ru='Уточните сумму налога к уплате в стр.030 Раздела 1'"));
	Заголовки.Вставить("Основание"			, НСтр("ru='Раздел 3 Приложения 18 к Договору о Евразийском экономическом союзе'"));
	...
	НастройкиКС.ЭтоОшибка = Показатели.Р01С030.Значение < РасчетнаяСумма;
...
Процедура ПроверкаКС_1_02()
	...
	Заголовки.Вставить("Описание"			, НСтр("ru='Сумма акциза к уплате в стр.030 Раздела 2 = '") +
		НСтр("ru='сумме стр.050 Раздела 2, в рублях, по соответствующим кодам ОКТМО и КБК, '") +
		НСтр("ru='если левая часть < правой'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма акциза к уплате'"));
	Заголовки.Вставить("Рекомендации"		, НСтр("ru='Уточните сумму акциза к уплате в стр.030 Раздела 2'"));
	Заголовки.Вставить("Основание"			, НСтр("ru='Раздел 3 Приложения 18 к Договору о Евразийском экономическом союзе'"));
	...
	Для каждого ВеткаР2 Из ДанныеКС.Раздел2.Строки Цикл
		...
		Для каждого СтрокаМнЧ1 Из ДеревоМнЧ1.Строки Цикл
			...
			НастройкиКС.ЭтоОшибка = Показатели.Р02С030.Значение < Показатели.Р02С050.Итог;
			НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации,
...
Процедура ПроверкаКС_1_03()
	...
	Заголовки.Вставить("Описание"			, НСтр("ru='Сумма акциза к уплате в стр.030 Раздела 3 = '") +
		НСтр("ru='сумме стр.050 Раздела 3, в рублях, по соответствующим кодам ОКТМО и КБК, '") +
		НСтр("ru='если левая часть < правой'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма акциза к уплате'"));
	Заголовки.Вставить("Рекомендации"		, НСтр("ru='Уточните сумму акциза к уплате в стр.030 Раздела 3'"));
	Заголовки.Вставить("Основание"			, НСтр("ru='Раздел 3 Приложения 18 к Договору о Евразийском экономическом союзе'"));
	...
	Для каждого ВеткаР3 Из ДанныеКС.Раздел3.Строки Цикл
		...
		Для каждого СтрокаМнЧ1 Из ДеревоМнЧ1.Строки Цикл
			...
			НастройкиКС.ЭтоОшибка = Показатели.Р03С030.Значение < Показатели.Р03С050.Итог;
			НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации,
...
Процедура ПроверкаКС_1_04()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма налога к уплате'"));
	Заголовки.Вставить("Рекомендации"		, НСтр("ru='Укажите сумму налога к уплате в стр.030 Раздела 1 >= 0'"));
