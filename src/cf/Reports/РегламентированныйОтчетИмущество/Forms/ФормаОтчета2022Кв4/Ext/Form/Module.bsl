...
Процедура ТабличныйДокументПриИзмененииСодержимогоОбласти(Элемент, Область)
	...
	Если СтрНачинаетсяС(ИмяПоказателя, "П000030009003_Числ") И ЗначПоказателя > 12 Тогда
		Область.Значение = 0;
		Сообщение = Новый СообщениеПользователю;
		Сообщение.Текст = НСтр("ru='Числитель коэффициента Кв не должен быть больше 12. Значение очищено'");
		Сообщение.Сообщить();
	ИначеЕсли СтрНачинаетсяС(ИмяПоказателя, "П000030009003_Знам") И ЗначПоказателя > 12 Тогда
		Область.Значение = 0;
		Сообщение = Новый СообщениеПользователю;
		Сообщение.Текст = НСтр("ru='Знаменатель коэффициента Кв не должен быть больше 12. Значение очищено'");
		Сообщение.Сообщить();
	ИначеЕсли СтрНачинаетсяС(ИмяПоказателя, "П000030009003") И ТабличныйДокумент.Области["П000030009003_Знам"].Значение > 0
		...
		Область.Значение = 0;
		Сообщение = Новый СообщениеПользователю;
		Сообщение.Текст = НСтр("ru='Числитель коэффициента Кв не должен быть больше знаменателя. Значение очищено'");
		Сообщение.Сообщить();
	КонецЕсли;
	...
	Если СтрНачинаетсяС(ИмяПоказателя, "П000030009503_Числ") И ЗначПоказателя > 12 Тогда
		Область.Значение = 0;
		Сообщение = Новый СообщениеПользователю;
		Сообщение.Текст = НСтр("ru='Числитель коэффициента Ки не должен быть больше 12. Значение очищено'");
		Сообщение.Сообщить();
	ИначеЕсли СтрНачинаетсяС(ИмяПоказателя, "П000030009503_Знам") И ЗначПоказателя > 12 Тогда
		Область.Значение = 0;
		Сообщение = Новый СообщениеПользователю;
		Сообщение.Текст = НСтр("ru='Знаменатель коэффициента Ки не должен быть больше 12. Значение очищено'");
		Сообщение.Сообщить();
	ИначеЕсли СтрНачинаетсяС(ИмяПоказателя, "П000030009503") И ТабличныйДокумент.Области["П000030009503_Знам"].Значение > 0
		...
		Область.Значение = 0;
		Сообщение = Новый СообщениеПользователю;
		Сообщение.Текст = НСтр("ru='Числитель коэффициента Ки не должен быть больше знаменателя. Значение очищено'");
		Сообщение.Сообщить();
	КонецЕсли;
