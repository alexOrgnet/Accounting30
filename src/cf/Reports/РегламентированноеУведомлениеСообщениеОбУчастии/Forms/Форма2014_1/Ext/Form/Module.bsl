...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если РегламентированнаяОтчетностьПереопределяемый.ЭтоЮридическоеЛицо(Объект.Организация) Тогда 
		...
		ПредставлениеСообщения.Области.П_ОГРНИП.ЦветФона = ЦветаСтиля.ЦветМакетаБРОФон;
	...
	Иначе
		...
		ПредставлениеСообщения.Области.П_ОГРН.ЦветФона = ЦветаСтиля.ЦветМакетаБРОФон;
