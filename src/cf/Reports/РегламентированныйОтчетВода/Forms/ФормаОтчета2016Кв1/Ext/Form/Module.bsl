...
Процедура СформироватьДанныеОтчета()
	...
	Раздел1 = Новый Массив;
	ТаблицаРаздела1 = ДанныеОтчета.ДанныеМногостраничныхРазделов.Раздел1;
	
	Для каждого ДанныеСтраницы Из ТаблицаРаздела1 Цикл
		...
		СтраницаРаздела.Вставить("Страница", "" + (ТаблицаРаздела1.Индекс(ДанныеСтраницы) + 1));
	    СтраницаРаздела.Вставить("КолвоСтрокР01", КоличествоСтрок(СтраницаРаздела, "П000100003003_"));
		
	    Раздел1.Добавить(СтраницаРаздела);
		
	КонецЦикла;
	
	ДанныеКС.Вставить("Раздел1", Раздел1);
