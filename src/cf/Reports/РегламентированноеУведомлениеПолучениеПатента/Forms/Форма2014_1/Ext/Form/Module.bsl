...
Процедура УстановитьДанныеПоРегистрацииВИФНС()
	...
	ДанныеПредставителя = РегистрацияВНОСервер.ДанныеРегистрации(РегистрацияВИФНС);
	...
	Если ЗначениеЗаполнено(Представитель) Тогда
		...
		Если ПредставлениеУведомления.Области.Количество() > 0 Тогда 
			...
			ПредставлениеУведомления.Области["ДОКУМЕНТ_ПРЕДСТАВИТЕЛЯ"].Значение = ДанныеПредставителя.ДокументПредставителя;
		КонецЕсли;
		ТитульнаяСтраница[0].ПРИЗНАК_НП_ПОДВАЛ = "2";
		ТитульнаяСтраница[0].ДОКУМЕНТ_ПРЕДСТАВИТЕЛЯ = ДанныеПредставителя.ДокументПредставителя;
	Иначе
