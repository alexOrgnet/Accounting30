...
Функция ДеревоФормИФорматов() Экспорт
	...
	Форма20111201 = ОпределитьФормуВДеревеФормИФорматов(ФормыИФорматы, "710099", '2011-10-05', "124н", "ФормаОтчета2011Кв4", '0001-01-01', '2011-12-31');
	ОпределитьФорматВДеревеФормИФорматов(Форма20111201, "5.02");
	
	Форма20120101 = ОпределитьФормуВДеревеФормИФорматов(ФормыИФорматы, "710099", '2011-10-05', "124н", "ФормаОтчета2011Кв4", '2012-01-01', '2012-12-31');
	ОпределитьФорматВДеревеФормИФорматов(Форма20120101, "5.04");
	
	Форма20130101 = ОпределитьФормуВДеревеФормИФорматов(ФормыИФорматы, "710099", '2011-10-05', "124н", "ФормаОтчета2011Кв4", '2013-01-01', '2014-12-31');
	ОпределитьФорматВДеревеФормИФорматов(Форма20130101, "5.05");
