...
Функция ПроверитьДокументСВыводомВТаблицу_Форма2022_1(Данные, УникальныйИдентификатор)
	...
	Для Каждого Стр Из Данные.ДанныеМногостраничныхРазделов.СведОбПодрИО Цикл
		...
		УведомлениеОСпецрежимахНалогообложения.ПроверкаКПП(СведОбПодрИО, ТаблицаОшибок, "СведОбПодрИО", "КПП", Истина);
		...
		КонецЕсли;
		УведомлениеОСпецрежимахНалогообложения.ПроверкаКодаНО(СведОбПодрИО.КодНОПодр, ТаблицаОшибок, "СведОбПодрИО", "КодНОПодр", СведОбПодрИО.УИД);
