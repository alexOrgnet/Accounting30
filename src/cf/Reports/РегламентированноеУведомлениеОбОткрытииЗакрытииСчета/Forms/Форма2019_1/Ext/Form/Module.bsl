...
Процедура ДоступностьОбластиКоррФайл()
	Если ТекущееИДНаименования = "Титульная" Тогда
		...
		ОФ.ЦветФона = ?(ЗначениеЗаполнено(ПредставлениеУведомления.Области.НомКорр.Значение), ЭтотОбъект["ЦФЖ"], ЭтотОбъект["ЦФБ"]);
		...
		ОФ.ЦветФона = ?(ЭтоЮЛ, ЭтотОбъект["ЦФЖ"], ЭтотОбъект["ЦФБ"]);
