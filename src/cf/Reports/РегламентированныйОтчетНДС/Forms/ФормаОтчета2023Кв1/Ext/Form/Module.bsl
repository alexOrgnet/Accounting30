...
&НаСервере
Процедура ПроверкаКС_1_1_0_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru='Раздел 2'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru='1.1.к'"));
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма НДС, подлежащая уплате в бюджет'"));
	...
	Заголовки.Вставить("Комментарий"		, 
		НСтр("ru='Критическая проверка. Возможно срабатывание в результате влияния погрешности округления показателей'"));
	...
	НастройкиКС.ЭтоОшибка = Код1011715Отсутствует И НЕ Показатели.Р02С060.Итог = Окр(РасчетнаяСумма);
...
&НаСервере
Процедура ПроверкаКС_1_2_1_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru='Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru='1.2.1.к'"));
...
&НаСервере
Процедура ПроверкаКС_1_2_2_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru='Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru='1.2.2.к'"));
...
&НаСервере
Процедура ПроверкаКС_1_2_3_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru='Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru='1.2.3.к'"));
	Заголовки.Вставить("Описание"			, НСтр("ru='Сумма налога в стр.090 Раздела 1 >= 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 >= 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, "Укажите сумму НДС в стр.090 Раздела 1 >= 0");
	Заголовки.Вставить("Основание"			, НСтр("ru=''"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru='Критическая проверка'"));
	ПодготовитьНастройки(Заголовки);
	...
	ЗаполнитьИРасшифроватьПоказатели(Показатели, ДанныеКС.ДанныеР01);
	НастройкиКС.ЭтоОшибка = Показатели.Р01С090.Значение < 0;
	НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации,
		Показатели.Р01С090.Значение);
	ДополнитьТаблицуРезультата();
	
КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_1_2_4_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru='Раздел 2'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru='1.2.4.к'"));
...
Процедура ПроверкаКС_1_02()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибка исчисления суммы НДС, подлежащей вычету'"));
...
Процедура ПроверкаКС_1_04()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма НДС, подлежащая вычету'"));
...
Процедура ПроверкаКС_1_05()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 >= %5 (%2 + %3 + %4)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма НДС, подлежащая восстановлению'"));
...
Процедура ПроверкаКС_1_08()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 <= %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма НДС, подлежащей возмещению'"));
...
Процедура ПроверкаКС_1_10()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 <= %4 (%2 - %3)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма НДС, исчисленная к возмещению'"));
...
Процедура ПроверкаКС_1_13()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 <= %2'"));
	Заголовки.Вставить("Нарушение"		, 
		НСтр("ru='Ошибочная сумма НДС, подлежащая уплате в бюджет'"));
...
Процедура ПроверкаКС_1_15()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма НДС, подлежащая возмещению'"));
...
Процедура ПроверкаКС_1_21()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная НДС, подлежащая возмещению'"));
...
Процедура ПроверкаКС_1_24()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='Сумма налога в стр.030 Раздела 1 = сумме стр.070 Раздела 12, если стр.030 Раздела 1 > 0, '") +
	...
	НастройкиКС.ЭтоОшибка = ЗначениеЗаполнено(Показатели.Р01С030.Значение) 
		И НЕ Показатели.Р01С030.Значение = Окр(Показатели.Р12С070.Значение);
	НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации,
...
Процедура ПроверкаКС_1_27()
	...
	Заголовки.Вставить("Основание"			, НСтр("ru='Приказ ФНС России от 25.05.2021 N ЕД-7-15/519@'"));
	Заголовки.Вставить("Комментарий"		, 
		НСтр("ru='Критическая проверка. Возможно ложное срабатывание в результате влияния погрешности округления'"));
	ПодготовитьНастройки(Заголовки);
...
Процедура ПроверкаКС_1_55()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 <= %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма НДС, заявленная к возмещению'"));
...
Процедура СформироватьСпискиВыбора()
	...
	МакетСоставаПоказателей = ОбъектОтчета(ЭтаФорма.ИмяФормы).ПолучитьМакет("Списки2023Кв1");
			...
			Для НомСтр = ВерхОбласти По НизОбласти Цикл
				...
				Если КодПоказателя <> "###" Тогда
					...
					ИначеЕсли Область.Имя = "КодыОпераций_Раздел7" Тогда
						...
						Если КодПоказателя = "1011221" И СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета < '20230401' Тогда
...
Процедура СохранитьОтчет(Команда)
	...
	Иначе        
    	Если ОбщегоНазначенияКлиент.ПодсистемаСуществует("РегламентированнаяОтчетность.ЭлектронныйДокументооборотСКонтролирующимиОрганами.ПроверкаВРЭЦ")
			...
			Если ВозможностьРедактированияОтчетаРЭЦ = Ложь Тогда   
				Кнопки = Новый СписокЗначений;
				Кнопки.Добавить(Истина, "Сохранить");
				Кнопки.Добавить(Ложь, "Отмена");
				
				ТекстВопроса = НСтр("ru='Отчет отправлен в сервис ""Мой экспорт"" на проверку.
