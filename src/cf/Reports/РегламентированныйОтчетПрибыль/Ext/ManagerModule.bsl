...
Функция ТаблицаФормОтчета() Экспорт
	...
	НоваяФорма.ОписаниеОтчета
	= "Приложение № 1 к приказу ФНС России от 23.09.2019 № ММВ-7-3/475@ (в ред. приказа ФНС России от 17.08.2022 № СД-7-3/753@).";
...
Функция ДанныеРеглОтчета(ЭкземплярРеглОтчета) Экспорт
	...
	Если ЭкземплярРеглОтчета.ВыбраннаяФорма = "ФормаОтчета2022Кв4"
	...
	Если ОписаниеОтчета.ВыбраннаяФорма = "ФормаОтчета2022Кв4"
		...
		Иначе
			...
			Для Каждого Лист Из ДеревоРаздела.Строки Цикл
				...
				ЗначениеПоказателя = ЗначениеПоказателя + РегламентированнаяОтчетность.ПоказательОтчета(ДанныеЛиста, "П000020006003");
			КонецЦикла;
			...
			Для Каждого СтрокаМнЧ Из ДеревоМнЧ.Строки Цикл
				...
				Для Каждого СтрокаПодчМнЧ Из ДеревоПодчМнЧ.Строки Цикл
					ЗначениеПоказателя = ЗначениеПоказателя + РегламентированнаяОтчетность.ПоказательОтчета(СтрокаПодчМнЧ.Данные, "П00013М204003");
				КонецЦикла;
			КонецЦикла;
			...
			Для Каждого Лист Из ДеревоРаздела.Строки Цикл
				ДанныеЛиста = Лист.Данные;
				ЗначениеПоказателя = ЗначениеПоказателя + РегламентированнаяОтчетность.ПоказательОтчета(ДанныеЛиста, "П000020003003");
			КонецЦикла;
			...
			Для Каждого Лист Из ДеревоРаздела.Строки Цикл
				ДанныеЛиста = Лист.Данные;
				ЗначениеПоказателя = ЗначениеПоказателя + РегламентированнаяОтчетность.ПоказательОтчета(ДанныеЛиста, "П000020001003");
			КонецЦикла;
