...
Процедура СформироватьСпискиВыбора()
	...
	МакетСоставаПоказателей = ОбъектОтчета(ЭтаФорма.ИмяФормы).ПолучитьМакет("СпискиВыбора2022Кв4");
...
&НаСервере
Процедура ПроверкаКС_3_1_1_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru='подраздел 1.1 Раздела 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru='3.1.1.к'"));
	...
	ПроверкаКС_3_1_1_к_код();
	
КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_3_1_1_к_код()
...
&НаСервере
Процедура ПроверкаКС_3_1_2_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru='подраздел 1.1 Раздела 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru='3.1.2.к'"));
	Заголовки.Вставить("Описание"			, 
...
&НаСервере
Процедура ПроверкаКС_3_1_3_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru='подраздел 1.1 Раздела 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru='3.1.3.к'"));
	Заголовки.Вставить("Описание"			, 
...
&НаСервере
Процедура ПроверкаКС_3_1_4_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru='подраздел 1.1 Раздела 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru='3.1.4.к'"));
	Заголовки.Вставить("Описание"			, 
...
Процедура ПроверкаКС_3_5_к()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='Стр.030 подр.1.1 Раздела 1 ≠ '") + ДанныеКС.КБК.КИК + НСтр("ru=', при этом стр.250 Раздела Б2 '") +
		НСтр("ru='Листа 09 > 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 ≠ '") + ДанныеКС.КБК.КИК + НСтр("ru=', %2 > 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Отсутствуют сведения в подр.1.1 Раздела 1'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сведения подр.1.1 Раздела 1");
	Заголовки.Вставить("Основание"			, НСтр("ru=''"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru='Критическая проверка'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru=''"));
	ПодготовитьНастройки(Заголовки);
	...
	Для Счетчик = 1 По ДанныеКС.Раздел1_1.КолвоСтрокП00011М1 Цикл
		...
		УсловиеВыполнено = УсловиеВыполнено И НЕ Показатели.Р11С001.Значение = ДанныеКС.КБК.КИК;
	...
	НастройкиКС.ЭтоОшибка = УсловиеВыполнено И Показатели.Л92С002.Итог > 0;
	НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, 
		Показатели.Л92С002.Итог);
	ДополнитьТаблицуРезультата();
...
&НаСервере
Процедура ПроверкаКС_3_1_5_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru='подраздел 1.2 Раздела 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru='3.1.5.к'"));
	...
	ПроверкаКС_3_1_5_к_код();
	
КонецПроцедуры

&НаСервере
Процедура ПроверкаКС_3_1_5_к_код()
...
&НаСервере
Процедура ПроверкаКС_3_1_6_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru='подраздел 1.2 Раздела 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru='3.1.6.к'"));
...
&НаСервере
Процедура ПроверкаКС_3_1_7_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru='подраздел 1.2 Раздела 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru='3.1.7.к'"));
...
&НаСервере
Процедура ПроверкаКС_3_1_8_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru='подраздел 1.2 Раздела 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru='3.1.8.к'"));
...
&НаСервере
Процедура ПроверкаКС_3_1_9_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru='подраздел 1.2 Раздела 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru='3.1.9.к'"));
...
Процедура ПроверкаКС_3_4_к()
	...
	Заголовки.Вставить("Описание"			, НСтр("ru='Подр.1.3 Раздела 1 не заполнен, при этом стр.120 Листа 03 '") +
		НСтр("ru='(Раздел А) или стр.080 Листа 04 > 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='Подр.1.3 Раздела 1 не заполнен, %1 > 0, %2 > 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Отсутствуют сведения в подр.1.3 Раздела 1'"));
	Заголовки.Вставить("Рекомендации"		, "Заполните подр.1.3 Раздела 1");
	Заголовки.Вставить("Основание"			, НСтр("ru=''"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru='Критическая проверка'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru=''"));
	ПодготовитьНастройки(Заголовки);
	...
	НастройкиКС.ЭтоОшибка = НЕ ДанныеКС.РазделЗаполнен_Раздел1_3 И РасчетнаяСумма > 0;
	НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, 
		Показатели.Л3АС001.Итог, Показатели.Л04С002.Итог);
	ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_3_1_15_к()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 >= 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма авансовых платежей'"));
...
&НаСервере
Процедура ПроверкаКС_3_2_1_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru='Лист 02'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru='3.2.1.к'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='Сумма налога в стр.280 Листа 02 = (стр.220 + стр.250 + стр.268 - стр.190) Листа 02, '") +
...
&НаСервере
Процедура ПроверкаКС_3_2_2_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru='Лист 02'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru='3.2.2.к'"));
	Заголовки.Вставить("Описание"			, 
...
&НаСервере
Процедура ПроверкаКС_3_3_1_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru='Лист 02'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru='3.3.1.к'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='Сумма налога в стр.270 Листа 02 = (стр.190 - стр.220 - стр.250 - стр.268) Листа 02, '") +
		НСтр("ru='если результат > 0, иначе 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = %2 (%3 - %4 - %5 - %6)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму налога в стр.270 Листа 02");
...
&НаСервере
Процедура ПроверкаКС_3_3_2_к()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru='Лист 02'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru='3.3.2.к'"));
	Заголовки.Вставить("Описание"			, 
...
Процедура ПроверкаКС_1_01_1()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму налога в стр.040 подр.1.1 Раздела 1");
	Заголовки.Вставить("Основание"			, НСтр("ru='п.1-3 ст.286 НК РФ'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru=''"));
	ПодготовитьНастройки(Заголовки);
...
Процедура ПроверкаКС_1_09_1()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочный код квартала'"));
...
Процедура ПроверкаКС_1_18_1()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочный срок уплаты'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните срок уплаты в стр.040 подр.1.3 Раздела 1");
	Заголовки.Вставить("Основание"			, НСтр("ru='ст.287 НК РФ'"));
...
Процедура ПроверкаКС_1_19()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму налога в стр.040 подр.1.3 Раздела 1");
	Заголовки.Вставить("Основание"			, НСтр("ru='ст.275 НК РФ'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru=''"));
	ПодготовитьНастройки(Заголовки);
...
Процедура ПроверкаКС_1_19_1()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочный КБК'"));
...
Процедура ПроверкаКС_1_20()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму налога в стр.040 подр.1.3 Раздела 1");
	Заголовки.Вставить("Основание"			, НСтр("ru='ст.281 НК РФ'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru=''"));
	ПодготовитьНастройки(Заголовки);
...
Процедура ПроверкаКС_1_22()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму налога в стр.040 подр.1.3 Раздела 1");
	Заголовки.Вставить("Основание"			, НСтр("ru='п.2 ст.275 НК РФ'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru=''"));
	ПодготовитьНастройки(Заголовки);
...
Процедура ПроверкаКС_1_23()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму налога в стр.040 подр.1.3 Раздела 1");
	Заголовки.Вставить("Основание"			, НСтр("ru='п.2 ст.282 НК РФ'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru=''"));
	ПодготовитьНастройки(Заголовки);
...
Процедура ПроверкаКС_1_28()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма доходов от реализации'"));
...
Процедура ПроверкаКС_1_30()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма внереализационных доходов'"));
...
Процедура ПроверкаКС_1_32()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма внереализационных расходов'"));
...
Процедура ПроверкаКС_1_33()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма убытков'"));
...
Процедура ПроверкаКС_1_34()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма прибыли (убытка)'"));
...
Процедура ПроверкаКС_1_37()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма налоговой базы и налога'"));
	Заголовки.Вставить("Рекомендации"		, 
...
Процедура ПроверкаКС_1_38()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма убытка'"));
...
Процедура ПроверкаКС_1_41()
	...
	Заголовки.Вставить("Описание"			, НСтр("ru='Налоговая база в стр.130 Листа 02 = 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Возможно необоснованная сумма налоговой базы'"));
	Заголовки.Вставить("Рекомендации"		, "Убедитесь в обоснованности суммы налоговой базы в стр.130 Листа 02");
	Заголовки.Вставить("Основание"			, НСтр("ru='п.1 ст.284 НК РФ'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru='Страница %1 Листа 02'"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru='Проверка носит справочный характер'"));
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Лист02 Из ДанныеКС.Лист02 Цикл
		...
		НастройкиКС.ЭтоОшибка = НЕ Показатели.Л02С001.Значение = 0;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, 
			Показатели.Л02С001.Значение);
		НастройкиКС.ДопСведения = СтрЗаменить(НастройкиКС.ШаблонДопСведений, "%1", Лист02.НомерСтраницы);
		ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_1_43()
	...
	Заголовки.Вставить("Описание"			, 
		...
		НСтр("ru='стр.120 Листа 02 и стр.120 Листа 2 ≠ 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = %4 (%2 + %3)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная ставка налога'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните ставку налога в стр.140 Листа 02");
	Заголовки.Вставить("Основание"			, НСтр("ru='ст.80 НК РФ'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru='Страница %1 Листа 02'"));
	ПодготовитьНастройки(Заголовки);
	...
	Для каждого Лист02 Из ДанныеКС.Лист02 Цикл
		...
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, 
			Показатели.Л02С003.Значение, Показатели.Л02С004.Значение, Показатели.Л02С005.Значение, РасчетнаяСумма);
		НастройкиКС.ДопСведения = СтрЗаменить(НастройкиКС.ШаблонДопСведений, "%1", Лист02.НомерСтраницы);
		ДополнитьТаблицуРезультата();
...
Процедура ПроверкаКС_1_45()
	...
	Заголовки.Вставить("Описание"			, 
		...
		НСтр("ru='""Признак налогоплательщика"" = 01, 15, 16, 19'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = 3'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная величина ставки налога'"));
...
Процедура ПроверкаКС_1_46()
	...
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='Ставка налога в федеральный бюджет в стр.150 Листа 02 = 3%, если код по реквизиту '") +
		НСтр("ru='""Признак налогоплательщика"" = 03 и код по реквизиту ""Номер документа"" = 1, 2, 4'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = 3'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная величина ставки налога'"));
	Заголовки.Вставить("Рекомендации"		, "Укажите ставку налога в стр.150 Листа 02 = 3");
	Заголовки.Вставить("Основание"			, НСтр("ru='п.1 ст.284 НК РФ'"));
...
Процедура ПроверкаКС_1_47_1()
	...
	Заголовки.Вставить("Основание"			, НСтр("ru='ст.284 НК РФ'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru='Страница %1 Листа 02'"));
	ПодготовитьНастройки(Заголовки);
...
Процедура ПроверкаКС_1_48()
	...
	Заголовки.Вставить("Основание"			, НСтр("ru='ст.288.1 НК РФ'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru='Страница %1 Листа 02'"));
	ПодготовитьНастройки(Заголовки);
...
Процедура ПроверкаКС_1_49()
	...
	Заголовки.Вставить("Описание"			, 
		...
		НСтр("ru='""Признак налогоплательщика"" = 01. КС проверяется для организаций, не имеющих '") +
		НСтр("ru='обособленных подразделений'"));
...
Процедура ПроверкаКС_1_51()
	...
	Заголовки.Вставить("Описание"			, 
		...
		НСтр("ru='""Признак налогоплательщика"" = 03 и код по реквизиту ""Номер документа"" = 6 '") +
		НСтр("ru='(для резидентов Калининградской ОЭЗ). КС проверяется для организаций, '") +
		НСтр("ru='не имеющих обособленных подразделений'"));
...
Процедура ПроверкаКС_1_52()
	...
	Заголовки.Вставить("Описание"			, НСтр("ru='Ставка налога в бюджет субъекта РФ в стр.170 Листа 02 = 0%'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = 0'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Возможно необоснованное применение пониженной налоговой ставки'"));
	Заголовки.Вставить("Рекомендации"		, "Убедитесь в обоснованности налоговой ставки в стр.170 Листа 02");
	Заголовки.Вставить("Основание"			, НСтр("ru='п.1 ст.284 НК РФ'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru='Страница %1 Листа 02'"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru='Проверка носит справочный характер'"));
	ПодготовитьНастройки(Заголовки);
...
Процедура ПроверкаКС_1_56()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму налога в стр.200 Листа 02");
	Заголовки.Вставить("Основание"			, НСтр("ru='п.2 ст.288 НК РФ'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru='Страница %1 Листа 02'"));
	ПодготовитьНастройки(Заголовки);
...
Процедура ПроверкаКС_1_56_код()
	...
	Для каждого Лист02 Из ДанныеКС.Лист02 Цикл
		...
		НастройкиКС.ЭтоОшибка = ДанныеКС.ЭтоГоловнаяСОП И НЕ Показатели.Л02С001.Значение = Показатели.П25С001.Итог;
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации, 
...
Процедура ПроверкаКС_1_66()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма авансовых платежей'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму авансовых платежей в стр.230 Листа 02");
	Заголовки.Вставить("Основание"			, НСтр("ru='п.1,2 ст.286 НК РФ'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru='Страница %1 Листа 02'"));
	ПодготовитьНастройки(Заголовки);
...
Процедура ПроверкаКС_1_69()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма уменьшения налога'"));
...
Процедура ПроверкаКС_1_71()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма налога'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму налога в стр.270 Листа 02");
	Заголовки.Вставить("Основание"			, НСтр("ru='п.1 ст.287 НК РФ'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru='Страница %1 Листа 02'"));
	ПодготовитьНастройки(Заголовки);
...
Процедура ПроверкаКС_1_88()
	...
	Для каждого Лист02 Из ДанныеКС.Лист02 Цикл
		...
		НастройкиКС.ЭтоОшибка = ДанныеКС.ЭтоГоловнаяСОП И ДанныеКС.МесОтчета = 9 И НЕ Показатели.Л02С001.Значение = 
...
Процедура ПроверкаКС_1_89()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = %2 (%3 - %4)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма разницы между доходами и расходами'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму разницы в стр.359 Листа 02");
	Заголовки.Вставить("Основание"			, НСтр("ru='ст.284.4 НК РФ'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru='Страница %1 Листа 02'"));
	ПодготовитьНастройки(Заголовки);
...
Процедура ПроверкаКС_3_01_доп()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма выручки от реализации'"));
...
Процедура ПроверкаКС_3_07_доп()
	...
	Заголовки.Вставить("Описание"			, 
		...
		НСтр("ru='Приложения 2 к Листу 02'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 >= %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма расходов на НИОКР'"));
...
Процедура ПроверкаКС_3_11_доп()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма признанных расходов'"));
...
Процедура ПроверкаКС_3_12_доп()
	...
	Заголовки.Вставить("Описание"			, 
		...
		НСтр("ru='Приложения 2 к Листу 02'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 >= %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма амортизации'"));
...
Процедура ПроверкаКС_3_15_доп()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочный метод начисления амортизации'"));
...
Процедура ПроверкаКС_3_19_доп()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма корректировки'"));
...
Процедура ПроверкаКС_3_20_доп()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 >= %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочное количество объектов реализации'"));
...
Процедура ПроверкаКС_3_36_доп()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма долей налоговых баз'"));
