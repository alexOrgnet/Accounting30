...
#Область Проверки
	...
	ПроверкаКС_7_4_1_к_2021Кв4();
	ПроверкаКС_7_4_2_к_2021Кв4();
	ПроверкаКС_7_4_3_к_2021Кв4();
	ПроверкаКС_7_4_4_к_2021Кв4();
...
Процедура ПроверкаКС_7_4_1_к_2021Кв4()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru='7.4.1.к'"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru='Критическая проверка'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru='Раздел 1'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru=''"));
	...
	ПроверкаКС_7_4_1_к_код_2021Кв4(Настройки);
	
КонецПроцедуры

Процедура ПроверкаКС_7_4_1_к_код_2021Кв4(Настройки)
...
Процедура ПроверкаКС_7_4_2_к_2021Кв4()
	
	Перем Показатели;
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru='7.4.2.к'"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru='Критическая проверка'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru='Раздел 1'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru=''"));
...
Процедура ПроверкаКС_7_4_3_к_2021Кв4()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru='7.4.3.к'"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru='Критическая проверка'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru='Раздел 1'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru=''"));
...
Процедура ПроверкаКС_7_4_4_к_2021Кв4()
	
	Перем Показатели;
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, НСтр("ru='7.4.4.к'"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru='Критическая проверка'"));
	Заголовки.Вставить("Раздел"				, НСтр("ru='Раздел 1'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru=''"));
...
#Область Проверки
	...
	Если Ложь Тогда
		...
		// проектные проверки
		ПроверкаКС_7_1_к_2023Кв1();
		ПроверкаКС_7_3_1_к_2023Кв1();
		ПроверкаКС_7_3_2_к_2023Кв1();
		ПроверкаКС_7_3_3_к_2023Кв1();
		ПроверкаКС_7_3_4_к_2023Кв1();
		ПроверкаКС_7_3_5_к_2023Кв1();
		ПроверкаКС_7_3_6_к_2023Кв1();
		ПроверкаКС_7_3_7_к_2023Кв1();
...
Процедура ПроверкаКС_7_1_к_2023Кв1()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru='Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru='7.1.к'"));
...
Процедура ПроверкаКС_7_3_1_к_2023Кв1()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru='Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru='7.2.1.к'"));
	...
	ПроверкаКС_7_3_1_к_код_2023Кв1();
	
КонецПроцедуры

Процедура ПроверкаКС_7_3_1_к_код_2023Кв1()
...
Процедура ПроверкаКС_7_3_2_к_2023Кв1()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru='Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru='7.2.2.к'"));
...
Процедура ПроверкаКС_7_3_3_к_2023Кв1()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru='Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru='7.2.3.к'"));
...
Процедура ПроверкаКС_7_3_4_к_2023Кв1()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru='Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru='7.2.4.к'"));
...
Процедура ПроверкаКС_7_3_5_к_2023Кв1()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru='Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru='7.2.5.к'"));
...
Процедура ПроверкаКС_7_3_6_к_2023Кв1()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru='Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru='7.2.6.к'"));
...
Процедура ПроверкаКС_7_3_7_к_2023Кв1()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru='Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru='7.2.7.к'"));
...
#Область Проверки
	...
	Если Ложь Тогда
		...
		ПроверкаКС_7_1_к_2024Кв2();
		ПроверкаКС_7_3_1_к_2024Кв2();
		ПроверкаКС_7_3_2_к_2024Кв2();
		ПроверкаКС_7_3_3_к_2024Кв2();
		ПроверкаКС_7_3_4_к_2024Кв2();
		ПроверкаКС_7_3_5_к_2024Кв2();
		ПроверкаКС_7_3_6_к_2024Кв2();
		ПроверкаКС_7_3_7_к_2024Кв2();
...
Процедура ПроверкаКС_7_1_к_2024Кв2()
	
	Заголовки = Новый Структура;
	Заголовки.Вставить("Раздел"				, НСтр("ru='Раздел 1'"));
	Заголовки.Вставить("НомерКС"			, НСтр("ru='7.1.к'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='Сумма налога в стр.(021 + 022 + 023 + 024 + 025 + 026) всех Разделов 1 >= сумме стр.(031 '") +
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Раздел1 Цикл
		...
		ЗаполнитьИРасшифроватьПоказатель_2024Кв2(Показатели.Р01С021, СтраницаРаздела);
		ЗаполнитьИРасшифроватьПоказатель_2024Кв2(Показатели.Р01С022, СтраницаРаздела);
		ЗаполнитьИРасшифроватьПоказатель_2024Кв2(Показатели.Р01С023, СтраницаРаздела);
		ЗаполнитьИРасшифроватьПоказатель_2024Кв2(Показатели.Р01С024, СтраницаРаздела);
		
		Для Счетчик = 1 По СтраницаРаздела.КолвоСтрокП00001М2 Цикл
			ЗаполнитьИРасшифроватьПоказатель_2024Кв2(Показатели.Р01С032, СтраницаРаздела, Счетчик);
		КонецЦикла;
...
Процедура ПроверкаКС_7_3_1_к_2024Кв2()
	...
	ПроверкаКС_7_3_1_к_код_2024Кв2();
	
КонецПроцедуры

Процедура ПроверкаКС_7_3_1_к_код_2024Кв2()
...
Процедура ПроверкаКС_7_3_2_к_2024Кв2()
...
Процедура ПроверкаКС_7_3_3_к_2024Кв2()
...
Процедура ПроверкаКС_7_3_4_к_2024Кв2()
...
Процедура ПроверкаКС_7_3_5_к_2024Кв2()
...
Процедура ПроверкаКС_7_3_6_к_2024Кв2()
...
Процедура ПроверкаКС_7_3_7_к_2024Кв2()
	...
	Для каждого СтраницаРаздела Из ДанныеКС.Раздел1 Цикл
		Для Счетчик = 1 По СтраницаРаздела.КолвоСтрокП00001М2 Цикл
			...
			ЗарегистрироватьПроверку_2024Кв2();
			ЗаполнитьИРасшифроватьПоказатели_2024Кв2(Показатели, СтраницаРаздела, Счетчик);
...
Процедура ПроверкаКС_1_14_2024Кв2()
	...
	Заголовки.Вставить("НомерКС"			, НСтр("ru='1.14'"));
	Заголовки.Вставить("Описание"			, 
		НСтр("ru='Стр.(140 - 150 - 155 - 156) Раздела 2 >= стр.(160 + 170 - 180) Раздела 2'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 (%2 - %3 - %4 - %5) >= %6 (%7 + %8 - %9)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Возможно ошибочные значения показателей'"));
	Заголовки.Вставить("Рекомендации"		, НСтр("ru='Уточните показатели в стр.140 - 180 Раздела 2'"));
	Заголовки.Вставить("Основание"			, НСтр("ru='Письмо ФНС России от 20.12.2023 № БС-4-11/15922@'"));
	Заголовки.Вставить("ШаблонДопСведений"	, НСтр("ru='Страница %1 Раздела 2'"));
	ПодготовитьНастройки_2024Кв2(Заголовки);
