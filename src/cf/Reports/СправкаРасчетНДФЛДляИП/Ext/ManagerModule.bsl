...
Процедура ПередКомпоновкойМакета(ПараметрыОтчета, Схема, КомпоновщикНастроек) Экспорт
	...
	СтавкиНалога = УчетНДФЛПредпринимателяКлиентСервер.НалоговыеСтавкиПоУмолчанию(ПараметрыОтчета.НачалоПериода);
	ПределНалоговойБазы = УчетНДФЛПредпринимателяКлиентСервер.ГраницаНалоговойБазыДляПримененияПовышеннойСтавки();
	БухгалтерскиеОтчетыКлиентСервер.УстановитьПараметр(КомпоновщикНастроек,
		"СуммаНалогаБазовая",
		ПределНалоговойБазы * СтавкиНалога.СтавкаНДФЛ / 100);
	...
	БухгалтерскиеОтчетыКлиентСервер.УстановитьПараметр(КомпоновщикНастроек, "ПределНалоговойБазы", ПределНалоговойБазы);
