	...
	Если ИмяРаздела = "Раздел2" Тогда
		...
		Иначе
			...
			ИначеЕсли ГодДействия = 2025 Тогда
				...
				Ставка = ?(КодВидаПодакцизногоТовара = "510",     0, Ставка);
				Ставка = ?(КодВидаПодакцизногоТовара = "520",    60, Ставка);
				Ставка = ?(КодВидаПодакцизногоТовара = "531",   579, Ставка);
				Ставка = ?(КодВидаПодакцизногоТовара = "532",   579, Ставка);
				Ставка = ?(КодВидаПодакцизногоТовара = "533",   948, Ставка);
				Ставка = ?(КодВидаПодакцизногоТовара = "534",  1617, Ставка);
				Ставка = ?(КодВидаПодакцизногоТовара = "535",  1673, Ставка);
				Ставка = ?(КодВидаПодакцизногоТовара = "536",  1728, Ставка);
				Ставка = ?(КодВидаПодакцизногоТовара = "630", 10842, Ставка);
				Ставка = ?(КодВидаПодакцизногоТовара = "640",  6893, Ставка);
				
				Ставка = ?(КодВидаПодакцизногоТовара = "650", Окр(13100 + 4865 * 1), Ставка);
				
				Ставка = ?(КодВидаПодакцизногоТовара = "665", 15650, Ставка);
				Ставка = ?(КодВидаПодакцизногоТовара = "671",  2800, Ставка);
				...
				Ставка = ?(КодВидаПодакцизногоТовара = "676", 16076, Ставка);
				Ставка = ?(КодВидаПодакцизногоТовара = "680",  9000, Ставка);
				
			ИначеЕсли ГодДействия = 2026 Тогда
				
				Ставка = ?(КодВидаПодакцизногоТовара = "510",     0, Ставка);
				Ставка = ?(КодВидаПодакцизногоТовара = "520",    62, Ставка);
				Ставка = ?(КодВидаПодакцизногоТовара = "531",   602, Ставка);
				Ставка = ?(КодВидаПодакцизногоТовара = "532",   602, Ставка);
				Ставка = ?(КодВидаПодакцизногоТовара = "533",   986, Ставка);
				Ставка = ?(КодВидаПодакцизногоТовара = "534",  1682, Ставка);
				Ставка = ?(КодВидаПодакцизногоТовара = "535",  1740, Ставка);
				Ставка = ?(КодВидаПодакцизногоТовара = "536",  1797, Ставка);
				Ставка = ?(КодВидаПодакцизногоТовара = "630", 11276, Ставка);
				Ставка = ?(КодВидаПодакцизногоТовара = "640",  7169, Ставка);
				
				Ставка = ?(КодВидаПодакцизногоТовара = "650", Окр(13100 + 4865 * 1), Ставка);
				
				Ставка = ?(КодВидаПодакцизногоТовара = "665", 16276, Ставка);
				Ставка = ?(КодВидаПодакцизногоТовара = "671",  2800, Ставка);
				...
				Ставка = ?(КодВидаПодакцизногоТовара = "676", 16719, Ставка);
				Ставка = ?(КодВидаПодакцизногоТовара = "680",  9000, Ставка);
...
Процедура Проверить(Команда)
	...
	|отчета в редакции приказа ФНС России от
	|12.10.2022 № ЕД-7-3/923@ будет реализована
