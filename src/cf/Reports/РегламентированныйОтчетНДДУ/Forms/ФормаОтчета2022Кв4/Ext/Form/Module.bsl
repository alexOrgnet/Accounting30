...
Процедура ПроверкаКС_1_01()
	...
	Заголовки.Вставить("НомерКС"			, "1.1");
	...
	Заголовки.Вставить("Основание"			, "п.1 ст.119, п.1 ст.126 НК РФ");
...
Процедура ПроверкаКС_1_02()
	...
	Заголовки = Новый Структура;
	Заголовки.Вставить("НомерКС"			, "1.2");
	...
	Заголовки.Вставить("ШаблонДетализации"	, "%1 >= %2");
	Заголовки.Вставить("Нарушение"			, "Ошибочное количество Разделов 2");
	Заголовки.Вставить("Рекомендации"		, "Дополните Раздел 2 в отчете за текущий период");
	Заголовки.Вставить("Основание"			, "ст.80 НК РФ");
	ПодготовитьНастройки(Заголовки);
...
Процедура ПроверкаКС_2_01_03()
	...
	Заголовки.Вставить("ШаблонДетализации"	, 
		НСтр("ru='%1 = 18210705030011000110, если %2 = 108 - 142, 154 - 157, 183, 184'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочное значение КБК'"));
...
Процедура ПроверкаКС_2_02()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 в списке допустимых значений'"));
...
Процедура ПроверкаКС_3_01()
	...
	Заголовки.Вставить("Основание"			, НСтр("ru='ст.333.45 НК РФ'"));
	Заголовки.Вставить("ШаблонДопСведений"	, "Страница %1 Раздела 2");
	ПодготовитьНастройки(Заголовки);
...
Процедура ПроверкаКС_3_02_03()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = 1, если %2 = 108 - 142, 154 - 157, 182 - 184, 186, 187'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочное значение коэффициента Кг'"));
...
Процедура ПроверкаКС_3_03()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма расчетной выручки'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму расчетной выручки в стр.050 Раздела 2");
	Заголовки.Вставить("Основание"			, НСтр("ru='ст.333.46 НК РФ'"));
	Заголовки.Вставить("ШаблонДопСведений"	, "Страница %1 Раздела 2");
	ПодготовитьНастройки(Заголовки);
...
Процедура ПроверкаКС_3_07()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма фактических расходов'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму фактических расходов в стр.060 Раздела 2");
	Заголовки.Вставить("Основание"			, НСтр("ru='ст.333.47 НК РФ'"));
	Заголовки.Вставить("ШаблонДопСведений"	, "Страница %1 Раздела 2");
	ПодготовитьНастройки(Заголовки);
...
Процедура ПроверкаКС_3_12()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = %2 (%3 + %4 + %5 + %6)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма расчетных расходов'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму расчетных расходов в стр.070 Раздела 2");
	Заголовки.Вставить("Основание"			, НСтр("ru='ст.333.49 НК РФ'"));
	Заголовки.Вставить("ШаблонДопСведений"	, "Страница %1 Раздела 2");
	ПодготовитьНастройки(Заголовки);
...
Процедура ПроверкаКС_3_17()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма восстановленных фактических расходов'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму восстановленных фактических расходов в стр.080 Раздела 2");
	Заголовки.Вставить("Основание"			, НСтр("ru='ст.333.48 НК РФ'"));
	Заголовки.Вставить("ШаблонДопСведений"	, "Страница %1 Раздела 2");
	ПодготовитьНастройки(Заголовки);
...
Процедура ПроверкаКС_3_20()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма дополнительного дохода'"));
	Заголовки.Вставить("Рекомендации"		, "Уточните сумму дополнительного дохода в стр.090 Раздела 2");
	Заголовки.Вставить("Основание"			, НСтр("ru='ст.333.50 НК РФ'"));
	Заголовки.Вставить("ШаблонДопСведений"	, "Страница %1 Раздела 2");
	ПодготовитьНастройки(Заголовки);
...
Процедура ПроверкаКС_3_22()
	...
	Заголовки.Вставить("Основание"			, НСтр("ru='ст.333.50, 333.51 НК РФ'"));
	Заголовки.Вставить("ШаблонДопСведений"	, "Страница %1 Раздела 2");
	ПодготовитьНастройки(Заголовки);
...
Процедура ПроверкаКС_3_23()
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		...
		НастройкиКС.ЭтоОшибка = НЕ Показатели.Р2С110.Значение = Макс(0, РасчетнаяСумма);
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации,
...
Процедура ПроверкаКС_3_24()
	...
	Заголовки.Вставить("Основание"			, НСтр("ru='ст.333.54 НК РФ'"));
	Заголовки.Вставить("ШаблонДопСведений"	, "Страница %1 Раздела 2");
	ПодготовитьНастройки(Заголовки);
...
Процедура ПроверкаКС_3_25()
	...
	Заголовки.Вставить("Основание"			, НСтр("ru='ст.333.55 НК РФ'"));
	Заголовки.Вставить("ШаблонДопСведений"	, "Страница %1 Раздела 2");
	ПодготовитьНастройки(Заголовки);
...
Процедура ПроверкаКС_3_26()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма минимального налога'"));
...
Процедура ПроверкаКС_3_28()
	...
	Заголовки.Вставить("Описание"			, 
		...
		НСтр("ru='> 0, иначе 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = %4 (%2 - %3)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма налога к доплате'"));
	...
	Для каждого Раздел2 Из ДанныеКС.Раздел2 Цикл
		...
		НастройкиКС.ЭтоОшибка = НЕ Показатели.Р2С150.Значение = Макс(0, РасчетнаяСумма);
		НастройкиКС.Детализация = СтрШаблон(НастройкиКС.ШаблонДетализации	, 
...
Процедура ПроверкаКС_3_29()
	...
	Заголовки.Вставить("Описание"			, 
		...
		НСтр("ru='> 0, иначе 0'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = %4 (%2 - %3)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма налога к уменьшению'"));
...
Процедура ПроверкаКС_3_30()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочное значение количества нефти и газа'"));
...
Процедура ПроверкаКС_3_31()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочное значение номера лицензии'"));
	Заголовки.Вставить("Рекомендации"		, "Проверьте наличие номера лицензии в системе АИС Налог-2");
	Заголовки.Вставить("Основание"			, НСтр("ru='ст.80 НК РФ'"));
	Заголовки.Вставить("ДляДокументации"	, НСтр("ru='Реализация отложена'"));
	Заголовки.Вставить("ШаблонДопСведений"	, "Страница %1 Раздела 2");
	ПодготовитьНастройки(Заголовки);
...
Процедура ПроверкаКС_3_32()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочное значение номера лицензии'"));
	Заголовки.Вставить("Рекомендации"		, "Проверьте наличие номера лицензии в ЕГРЮЛ");
	Заголовки.Вставить("Основание"			, НСтр("ru='ст.80 НК РФ'"));
	Заголовки.Вставить("ДляДокументации"	, НСтр("ru='Реализация отложена'"));
	Заголовки.Вставить("ШаблонДопСведений"	, "Страница %1 Раздела 2");
	ПодготовитьНастройки(Заголовки);
...
Процедура ПроверкаКС_3_35_доп()
	...
	Заголовки.Вставить("Описание"			, 
		...
		НСтр("ru='за предыдущий отчетный период'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = %4 (%2 + %3)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма доходов от аренды'"));
...
Процедура ПроверкаКС_4_01()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочный месяц отчетного периода'"));
...
Процедура ПроверкаКС_4_03()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='Недопустимое значение %1'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочное значение кода источника цены'"));
...
Процедура ПроверкаКС_4_04()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='Недопустимое значение %1'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочное значение коэффициента для попутного газа'"));
...
Процедура ПроверкаКС_4_05()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = %4 (%2 - %3)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочное значение количества попутного газа'"));
...
Процедура ПроверкаКС_4_06()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = %4 (%2 + %3)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочное значение количества нефти и газового конденсата'"));
	Заголовки.Вставить("Рекомендации"		, 
...
Процедура ПроверкаКС_5_01()
	...
	Заголовки.Вставить("Описание"			, 
		...
		НСтр("ru='за налоговый период'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочное значение месяца отчетного периода'"));
	Заголовки.Вставить("Рекомендации"		, "Укажите месяц из текущего отчетного периода");
	Заголовки.Вставить("Основание"			, НСтр("ru='ст.333.47 НК РФ'"));
	ПодготовитьНастройки(Заголовки);
...
Процедура ПроверкаКС_6_03()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма таможенной пошлины'"));
...
Процедура ПроверкаКС_6_05()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = %2 (%3 + %4)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочное количество нефти и газового конденсата'"));
...
Процедура ПроверкаКС_7_01()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='Недопустимое значение %1'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочное значение кода основания'"));
	Заголовки.Вставить("Рекомендации"		, "Выберите код основания из списка значений");
	Заголовки.Вставить("Основание"			, НСтр("ru='п.4 ст.333.48 НК РФ'"));
	ПодготовитьНастройки(Заголовки);
...
Процедура ПроверкаКС_7_02()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='Недопустимое значение %1'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочное значение признака номера'"));
...
Процедура ПроверкаКС_7_03()
	...
	Заголовки.Вставить("Описание"			, 
		...
		НСтр("ru='допустимых значений'"));
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='Недопустимое значение %1'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочное значение коэффициента индексации убытка'"));
	Заголовки.Вставить("Рекомендации"		, "Выберите коэффициент индексации убытка из списка значений");
	Заголовки.Вставить("Основание"			, НСтр("ru='п.5 ст.333.48 НК РФ'"));
	ПодготовитьНастройки(Заголовки);
...
Процедура ПроверкаКС_8_01()
	...
	Заголовки.Вставить("Основание"			, НСтр("ru='ст.333.51, 333.52 НК РФ'"));
	ПодготовитьНастройки(Заголовки);
...
Процедура ПроверкаКС_8_02_01()
	...
	Заголовки.Вставить("Основание"			, НСтр("ru='ст.333.52 НК РФ'"));
	ПодготовитьНастройки(Заголовки);
...
Процедура ПроверкаКС_8_03()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 < %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочное значение года'"));
...
Процедура ПроверкаКС_8_05()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = %2 (%3 - %4 - %5 + %6)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма финансового результата'"));
...
Процедура ПроверкаКС_9_01()
	...
	Заголовки.Вставить("Основание"			, НСтр("ru='ст.333.51 НК РФ'"));
	ПодготовитьНастройки(Заголовки);
...
Процедура ПроверкаКС_10_03_01()
	...
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочное значение количества добытой нефти'"));
...
Процедура ПроверкаКС_10_04_01()
	...
	Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = %2'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочное количество добытой нефти'"));
...
Процедура ПроверкаКС_10_05()
	...
	Заголовки.Вставить("Описание"			, 
		...
		Заголовки.Вставить("ШаблонДетализации"	, НСтр("ru='%1 = %2 (%3 - %4 - %5 - %6)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='Ошибочная сумма минимальной налоговой базы'"));
