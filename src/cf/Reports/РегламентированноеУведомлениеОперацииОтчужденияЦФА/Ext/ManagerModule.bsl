...
Функция ПроверитьДокументСВыводомВТаблицу_Форма2023_1(Данные, УникальныйИдентификатор)
	...
	Для Каждого Стр Из Данные.ДанныеМногостраничныхРазделов.ИнфОтнФЛ Цикл
		...
		УведомлениеОСпецрежимахНалогообложения.ПроверкаИНН(ИнфОтнФЛ, ТаблицаОшибок, "ИнфОтнФЛ", "ИННФЛ", Ложь, Ложь);
		УведомлениеОСпецрежимахНалогообложения.ПроверкаОКСМ(ИнфОтнФЛ, ТаблицаОшибок, "ИнфОтнФЛ", "Гражд", Истина);
