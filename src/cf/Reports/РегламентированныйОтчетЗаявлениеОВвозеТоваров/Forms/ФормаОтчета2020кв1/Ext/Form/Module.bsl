...
Процедура ВывестиНаПечатьЛистРаздел1(СтруктураПараметров)
	...
	МакетПечатиРаздела = ОбъектОтчета(ЭтаФорма.ИмяФормы).ПолучитьМакет("ПечатнаяФормаОтчета2020Кв1_Раздел1");
	
	МакетОбразцаПечатиРаздела = ОбъектОтчета(ЭтаФорма.ИмяФормы).ПолучитьМакет("ПечатнаяФормаОтчета2020Кв1_Раздел1");
