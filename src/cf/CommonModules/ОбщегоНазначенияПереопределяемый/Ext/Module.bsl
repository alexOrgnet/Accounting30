...
Процедура ПриОпределенииОбщихПараметровБазовойФункциональности(ОбщиеПараметры) Экспорт
	...
	ОбщиеПараметры.МинимальнаяВерсияПлатформы = "8.3.21.1895; 8.3.22.2239; 8.3.23.1865; 8.3.24.1163";
	ОбщиеПараметры.РекомендуемаяВерсияПлатформы = "8.3.21.1895; 8.3.22.2239; 8.3.23.1865; 8.3.24.1163";
...
Процедура ПриДобавленииОбработчиковУстановкиПараметровСеанса(Обработчики) Экспорт
	...
	Обработчики.Вставить("ДанныеКлючаСессииИСМПРозница"		, "ИнтеграцияИСМП.УстановитьПараметрыСеанса");
	Обработчики.Вставить("CDNПлощадкиСОшибкамиОбменаИСМП"	, "ИнтеграцияИСМП.УстановитьПараметрыСеанса");
	// Конец ИСМП
