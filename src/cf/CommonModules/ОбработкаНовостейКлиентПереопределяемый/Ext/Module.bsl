...
Процедура РазрешенаРаботаСНовостямиТекущемуПользователю(Результат) Экспорт
	...
	Если Результат = Истина Тогда
		Результат = Не СтандартныеПодсистемыКлиент.ПараметрыРаботыКлиентаПриЗапуске().НачалоРаботы
			И СтандартныеПодсистемыКлиент.ПараметрыРаботыКлиента().РежимИнтерфейсаПользователяРазрешаетРаботуСНовостями;
	КонецЕсли;
