...
Функция ПолучитьФайлыМЧД(МЧД, ВладелецЭЦПИНН, ВладелецЭЦПСНИЛС) Экспорт
	...
	Если ТипЗнч(МЧД) = Тип("СправочникСсылка.МашиночитаемыеДоверенностиФНС")
		...
		ИЛИ ЗначениеЗаполнено(ИмяТипаСправочникаМашиночитаемыеДоверенности)
			И ТипЗнч(МЧД) = Тип("СправочникСсылка." + ИмяТипаСправочникаМашиночитаемыеДоверенности) Тогда
...
Функция ЗаполнитьСвойстваСертификатаСТокена(Реквизиты, Контейнер) Экспорт
	...
	Контейнер.Подходит = 
		ЭтоСертификатВладельца
		И Сертификат.ДатаНачала < ТекущаяДатаСеанса() 
		И Сертификат.ДатаОкончания > ТекущаяДатаСеанса();
