...
Процедура ОчиститьДанныеПриОтключенииСервиса(ОчищатьДанныеОтложенногоПодключения = Истина) Экспорт
	...
	ОбщегоНазначения.УдалитьДанныеИзБезопасногоХранилища("1СКабинетСотрудника.Менеджер.Токен");
	ОбщегоНазначения.УдалитьДанныеИзБезопасногоХранилища("1СКабинетСотрудника.Менеджер.Ключи");
	ИнтеграцияУправлениеПерсоналом.ОчиститьКлючиТокенПриложения(Приложение);
	...
	ИнтеграцияУправлениеПерсоналом.ОчиститьДанныеПриОтключенииПриложения(Приложение);
	УстановитьПривилегированныйРежим(Ложь);
...
Процедура ЗаписатьНастройкиПриПодключенииСервиса(ОписаниеПриложения, ОписаниеИС)
	...
	УстановитьПривилегированныйРежим(Истина);
	Приложение = Перечисления.ПриложенияДляИнтеграции.КабинетСотрудника;
	ИнтеграцияУправлениеПерсоналом.СохранитьКлючиПриложения(Приложение, ОписаниеИС);
	УстановитьПривилегированныйРежим(Ложь);
	...
	ИнтеграцияКабинетСотрудника.ЗарегистрироватьОпубликоватьОтветственного(Ответственный);
