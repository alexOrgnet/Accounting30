...
Функция РаспределитьЧастьРасходовЗаМесяц(Период, Организация, Отказ, Ошибки = Неопределено) Экспорт
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	СостоянияОСОрганизацийСрезПоследнихПринятоКУчету.ОсновноеСредство КАК ОсновноеСредство,
	|	СостоянияОСОрганизацийСрезПоследнихПринятоКУчету.ДатаСостояния КАК ДатаСостоянияПринятоКУчету
	...
	|				И Организация = &Организация) КАК СостоянияОСОрганизацийСрезПоследнихПринятоКУчету
	|
	|ИНДЕКСИРОВАТЬ ПО
	|	ОсновноеСредство
	|;
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	СостоянияОСОрганизацийСрезПоследнихСнятоСУчета.ОсновноеСредство КАК ОсновноеСредство,
	|	СостоянияОСОрганизацийСрезПоследнихСнятоСУчета.ДатаСостояния КАК ДатаСостоянияСнятоСУчета
	...
	|				И Организация = &Организация) КАК СостоянияОСОрганизацийСрезПоследнихСнятоСУчета
	|
	|ИНДЕКСИРОВАТЬ ПО
	|	ОсновноеСредство
	|;
	...
	|	ЕСТЬNULL(НачислениеАмортизацииОССпециальныйКоэффициентНалоговыйУчетСрезПоследних.СпециальныйКоэффициент, 0) КАК Коэффициент
	...
	|		ПО ПараметрыАмортизацииОСНалоговыйУчетСрезПоследних.ОсновноеСредство = НачислениеАмортизацииОССпециальныйКоэффициентНалоговыйУчетСрезПоследних.ОсновноеСредство
	|			И ПараметрыАмортизацииОСНалоговыйУчетСрезПоследних.Организация = НачислениеАмортизацииОССпециальныйКоэффициентНалоговыйУчетСрезПоследних.Организация
	|
	|ИНДЕКСИРОВАТЬ ПО
	|	ОсновноеСредство
	|;
