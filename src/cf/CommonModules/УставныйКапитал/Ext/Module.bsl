...
// Устанавливает видимость команд по уставному капиталу
//
// Параметры:
//  ВестиУчетЮридическогоЛица - Булево - значение константы ВестиУчетЮридическогоЛица
//
Процедура УстановитьВидимостьКомандУставногоКапитала(Знач ВестиУчетЮридическогоЛица = Неопределено) Экспорт 
	
	УстановитьПривилегированныйРежим(Истина);
	
	Если ВестиУчетЮридическогоЛица = Неопределено Тогда 
		ВестиУчетЮридическогоЛица = Константы.ВестиУчетЮридическогоЛица.Получить();
	КонецЕсли;
	
	ФормированиеУставногоКапиталаПростойИнтерфейс = ВестиУчетЮридическогоЛица
		И ОбщегоНазначенияБП.ЭтоПростойИнтерфейс();
	Константы.ФормированиеУставногоКапиталаПростойИнтерфейс.Установить(ФормированиеУставногоКапиталаПростойИнтерфейс);
