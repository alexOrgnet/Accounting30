...
Функция ВнешниеДанные(ИмяОбъекта) Экспорт
	...
	ИначеЕсли ИмяОбъекта = "БуквенныеКодыРазделовОКВЭД2" Тогда
		...
		Возврат РегистрыСведений.КлассификаторОКВЭД2.БуквенныеКодыРазделовОКВЭД2();
...
Процедура ЧисленностьПерсонала(Показатели, Формула, ПараметрыОтчета) Экспорт
	...
	// Получим данные через актуальный программный интерфейс.
	ДанныеЧисленности = УчетЗарплаты.СреднесписочнаяЧисленность(
