...
// Возвращает Истина, если доступен доступен сервис интеграции
//
// Возвращаемое значение:
...
// 
// Параметры:
//   АктивироватьПромокод - Булево - активировать промокод, если недоступна конфигурация сервиса
//
// Возвращаемое значение:
//   Булево - Истина, если изменилось значение константы. Ложь - в противном случае.
//
Функция УстановитьДоступнаИнтеграция(АктивироватьПромокод = Ложь) Экспорт
	...
	Если ИспользуетсяНПД И ДоступенСервисИнтеграции() Тогда
		Если ДоступнаКонфигурацияСервисаИнтеграции() Тогда
			ИнтеграцияДоступна = Истина;
		ИначеЕсли АктивироватьПромокод Тогда
...
Функция АктивироватьПромокодСервисаИнтеграции()
	...
	Попытка
		РезультатАктивации = ПрограммныйИнтерфейсСервиса.ИспользоватьПромокод(ПромокодАктивацииСервисаИнтеграции(), Ложь);
	Исключение
		ЗаписьЖурналаРегистрации(
			ИнтеграцияСПлатформойСамозанятыеКлиентСервер.ИмяСобытияЖурналаРегистрации(),
			УровеньЖурналаРегистрации.Ошибка,,,
...
Функция ПодключенСервисИнтеграции(ПараметрыДоступаКСервису = Неопределено)
	...
	Если Не ДоступнаКонфигурацияСервисаИнтеграции() Тогда
		Возврат Ложь;
	КонецЕсли;
...
Функция ПодключитьПриложениеКСервисуИнтеграции() Экспорт
	...
	Если ДоступнаКонфигурацияСервисаИнтеграции() Или АктивироватьПромокодСервисаИнтеграции() Тогда
