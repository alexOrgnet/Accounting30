...
Процедура ДополнитьНомерамиДоверенностейСообщений(НомераМЧД, ФайлСообщения, ХешПодписи) Экспорт
	...
	Запрос.Текст =
		...
		|ПОМЕСТИТЬ ВТ_НомераДоверенностейСообщений
		|ИЗ
		...
		|	И МашиночитаемыеДоверенностиСообщений.Доверенность НЕ В (&ЗначенияПустойДоверенности)
		|
		|ОБЪЕДИНИТЬ ВСЕ
		|
		|ВЫБРАТЬ РАЗЛИЧНЫЕ
		...
		|	МашиночитаемыеДоверенностиСообщений.ПодписанныйОбъект = &ПодписанныйОбъект
		|	И МашиночитаемыеДоверенностиСообщений.ХешПодписи = &ХешПодписи
		|	И НЕ МашиночитаемыеДоверенностиСообщений.НомерДоверенности = """"
		|;
		|
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
		|	ВТ_НомераДоверенностейСообщений.НомерДоверенности
		|ИЗ
		|	ВТ_НомераДоверенностейСообщений КАК ВТ_НомераДоверенностейСообщений
		|СГРУППИРОВАТЬ ПО
		|	ВТ_НомераДоверенностейСообщений.НомерДоверенности";
