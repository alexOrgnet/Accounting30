...
Процедура ПриОпределенииЗапросаТоварыДокументаОснования(МетаданныеОснования, МетаданныеДокументаИСМП,
	...
	ИначеЕсли МетаданныеОснования = Метаданные.Документы.МаркировкаТоваровИСМП Тогда
		...
		ИнтеграцияИС.ОбновитьТекстЗапросаСРегистромОписаниеНоменклатурыИС(ПодзапросКОформлению, "ОписаниеНоменклатурыИС", "ТаблицаТовары.Номенклатура");
		...
		ИнтеграцияИС.ОбновитьТекстЗапросаСРегистромОписаниеНоменклатурыИС(ПодзапросУжеМаркировано, "ОписаниеНоменклатурыИС", "ТаблицаТовары.Номенклатура");
