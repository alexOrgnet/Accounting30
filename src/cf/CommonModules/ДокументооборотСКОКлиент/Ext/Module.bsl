...
Процедура ОтключитьНедействительныеМЧДФНС(
		...
		ПроверяемыеМЧДФНС = Неопределено,
		ВыбранныеОрганизации = Неопределено,
		ЭтоОтключениеИзПанели = Ложь) Экспорт
...
Процедура ПолучитьНомерМЧДРРПослеПодключенияИнтернетПоддержки(
	...
	Если ДополнительныеПараметры.ФормаДоверенности <> Неопределено Тогда
		ДополнительныеПараметры.ФормаДоверенности.Объект.НомерДоверенности =
			ДополнительныеПараметры.Результат.НомерДоверенности;
		ЭтоВерсия5_02 = (ДополнительныеПараметры.ФормаДоверенности.Объект.ВерсияФормата = "5.02");
...
Процедура ПоказатьРекламуАкцииКадровыеРешения_ОтправитьЗаявление(ОтправитьЗаявление, ВходящийКонтекст) Экспорт
	...
	ОписаниеОповещения = Новый ОписаниеОповещения(
		"ПоказатьРекламуАкцииКадровыеРешения_ПослеВыбораОрганизации", 
		ЭтотОбъект);
		
	Если ЗначениеЗаполнено(ВходящийКонтекст.Организация) Тогда
		ВыполнитьОбработкуОповещения(ОписаниеОповещения, ВходящийКонтекст.Организация);
	Иначе
...
Процедура ПоказатьРекламуАкцииКадровыеРешения_ПослеВыбораОрганизации(ВыбраннаяОрганизация, ВходящийКонтекст) Экспорт
...
Процедура ПоказатьРекламуПромоЕНС_ОтправитьЗаявление(ОтправитьЗаявление, ВходящийКонтекст) Экспорт
	...
	ОписаниеОповещения = Новый ОписаниеОповещения(
		"ПоказатьРекламуПромоЕНС_ПослеВыбораОрганизации", 
		ЭтотОбъект);
...
Процедура ПоказатьРекламуПромоЕНС_ПослеВыбораОрганизации(ВыбраннаяОрганизация, ВходящийКонтекст) Экспорт
