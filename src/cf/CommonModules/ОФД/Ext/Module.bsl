...
//          **** ФискальныйНомер - Число - Фискальный номер корректируемого документа;
...
//          **** Наименование - Строка - Наименование предмета расчета;
//          **** Цена - Число - Стоимость единицы предмета расчета;
//          **** Количество - Число - Количество единиц предмета расчета;
//          **** Сумма - Число - Сумма (с учетом скидок) по предмету расчета;
...
//          **** ПризнакПредметаРасчета - Число - Идентификатор признака расчета. Может принимать одно следующих значений:
//            1 - Товар;
//            2 - Подакцизный товар;
//            3 - Работа;
//            4 - Услуга;
...
//            ПРЕДОПЛАТА100%, ПРЕДОПЛАТА, АВАНС, ПОЛНЫЙРАСЧЕТ, ЧАСТИЧНЫЙРАСЧЕТКРЕДИТ, КРЕДИТ, ОПЛАТАКРЕДИТА;
