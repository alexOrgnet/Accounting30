...
Процедура НастроитьФорму(Форма, ОписаниеДокумента, УчетВозможен = Истина) Экспорт
	...
	Если ПравоДоступа("Чтение", Метаданные.Справочники.ПодключаемоеОборудование) Тогда
		...
		Форма.ИспользуютсяСканерыШтрихкода = (МенеджерОборудованияВызовСервера.СписокОборудования(СписокОборудованияОтбор).Количество() > 0);
	Иначе
...
Процедура ВключитьРегламентноеЗаданиеЗагрузкиКассовыхЧеков() Экспорт
	...
	Отбор = Новый Структура("Метаданные", Метаданные.РегламентныеЗадания.ЗагрузкаКассовыхЧековПодотчетныхЛиц);
	Задания = РегламентныеЗаданияСервер.НайтиЗадания(Отбор);
	
	ПараметрыЗадания = Новый Структура;
	ПараметрыЗадания.Вставить("Использование", Истина);
	ПараметрыЗадания.Вставить("Расписание", РасписаниеЗаданияЕжедневно());
	...
	ПараметрыЗадания.Вставить("Метаданные", Метаданные.РегламентныеЗадания.ЗагрузкаКассовыхЧековПодотчетныхЛиц);
...
Функция РасписаниеЗаданияЕжедневно()
	...
	Расписание.ВремяНачала = ГенераторЧисел.СлучайноеЧисло(0, ДлительностьСуток);
