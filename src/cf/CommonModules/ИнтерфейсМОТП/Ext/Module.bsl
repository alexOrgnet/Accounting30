					...
					Если ТипЗнч(ДанныеОбработки) = Тип("Массив") Тогда
						...
						Для Каждого ЭлементДанных Из ДанныеОбработки Цикл
							...
							Иначе
								...
								ПараметрыКодаМаркировки = ИнтерфейсМОТПСлужебный.ПараметрыКодаМаркировки(ДанныеКодаМаркировки, ВидПродукции, СтруктураДополнительныхПараметров);
		...
		Для Каждого ЗначениеВложенногоКода Из КодыМаркировкиУпаковок Цикл
			...
			Если СтрокаКодаМаркировки.ВидУпаковки = Перечисления.ВидыУпаковокИС.Логистическая
				...
				Если ДобавлятьУпаковкуВДерево(СтрокаКодаМаркировки, Детализация, ДанныеВерхнегоУровня) Тогда
					...
					ЗаполнитьРодительскуюУпаковкуСтрокиДерева(СтрокаДерева, СтрокаКодаМаркировки);
				...
				Иначе
					...
					ЗаполнитьРодительскуюУпаковкуСтрокиДерева(ДанныеСтрокиВместоДанныеВерхнегоУровня, СтрокаКодаМаркировки);
...
Процедура ЗаполнитьРодительскуюУпаковкуСтрокиДерева(СтрокаДерева, ИсточникДанных)
	
	Если ИсточникДанных.Свойство("РодительскаяУпаковка")
		И ЗначениеЗаполнено(ИсточникДанных.РодительскаяУпаковка) Тогда
		СтрокаДерева.РодительскаяУпаковка = ИсточникДанных.РодительскаяУпаковка;
	КонецЕсли;
