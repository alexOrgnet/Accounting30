		...
		Для Каждого ЭлементОчереди Из Очередь Цикл
			...
			Попытка
				...
				ИначеЕсли ДанныеДокумента.Операция = Перечисления.ВидыДокументовЕГАИС.УведомлениеОРегистрацииДвиженияОтчетаОбИмпортеПроизводстве Тогда 
					...
					ДанныеЗагруженногоДокумента = ИнтеграцияЕГАИС.ЗагрузитьУведомлениеОРегистрацииДвиженияОтчетаОбИмпортеПроизводстве(ДанныеДокумента, ОрганизацияЕГАИС, ДополнительныеПараметры);
				...
				ИначеЕсли ДанныеДокумента.Операция = Перечисления.ВидыДокументовЕГАИС.Квитанция
					...
					ДанныеЗагруженногоДокумента = ИнтеграцияЕГАИС.ОбработатьКвитанциюАСИиУ(ДанныеДокумента, ОрганизацияЕГАИС, ДополнительныеПараметры);
...
// 
// Возвращаемое значение:
//  Массив из см. ИнтеграцияЕГАИСКлиентСервер.СтруктураИзменения()
