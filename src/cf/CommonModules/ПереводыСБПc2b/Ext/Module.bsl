...
Функция КарточкаКассовойСсылки(
	...
	Если ПараметрыПечати.ТипПечати = 1 Тогда
		Макет = МодульУправлениеПечатью.МакетПечатнойФормы(
			"ОбщийМакет.ПФ_MXL_КассоваяСсылкаА5Широкий");
	ИначеЕсли ПараметрыПечати.ТипПечати = 2 Тогда
		Макет = МодульУправлениеПечатью.МакетПечатнойФормы(
			"ОбщийМакет.ПФ_MXL_КассоваяСсылкаА5ТолькоЛого");
	ИначеЕсли ПараметрыПечати.ТипПечати = 3 Тогда
		Макет = МодульУправлениеПечатью.МакетПечатнойФормы(
			"ОбщийМакет.ПФ_MXL_КассоваяСсылкаА5Узкий");
	ИначеЕсли ПараметрыПечати.ТипПечати = 4 Тогда
		Макет = МодульУправлениеПечатью.МакетПечатнойФормы(
			"ОбщийМакет.ПФ_MXL_КассоваяСсылкаА5УзкийГоризонтальный");
	ИначеЕсли ПараметрыПечати.ТипПечати = 5 Тогда
		Макет = МодульУправлениеПечатью.МакетПечатнойФормы(
			"ОбщийМакет.ПФ_MXL_КассоваяСсылкаА6Квадратный");
	ИначеЕсли ПараметрыПечати.ТипПечати = 6 Тогда
		Макет = МодульУправлениеПечатью.МакетПечатнойФормы(
			"ОбщийМакет.ПФ_MXL_КассоваяСсылкаА6Круглый");
	Иначе
		Возврат ТабличныйДокумент;
	КонецЕсли;
