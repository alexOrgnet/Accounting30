...
Функция ВидНалогаПоСчетуУчета(СчетУчета, Организация = Неопределено, Знач Период = Неопределено, УровеньБюджета = Неопределено) Экспорт
	...
	ИначеЕсли НайденныеСтроки.Количество() > 1 Тогда
		...
		ИначеЕсли СчетУчета = ПланыСчетов.Хозрасчетный.НДФЛ_ДоходыСвышеПредельнойВеличины Тогда
			...
			ВидНалога = Перечисления.ВидыНалогов.НДФЛ_ДоходыСвышеПредельнойВеличины;
...
Функция НеобходимыеВидыНалогов() Экспорт
	...
	Если УсловияПримененияТребованийЗаконодательства.ЕстьОбъектыТорговогоСбора()
...
Функция ТаблицаСоответствияСчетовУчета()
	...
	ДобавитьСчетУчета(ТаблицаЗначений, Перечисления.ВидыНалогов.НДФЛ_Дивиденды, ПланыСчетов.Хозрасчетный.НДФЛ);
	ДобавитьСчетУчета(ТаблицаЗначений, Перечисления.ВидыНалогов.НДФЛ_Дивиденды_ДоходыСвышеПредельнойВеличины, ПланыСчетов.Хозрасчетный.НДФЛ_ДоходыСвышеПредельнойВеличины);
...
Функция ТаблицаСоответствияЗадачБухгалтера() Экспорт
	...
	ДобавитьКодЗадачи(ТаблицаЗначений, Перечисления.ВидыНалогов.НДФЛ_Дивиденды, "НДФЛ_Агент_Уплата");
	ДобавитьКодЗадачи(ТаблицаЗначений, Перечисления.ВидыНалогов.НДФЛ_Дивиденды_ДоходыСвышеПредельнойВеличины, "НДФЛ_Агент_Уплата");
