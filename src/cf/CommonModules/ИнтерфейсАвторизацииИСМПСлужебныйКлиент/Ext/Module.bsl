...
Процедура Подписать(Сообщения, ПараметрыЗапроса, ОповещениеПриЗавершении) Экспорт
	...
	Сертификаты = ИнтеграцияИСМПВызовСервера.СертификатыПользователяДляПодписиПоОрганизации(ПараметрыЗапроса.Организация, Истина);
	...
	ИнтеграцияИСКлиент.Подписать(ОписаниеДанных, ЭтотОбъект, ПодписатьЗавершение);
