...
// Возвращает ИНН и КПП переданной организации или контрагента, структурой со свойствами:
//
// Параметры:
...
//
Функция ИННКПППоОрганизацииКонтрагенту(ОрганизацияКонтрагент) Экспорт
	
	ИННиКПП = Новый Структура("ИНН, КПП", "", "");
	ИнтеграцияИСПереопределяемый.ЗаполнитьИННКПППоОрганизацииКонтрагенту(ИННиКПП, ОрганизацияКонтрагент);
	Возврат ИННиКПП;
