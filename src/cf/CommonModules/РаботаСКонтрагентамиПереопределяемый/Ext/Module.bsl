...
Процедура ПриОпределенииСтатусаПроверкиКонтрагентаВБазеФНС(
	...
	ИначеЕсли Справочники.Контрагенты.ЭтоСамозанятый(ДанныеКонтрагента.Контрагент) Тогда
		ОтключитьПроверкуФНС = Истина;
		ПричинаОтключения = РаботаСКонтрагентамиБП.ПричинаОтключенияПроверкиФНССамозанятый();
...
Процедура ДополнитьРеквизитыФормыКонтрагент(Форма, НовыеРеквизиты) Экспорт
	...
	ЭтоСамозанятый = Форма.Объект.Самозанятый;
	...
	НовыеРеквизиты.ОтключитьПроверкуФНС = (НовыеРеквизиты.ЭтоИностранныйКонтрагент 
											ИЛИ ЭтоСамозанятый 
											ИЛИ ЭтоФизическоеЛицо);
	
	Если ЭтоСамозанятый Тогда
		НовыеРеквизиты.ПричинаОтключенияПроверкиФНС = РаботаСКонтрагентамиБП.ПричинаОтключенияПроверкиФНССамозанятый();
	ИначеЕсли НовыеРеквизиты.ЭтоИностранныйКонтрагент Тогда
...
Процедура ДополнитьДанныеКонтрагентов(ДанныеКонтрагентов, СтандартнаяОбработка) Экспорт
	...
	Если ОбщегоНазначения.РазделениеВключено()
		...
		Запрос.УстановитьПараметр("ПричинаОтключенияПроверкиСамозанятый",
			РаботаСКонтрагентамиБП.ПричинаОтключенияПроверкиФНССамозанятый());
		...
		Запрос.Текст = 
			...
			|			ТОГДА &ПричинаОтключенияПроверкиСамозанятый
			|		КОГДА ДанныеКонтрагентов.ЭтоИностранныйКонтрагент <> НЕОПРЕДЕЛЕНО
