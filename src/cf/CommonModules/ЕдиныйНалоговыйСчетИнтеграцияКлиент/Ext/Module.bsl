...
Процедура ЗапроситьПодтверждениеРегистрацииEnsIntegration(ПараметрыПолученияДанных) Экспорт
	...
	ПараметрыЗапроса = Новый Структура("Организация, СертификатПодписи, КлючДоступа, ПодписанныйКлюч, НомерМашиночитаемойДоверенности, ОповещениеПослеПодтвержденияРегистрацииEnsIntegration, ТекущаяДата");
...
Процедура АвторизоватьсяНаСервисеEnsIntegration(ПараметрыПолученияДанных) Экспорт
	...
	ПараметрыЗапроса = Новый Структура("Организация, СертификатПодписи, НомерМашиночитаемойДоверенности, ОповещениеПослеАвторизацииНаСервисеEnsIntegration, ТекущаяДата");
	ЗаполнитьЗначенияСвойств(ПараметрыЗапроса, ПараметрыПолученияДанных);
...
Процедура ПолучитьТокенАвторизацииEnsIntegration(Параметры)
	...
	ПараметрыВыполнения = Новый Структура("Организация, СертификатПодписи, НомерМашиночитаемойДоверенности, ОповещениеПослеАвторизацииНаСервисеEnsIntegration, ТекущаяДата");
	ЗаполнитьЗначенияСвойств(ПараметрыВыполнения, Параметры);
