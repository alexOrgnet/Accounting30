...
Процедура ОбновитьПравилоПреобразования(Провайдер, Формат, ОписаниеРесурса, КонтекстДиагностики)
	...
	ОтборНеобработанных = Новый Структура("Обработано", Ложь);
	ПравилаКУдалению = ПравилаФормата.НайтиСтроки(ОтборНеобработанных);
	НаборЗаписей.Очистить();
	Для Каждого ОписаниеПравила Из ПравилаКУдалению Цикл
		НаборЗаписей.Отбор.ИсходныйФормат.Установить(Формат);
		НаборЗаписей.Отбор.ВариантЗаполнения.Установить(ОписаниеПравила.ВариантЗаполнения);
		НаборЗаписей.Отбор.ИтоговыйФормат.Установить(ОписаниеПравила.ИтоговыйФормат);
		НаборЗаписей.Отбор.ВерсияИтоговогоФормата.Установить(ОписаниеПравила.ВерсияИтоговогоФормата);
		УстановитьПривилегированныйРежим(Истина);
		НаборЗаписей.Записать();
		УстановитьПривилегированныйРежим(Ложь);
	КонецЦикла;
