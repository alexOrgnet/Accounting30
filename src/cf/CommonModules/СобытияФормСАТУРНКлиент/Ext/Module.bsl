...
Процедура ОткрытьФормуВыбораОснованияДокументаИС(Форма, ОповещениеПриЗавершении, ИмяДокумента, ТипОбъекта) Экспорт
	...
	Если ТипОбъекта = Тип("ДокументСсылка.АктИнвентаризацииСАТУРН")
		Или ТипОбъекта = Тип("ДокументСсылка.АктПримененияСАТУРН")
		Или ТипОбъекта = Тип("ДокументСсылка.ЗапросОстатковПартийСАТУРН")
		Или ТипОбъекта = Тип("ДокументСсылка.ИмпортПродукцииСАТУРН")
		Или ТипОбъекта = Тип("ДокументСсылка.НакладнаяСАТУРН")
		Или ТипОбъекта = Тип("ДокументСсылка.ПроизводственнаяОперацияСАТУРН") Тогда
	Иначе
		Возврат;
	КонецЕсли;
	...
	ИнтеграцияСАТУРНКлиентСервер.ЗаполнитьСоответствиеПолейДокументовОснований(Форма, ТипОбъекта, СоответствиеПолей);
