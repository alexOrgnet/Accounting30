...
Функция ПолучитьСведенияОПоказателяхОтчета(ИДОтчета, ИДРедакцииОтчета, ПараметрыОтчета = Неопределено) Экспорт
	...
	ИначеЕсли ИДОтчета = "РегламентированныйОтчетУСН" Тогда
		...
		ИначеЕсли ИДРедакцииОтчета = "ФормаОтчета2015Кв1" Или ИДРедакцииОтчета = "ФормаОтчета2023Кв1" Тогда
	...
	ИначеЕсли ИДОтчета = "РегламентированныйОтчетИмущество" Тогда
		...
		ИначеЕсли ИДРедакцииОтчета = "ФормаОтчета2019Кв1" 
			...
			УправлениеВнеоборотнымиАктивами.ПолучитьСведенияОПоказателяхОтчетаИмуществоФормаОтчета2019_2022(ПоказателиОтчета, ИДРедакцииОтчета, ПараметрыОтчета);
...
// Если не разрешен учет регулярной деятельности заполняется только ограниченный набор отчетов.
	...
	ИначеЕсли ИДОтчета = "РегламентированныйОтчетУСН" Тогда
		...
		ИначеЕсли ИДРедакцииОтчета = "ФормаОтчета2021Кв1" Или ИДРедакцииОтчета = "ФормаОтчета2023Кв1"  Тогда
	...
	ИначеЕсли ИДОтчета = "РегламентированныйОтчетИмущество" Тогда
		...
		ИначеЕсли ИДРедакцииОтчета = "ФормаОтчета2022Кв4" Тогда
			...
			Иначе
				УправлениеВнеоборотнымиАктивами.ЗаполнитьОтчетИмуществоФормаОтчета2022(ПараметрыОтчета, Контейнер, ИДРедакцииОтчета);
			КонецЕсли;
	...
	ИначеЕсли ИДОтчета = "РегламентированныйОтчетСтатистикаФормаУчетаПеремещенияТоваровТС" Тогда
		Если ИДРедакцииОтчета = "ФормаАналогЛК" Тогда
			Контейнер = Документы.ЗаявлениеОВвозеТоваров.ПодготовитьТаблицыСтатистическойФормыУчетаПеремещенияТоваровДляВыгрузкиПечати(
				ПараметрыОтчета.МассивДокументов);
			//Контейнер = УчетНДС.ТаблицыСтатистическойФормыУчетаПеремещенияТоваров(
			//	ПараметрыОтчета.МассивДокументов, ПараметрыОтчета.НаправлениеПеремещения);
		КонецЕсли;
	...
	ИначеЕсли ИДОтчета = "РегламентированныйОтчетДоходыИностраннымОрганизациям" Тогда
		...
		Если ИДРедакцииОтчета = "ФормаОтчета2023Кв4" Тогда
			УчетДенежныхСредствБП.ЗаполнитьРегламентированныйОтчетДоходыИностраннымОрганизациям(ПараметрыОтчета, Контейнер);
		КонецЕсли;
