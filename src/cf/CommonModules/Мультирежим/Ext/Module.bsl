...
Функция ИмяПользователяИБ(Пользователь) Экспорт
	...
	УстановитьПривилегированныйРежим(Истина);
	Возврат Пользователи.СвойстваПользователяИБ(Пользователь.ИдентификаторПользователяИБ).Имя
...
Функция ЭтоОбязательныйАдмин(Форма, Строка) Экспорт
	...
	ЭтоТекущий = Строка.ФизическоеЛицо = Форма.ВладелецЭЦП;
	
	Возврат ЭтоТекущий ИЛИ ЭтоПервый;
...
Функция ФизЛицоПоСНИЛС(СНИЛС, ВыводитьОшибку = Ложь) Экспорт
