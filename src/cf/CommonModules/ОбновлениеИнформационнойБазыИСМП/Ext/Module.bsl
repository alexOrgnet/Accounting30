...
#Область Отложенно
	...
	Обработчик.Версия = "10.1.30.1";
	Обработчик.РежимВыполнения = "Отложенно";
	Обработчик.Процедура = "Обработки.ПанельАдминистрированияИСМП.ОбработатьДанныеДляОбновленияИсключенийКонтроляСтатусовИВладельцев";
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("b435ed51-c3c6-4121-a71f-4fcae855e229");
	Обработчик.ПроцедураЗаполненияДанныхОбновления = "Обработки.ПанельАдминистрированияИСМП.ЗарегистрироватьДанныеДляОбновленияИсключенийКонтроляСтатусовИВладельцев";
	Обработчик.ОчередьОтложеннойОбработки = 1;
