...
Процедура ОбъектПередЗаписью(Источник, Отказ) Экспорт
	...
	ИначеЕсли ТипЗнч(Источник) = Тип("СправочникОбъект.МашиночитаемыеДоверенностиКЭДО") Тогда
		ПрежниеДанныеОбъекта = КонтролируемыеДанныеМашиночитаемойДоверенности(Источник);
	Иначе
...
Функция ИменаКонтролируемыхРеквизитов(Объект)
	...
	ИначеЕсли ТипЗнч(Объект) = Тип("СправочникОбъект.МашиночитаемыеДоверенностиКЭДО") Тогда
		ИменаРеквизитов = "Наименование,ДатаНачала,ДатаОкончания,НомерВРеестре,Отозвана";
	ИначеЕсли ТипЗнч(Объект) = Тип("СправочникОбъект.ШаблоныДокументов") Тогда
		ИменаРеквизитов = "Наименование,ТребуетсяСогласование,КодДокументаКадровогоМероприятия,ХешНастроек";
	Иначе
...
Функция КонтролируемыеДанныеМашиночитаемойДоверенности(Объект)
	...
	ДанныеДоверенности = Справочники.МашиночитаемыеДоверенностиКЭДО.ДанныеДоверенности(Объект.Ссылка);
...
Функция ЗначенияКонтролируемыхРеквизитовИзменились(Объект) Экспорт
	...
	Если Не ЗначениеЗаполнено(ЗначенияКонтролируемыхРеквизитов) Тогда
		Возврат Истина;
	Иначе
		Если ТипЗнч(Объект) = Тип("СправочникОбъект.МашиночитаемыеДоверенностиКЭДО") Тогда
			ПроверяемыеДанные = КонтролируемыеДанныеМашиночитаемойДоверенности(Объект.Ссылка);
		Иначе
...
Процедура ПриЗаписиШаблоныДокументов(Объект)
