...
Процедура ИнициализацияНастроекСкачатьДистрибутивАгента(URLДистрибутива, РезультатИнициализации)
	...
	РезультатОперации = ИнтернетПоддержкаПользователей.ЗагрузитьСодержимоеИзИнтернет(URLДистрибутива
		,
		,
		,
		ПараметрыЗапроса);
...
Процедура ИнициализацияНастроекЗарегистрироватьОбъектАрхивирования(РезультатИнициализации, URI)
	...
	Если РезультатОперации.Статус = ИдентификаторСтатусаАгентФайлыДоступны() Тогда
		...
		URLОперации = URLОперацииРегистрацииОбъектаАрхивирования(РезультатИнициализации.ПараметрыАрхивирования.АгентID);
		...
		ПараметрыЗапроса.Вставить("ДанныеДляОбработки"      ,
