...
//		Строка
//
Функция ПредставлениеПрисоединенногоФайла(Наименование, Расширение, Размер) Экспорт 
	
	ПредставлениеНаименование = СтрШаблон("%1.%2",Наименование, Расширение);  
	ПредставлениеРазмер = Формат(Размер / 1024, "ЧДЦ=1") + " " + НСтр("ru = 'Кб'"); 
	
	Возврат СтрШаблон("%1 (%2)", ПредставлениеНаименование, ПредставлениеРазмер);  
