...
Процедура ПослеЗаписиДокументаРеализацииПолномочийНалоговыхОрганов(Сообщение, Файлы) Экспорт
	...
	Если ЗначениеЗаполнено(РеквизитыВходящегоСообщения.ВидДокумента) 
		 И ТипЗнч(РеквизитыВходящегоСообщения.ВидДокумента) = Тип("ПеречислениеСсылка.ВидыНалоговыхДокументов") 
		 И РеквизитыВходящегоСообщения.ВидДокумента <> Перечисления.ВидыНалоговыхДокументов.СообщениеОбИсчисленнойСуммеТранспортногоНалога
	...
	Для Каждого Файл Из Файлы Цикл
		...
		Если НеверноеНачалоИмени Тогда
			...
			Если ВозможныеНачалаИмениФайла.Количество() > 2 Тогда
				...
				КонецЦикла;
				НачалоФайлаОписание.Вставить(СтрСоединить(ПеречислениеЧерезИ, НСтр("ru=' и '")));
				НачалоФайлаОписание.Вставить(""""+ВозможныеНачалаИмениФайла[ВозможныеНачалаИмениФайла.ВГраница()]+"""");
			Иначе
