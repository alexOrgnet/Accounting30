...
// Возвращает причину отключения провекри ФНС для самозанятого
//
// Возвращаемое значение:
//   Строка - Причина отключения для самозанятого
//
Функция ПричинаОтключенияПроверкиФНССамозанятый() Экспорт
	
	Возврат НСтр("ru='самозанятые отсутствуют в базе ФНС'");
