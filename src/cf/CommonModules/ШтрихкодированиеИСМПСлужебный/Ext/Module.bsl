...
Функция ЗаполнитьПоСтрокуПоДаннымШтрихкодовДокумента(ДанныеПоШтрихкодам, СтрокаДанных, ПараметрыСканирования, ДанныеШтрихкодовДокумента) Экспорт
	...
	Если ДанныеШтрихкодовДокумента = Неопределено
		Или Не ШтрихкодированиеИС.ТребуетсяЧастичноеВыбытие(ПараметрыСканирования, ДанныеПоШтрихкодам) Тогда
		Возврат ВозвращаемоеЗначение;
	КонецЕсли;
	
	Если ШтрихкодированиеИСКлиентСервер.ЭтоСтрокаДанныхЧастичногоВыбытия(СтрокаДанных, ПараметрыСканирования) Тогда
...
Процедура ЗаполнитьДанныеНеизвестнойМаркируемойПродукции(ДанныеПоШтрихкодам, ПараметрыСканирования) Экспорт
	...
	Если ИнтеграцияИСМПКлиентСервер.ЗначениеПараметраСканированияЗапрашиватьДанныеСервисаИСМП(ПараметрыСканирования, ДанныеПоШтрихкодам.ОтключитьЗапросВСервисПоОперацииИПродукции) Тогда
...
Процедура ЗаполнитьСтрокиТаблицыДанныхПоГрупповымУпаковкам(ДанныеКодовМаркировки, ПараметрыСканирования, ЗаполнятьКоличествоПотребительскихУпаковок = Истина) Экспорт
	...
	Если НоменклатураКПолучениюОписания.Количество() > 0 Тогда
		ОписанияНоменклатуры = РегистрыСведений.ОписаниеНоменклатурыИС.ПолучитьОписание(НоменклатураКПолучениюОписания);
	КонецЕсли;
	...
	Если ДанныеШтрихкода.ВидПродукции = Перечисления.ВидыПродукцииИС.ПродукцияИзНатуральногоМеха
		...
		ТребуетсяИндивидуализацияRFID = ПараметрыСканирования.ИндивидуализироватьКИЗ
			И (ДанныеШтрихкода.ДанныеRFID = Неопределено
				Или ШтрихкодированиеИСКлиентСервер.ТребуетсяИндивидуализацияRFID(ДанныеШтрихкода.ДанныеRFID, ДанныеШтрихкода.GTIN).НужноЗаписатьМетку);
...
Функция ПроверитьНаНеобходимостьОбновленияКлючаСессии(ДанныеПоШтрихкодам, ПараметрыСканирования) Экспорт
	...
	Если ИнтеграцияИСМПКлиентСервер.ЗначениеПараметраСканированияЗапрашиватьДанныеСервисаИСМП(ПараметрыСканирования, ДанныеПоШтрихкодам.ОтключитьЗапросВСервисПоОперацииИПродукции) Тогда
		...
		РезультатПроверкиАвторизации = ТребуетсяАвторизацияПользователя(ПараметрыСканирования);
		Если Не РезультатПроверкиАвторизации.ТребуетсяОбновлениеКлючаСессии И Не РезультатПроверкиАвторизации.ТребуетсяОбновлениеКлючаСессииРозница Тогда
	...
	Для Каждого СтрокаДанных Из ДанныеПоШтрихкодам.ДанныеКодовМаркировки Цикл
		...
		Если ЗначениеЗаполнено(СтрокаДанных.ВидПродукции)
			...
			Если РезультатПроверкиАвторизации.ТребуетсяОбновлениеКлючаСессии Тогда
			...
			Если РезультатПроверкиАвторизации.ТребуетсяОбновлениеКлючаСессииРозница Тогда
				
				ЗаполнитьРезультатОбработкиТребуетсяАвторизация(РезультатОбработкиШтрихкода, ПараметрыСканирования, Истина);
				ДанныеПоШтрихкодам.ТребуетсяОбновлениеКлючаСессииРозница = Истина;
...
Процедура ЗаполнитьДанныеНеизвестныхУпаковок(ДанныеПоШтрихкодам, ПараметрыСканирования) Экспорт
	...
	Для Каждого СтрокаДанных Из ДанныеПоШтрихкодам.ДанныеКодовМаркировки Цикл
		...
		ПрисутствуетПродукцияИСМП = ШтрихкодированиеИС.ПрисутствуетПродукцияИСМП(СтрокаДанных.ВидыПродукцииКодаМаркировки);
		...
		Если ПрисутствуетПродукцияИСМП
			И Не ИнтеграцияИСМПКлиентСервер.ЗначениеПараметраСканированияЗапрашиватьДанныеНеизвестныхУпаковокИСМП(ПараметрыСканирования)
	...
	Если ИнтеграцияИСМПКлиентСервер.ЗначениеПараметраСканированияЗапрашиватьДанныеНеизвестныхУпаковокИСМП(ПараметрыСканирования, ДанныеПоШтрихкодам.ОтключитьЗапросВСервисПоОперацииИПродукции) Тогда
...
Функция ШтрихкодыУпаковокИзДокумента(Знач ДокументСсылка, Знач ПараметрыСканирования) Экспорт
	...
	Если ШтрихкодированиеИС.ТребуетсяЧастичноеВыбытие(ПараметрыСканирования) Тогда
		Для Каждого ВидПродукции Из ПараметрыСканирования.ДопустимыеВидыПродукции Цикл
			Если ИнтеграцияИСКлиентСерверПовтИсп.ПоддерживаетсяЧастичноеВыбытие(ВидПродукции, ПараметрыСканирования.ВидОперацииИСМП) Тогда
...
Функция ВложенныеШтрихкодыУпаковок(ШтрихкодыУпаковок, ПараметрыСканирования, СортироватьДанные = Ложь) Экспорт
	...
	Если ИзвестныеУпаковки.Количество() > 0 Тогда
		...
		ШтрихкодированиеИС.ЗаполнитьВидыПродукцииВДанныхПоШтрихкодам(ДанныеПоШтрихкодам, ПараметрыСканирования);
		
		ШтрихкодированиеИС.ЗаполнитьДанныеRFID(ДанныеПоШтрихкодам, ПараметрыСканирования);
		
		УстановитьПризнакОтказаОтПроверкиКодовМаркировки(ДанныеПоШтрихкодам, ПараметрыСканирования);
...
Функция ВложенныеШтрихкоды(ДанныеШтрихкодовСписок, ПараметрыСканирования, ДляУпаковокТребоватьПодключениеМОТП = Истина, СортироватьДанные = Ложь) Экспорт
	...
	Если ИнтеграцияИСМПКлиентСервер.ЗначениеПараметраСканированияЗапрашиватьДанныеНеизвестныхУпаковокИСМП(ПараметрыСканирования) Тогда
...
Процедура ЗаполнитьРасширенноеПредставлениеОшибки(ПредставлениеОшибки, ПараметрыДополнения, Форма) Экспорт
	...
	Если ПараметрыДополнения.ТокенАвторизацииГИСМТ Тогда
		
		Форма.ПоказатьДерево = Ложь;
		ДобавляемыеЧасти.Добавить(НСтр("ru = 'Произошла ошибка при авторизации в ИС МП.'"));
	...
	Если ЗначениеЗаполнено(ПараметрыДополнения.Статус) Тогда
		...
		Если Не ВыведеноОтключение И Не ПараметрыДополнения.ЗапретитьОтключениеКонтролейСтатусовИВладельцев Тогда
	...
	Для Каждого КлючИЗначение Из РезультатЗапроса.СтатусыКодовМаркировки Цикл
		...
		Если ЗначениеЗаполнено(ВидПродукции) Тогда
			...
			Если СтрокаТаблицыДанных.ДанныеРазбора = Неопределено Тогда
				ШтрихкодированиеИС.УточнитьДанныеРазбораПоВидуПродукции(СтрокаТаблицыДанных, СтрокаТаблицыДанных.ВидПродукции);
			КонецЕсли;
		КонецЕсли;
...
Функция ДанныеКОпределениюВидаУпаковки(ПараметрыОбмена) Экспорт
	...
	Если Не РезультатОбработкиШтрихкодов.ДанныеПоШтрихкодам.ТребуетсяОбновлениеКлючаСессии Тогда
		...
		ДанныеУточнения = ШтрихкодированиеИС.ИнициализироватьТаблицуУточненияКоэффициентовУпаковок();
...
Процедура УстановитьПризнакОтказаОтПроверкиКодовМаркировки(ДанныеПоШтрихкодам, ПараметрыСканирования) Экспорт
	...
	Для Каждого СтрокаДанных Из ДанныеПоШтрихкодам.ДанныеКодовМаркировки Цикл
		...
		Если Не НеобходимоДелатьЗапрос И 
			ИнтеграцияИСМПКлиентСерверПовтИсп.ПродукцияПодлежитОбязательнойОнлайнПроверкеПередРозничнойПродажей(СтрокаДанных.ВидПродукции, ПараметрыСканирования.ВидОперацииИСМП, ПараметрыСканирования.ТребуетсяПроверкаСредствамиККТ) Тогда
			Продолжить;
		КонецЕсли;
...
Процедура ОчиститьДанныеРазрешительногоРежимаПриИзмененииОрганизации(ДокументОбъект) Экспорт
	...
	ПараметрыСканированияЗаписываемогоОбъекта = ШтрихкодированиеИС.ПараметрыСканирования(ДанныеШапкиЗаписываемогоОбъекта);
	ПараметрыСканированияОбъектаВБазе         = ШтрихкодированиеИС.ПараметрыСканирования(ДанныеШапкиОбъектаВБазе);
	...
	Если Не ДанныеШапкиЗаписываемогоОбъекта.Организация = ДанныеШапкиОбъектаВБазе.Организация Тогда
		...
		Если ЗначениеЗаполнено(ПараметрыСканированияЗаписываемогоОбъекта.ИмяКолонкиРазрешительныйРежимИдентификаторЗапросаГИСМТ) Тогда
			ПустыеЗначенияКолонокКОчистке.Вставить(ПараметрыСканированияЗаписываемогоОбъекта.ИмяКолонкиРазрешительныйРежимИдентификаторЗапросаГИСМТ, ИнтеграцияИС.ПустоеЗначениеОпределяемогоТипа("УникальныйИдентификаторИС"));
		КонецЕсли;
	...
	Если Не ПараметрыСканированияОбъектаВБазе.ИмяКолонкиРазрешительныйРежимИдентификаторЗапросаГИСМТ = ПараметрыСканированияЗаписываемогоОбъекта.ИмяКолонкиРазрешительныйРежимИдентификаторЗапросаГИСМТ
		...
		Если ЗначениеЗаполнено(ПараметрыСканированияОбъектаВБазе.ИмяКолонкиРазрешительныйРежимИдентификаторЗапросаГИСМТ) Тогда
			ПустыеЗначенияКолонокКОчистке.Вставить(ПараметрыСканированияОбъектаВБазе.ИмяКолонкиРазрешительныйРежимИдентификаторЗапросаГИСМТ, ИнтеграцияИС.ПустоеЗначениеОпределяемогоТипа("УникальныйИдентификаторИС"));
		КонецЕсли;
...
Процедура ЗаполнитьПараметрыДополненияВложенныхШтрихкодов(ПараметрыДополнения, ШтрихкодыУпаковок, ПараметрыСканирования) Экспорт
	...
	Для Каждого СтрокаТаблицы Из ШтрихкодыУпаковок Цикл
		...
		Если ЕстьВидПродукцииВСтроке Тогда
			...
			СтрокаЧастичногоВыбытия     = ШтрихкодированиеИСКлиентСервер.ЭтоСтрокаДанныхЧастичногоВыбытия(СтрокаТаблицы, ПараметрыСканирования,, Истина);
			СтрокаРазрешительногоРежима = ИнтеграцияИСМПКлиентСерверПовтИсп.ПродукцияПодлежитОбязательнойОнлайнПроверкеПередРозничнойПродажей(
...
Процедура ОбработатьУточнениеДанныхЧастичноеВыбытие(ДанныеВыбора, ДанныеШтрихкода, ПараметрыСканирования) Экспорт
	...
	Если Не ШтрихкодированиеИСКлиентСервер.ЭтоСтрокаДанныхЧастичногоВыбытия(ДанныеШтрихкода, ПараметрыСканирования) Тогда
		Возврат;
	КонецЕсли;
...
Процедура ДобавитьСтрокуДляЗаполненияДаннымиЧастичногоВыбытия(СтрокаДанных, ПараметрыСканирования, ДанныеЗаполнения) Экспорт
	...
	Если Не ИнтеграцияИСМПКлиентСерверПовтИсп.ПоддерживаетсяЧастичноеВыбытие(
...
Функция ЭтоПродажаВыбывшегоЧастично(СтрокаДанных, ПараметрыСканирования, ДопустимыеСтатусы) Экспорт
	...
	ПоддерживаетсяЧастичноеВыбытие = ИнтеграцияИСМПКлиентСерверПовтИсп.ПоддерживаетсяЧастичноеВыбытие(
		СтрокаДанных.ВидПродукции,
		ПараметрыСканирования.ВидОперацииИСМП);
...
Функция СтрокаСодержитОшибкиЧастичногоВыбытия(СтрокаДанных, ПараметрыСканирования, ПравилаПроверкиНаОшибки, КэшМаркируемойПродукции) Экспорт
	...
	ВидПродукцииПоддерживаетЧастичноеВыбытие = ИнтеграцияИСМПКлиентСерверПовтИсп.ПоддерживаетсяЧастичноеВыбытие(
		СтрокаДанных.ВидПродукции);
	...
	ВидОперацииПоддерживаетЧастичноеВыбытие = ИнтеграцияИСМПКлиентСерверПовтИсп.ПоддерживаетсяЧастичноеВыбытие(
		СтрокаДанных.ВидПродукции,
		ПараметрыСканирования.ВидОперацииИСМП);
	...
	Если Не ЕстьОшибки
		И Не ШтрихкодированиеИСКлиентСервер.ЭтоСтрокаДанныхЧастичногоВыбытия(СтрокаДанных, ПараметрыСканирования,, Истина) Тогда
		
		Если КэшМаркируемойПродукции = Неопределено Тогда
...
Процедура ОписаниеОшибокКонтроляЧастичногоВыбытия(ПравилаПроверкиНаОшибки, ПараметрыСканирования, ОбработкаСтрокиТаблицы = Ложь) Экспорт
	...
	Если ПравилаПроверкиНаОшибки.Свойство("КодМаркировкиВыбывалЧастичноОперацияНевозможна")
		...
		Для Каждого СтрокаДанных Из ПравилаПроверкиНаОшибки.КодМаркировкиВыбывалЧастичноОперацияНевозможна Цикл
			...
			ИначеЕсли СтрокаДанных.ВидПродукции = Перечисления.ВидыПродукцииИС.НикотиносодержащаяПродукция Тогда
				ОписаниеПроблемы = НСтр("ru = 'Операция не поддерживается. Единицы продукции ранее продавались поштучно.'");
			ИначеЕсли СтрокаДанных.ВидПродукции = Перечисления.ВидыПродукцииИС.Духи Тогда
	...
	Если ПравилаПроверкиНаОшибки.Свойство("КонтрольУжеДобавленоВДокумент")
		...
		Для Каждого СтрокаДанных Из ПравилаПроверкиНаОшибки.КонтрольУжеДобавленоВДокумент Цикл
			...
			СтрокаДанных.ТекстОшибки = ШтрихкодированиеИС.ТекстОшибкиУжеДобавленаВДокумент();
...
Процедура ЗаполнитьДанныеИдентификатораРозничнойПродажиПоОбязательнымТоварнымГруппам(ДанныеПоШтрихкодам, ПараметрыСканирования) Экспорт
	...
	Если Не ПараметрыСканирования.ЭтоПроверкаКодовМаркировкиИСМП
		И (Не ИнтеграцияИСМПКлиентСервер.ЗначениеПараметраСканированияЗапрашиватьДанныеСервисаИСМП(ПараметрыСканирования)
	...
	Для Каждого СтрокаДанных Из ДанныеПоШтрихкодам.ДанныеКодовМаркировки Цикл
		...
		Если ЗначениеЗаполнено(СтрокаДанных.ВидПродукции)
			И Не ИнтеграцияИСПовтИсп.ЭтоПродукцияИСМП(СтрокаДанных.ВидПродукции, Истина) Тогда
			Продолжить;
		КонецЕсли;
		
		ПрисутствуетПродукцияИСМП = ШтрихкодированиеИС.ПрисутствуетПродукцияИСМП(СтрокаДанных.ВидыПродукцииКодаМаркировки, Истина);
		
		Если Не ПрисутствуетПродукцияИСМП Тогда
			Продолжить;
		КонецЕсли;
		
		ПроверкаПиваВРозницуСЧастичнымВыбытием = (СтрокаДанных.ВидПродукции = Перечисления.ВидыПродукцииИС.Пиво
		...
		ПолучатьДанныеГИСМТ = ИнтеграцияИСМПКлиентСерверПовтИсп.ПродукцияПодлежитОбязательнойОнлайнПроверкеПередРозничнойПродажей(
		...
		Если ЭтоПолныйКодМаркировки(СтрокаДанных, ЗначениеЗаполнено(СтрокаДанных.ВидУпаковки))
	...
	Результат = ИнтерфейсИСМП.СокращеннаяИнформацияПоКМПриРозничнойПродаже(ДанныеКМ,
		ПараметрыСканирования.Организация,
	...
	Если Результат.АварийныйРежим Тогда
		...
		Для Каждого СтрокаДанныхПоШтрихкодам Из ДанныеПоШтрихкодам.ДанныеКодовМаркировки Цикл
			СтрокаДанныхПоШтрихкодам.РазрешительныйРежимКодОтвета       = ИнтеграцияИСМПКлиентСерверПовтИсп.АварийныйРежимКодОтветаСервисаГИСМТ();
		КонецЦикла;
	...
	Для Каждого СтрокаДанныхПоШтрихкодам Из ДанныеПоШтрихкодам.ДанныеКодовМаркировки Цикл
		...
		Если Результат.ОтсутствуютCDNПлощадки Тогда
			...
			ВидДополнения.ВидОперацииИСМП      = ПараметрыСканирования.ВидОперацииИСМП;
			ДополнитьПредставлениеОшибки(СтрокаДанныхПоШтрихкодам, ВидДополнения);
		...
		Если ПараметрыКодаМаркировки <> Неопределено Тогда
			...
			НаличиеСерыхКодов = ИнтеграцияИСПовтИсп.ЭтоПродукцияМОТП(СтрокаДанных.ВидПродукции)
		...
		ИначеЕсли Результат.КодыМаркировкиБезДанныхГИСМТ.Получить(СтрокаДанныхПоШтрихкодам) <> Неопределено Тогда
			...
			СтрокаДанныхПоШтрихкодам.РазрешительныйРежимДатаЗапросаГИСМТ = Формат(ИнтеграцияИС.ДатаВСтрокуUNIX(ТекущаяДатаСеанса()), "ЧРГ=; ЧГ=0;");
...
Процедура ЛогироватьРезультатыОперацийПроверкиКМ(ДанныеДляЛогирования) Экспорт
	...
	Если ИнтеграцияИСМП.ВерсияБПОПоддерживаетПроверкуКМЕдинымМетодом() Тогда
...
Функция ТребуетсяАвторизацияПользователя(ПараметрыСканирования) Экспорт
	...
	РезультатПроверки.Вставить("ТребуетсяОбновлениеКлючаСессииРозница", Ложь);
	
	Если ИнтеграцияИСМПКлиентСервер.ЗначениеПараметраСканированияЗапрашиватьДанныеСервисаИСМП(ПараметрыСканирования) Тогда
		
		ТребуетсяПроверкаРозничногоТокена = Ложь;
		
		Для Каждого СканируемаяТоварнаяГруппа Из ПараметрыСканирования.ДопустимыеВидыПродукции Цикл
			
			Если ИнтеграцияИСМПКлиентСерверПовтИсп.ПродукцияПодлежитОбязательнойОнлайнПроверкеПередРозничнойПродажей(
				СканируемаяТоварнаяГруппа, ПараметрыСканирования.ВидОперацииИСМП, ПараметрыСканирования.ТребуетсяПроверкаСредствамиККТ) Тогда
				
				ТребуетсяПроверкаРозничногоТокена = Истина;
				Прервать;
		...
		Если ТребуетсяПроверкаРозничногоТокена Тогда
			РезультатПроверки.ТребуетсяОбновлениеКлючаСессииРозница = ИнтерфейсАвторизацииИСМПВызовСервера.ТребуетсяОбновлениеКлючаСессииСУчетомВидаТокена(ПараметрыСканирования, Истина);
		КонецЕсли;
		
		РезультатПроверки.ТребуетсяОбновлениеКлючаСессии = ИнтерфейсАвторизацииИСМПВызовСервера.ТребуетсяОбновлениеКлючаСессииСУчетомВидаТокена(ПараметрыСканирования);
	...
	Если Не ПараметрыСканирования.ИспользуетсяСоответствиеШтрихкодовСтрокДерева
		...
		Для Каждого СтрокаДанных Из ДанныеПоШтрихкодам.ВложенныеШтрихкоды.МаркированныеТовары Цикл
			...
			Если СтрокаДанных.СтрокаДерева <> Неопределено
				И ИнтеграцияИСПовтИсп.ЭтоПродукцияИСМП(СтрокаДанных.ВидПродукции)
...
Функция НастройкиЧастичногоВыбытияПоТаблицеНоменклатуры(ТаблицаНоменклатуры)
	...
	Запрос.Текст =
		...
		|	НастройкиЧастичногоВыбытия.НоменклатураЧастичногоВыбытия   КАК НастроеннаяНоменклатура,
		|	НастройкиЧастичногоВыбытия.ХарактеристикаЧастичногоВыбытия КАК НастроеннаяХарактеристика,
		...
		|		ПО ИсходнаяТаблицаВременная.Номенклатура = НастройкиЧастичногоВыбытия.Номенклатура
		|		И ИсходнаяТаблицаВременная.Характеристика = НастройкиЧастичногоВыбытия.Характеристика";
	
	Запрос.УстановитьПараметр("ИсходнаяТаблица", ТаблицаНоменклатуры);
	
	РезультатЗапроса = Запрос.Выполнить().Выгрузить();
	
	ОписанияНоменклатур = РегистрыСведений.ОписаниеНоменклатурыИС.ПолучитьОписание(РезультатЗапроса.ВыгрузитьКолонку("Номенклатура"));
...
Процедура ЗаполнитьРезультатОбработкиШтрихкодаЧастичноеВыбытие(ДанныеШтрихкода, РезультатОбработки, ПараметрыСканирования) Экспорт
	...
	Если Не ПараметрыСканирования.ЭтоПроверкаКодовМаркировкиИСМП
		...
		И ИнтеграцияИСМПКлиентСерверПовтИсп.ПоддерживаетсяЧастичноеВыбытие(
			...
			ПараметрыСканирования.ВидОперацииИСМП)
		И ДанныеШтрихкода.ВидУпаковки = Перечисления.ВидыУпаковокИС.Потребительская
		И ШтрихкодированиеИС.ТребуетсяЧастичноеВыбытие(ПараметрыСканирования)
...
Процедура ЗаполнитьРезультатОбработкиШтрихкодаПроверкаСредствамиККТ(ДанныеШтрихкода, РезультатОбработки, ПараметрыСканирования) Экспорт
	...
	Если ДанныеШтрихкода <> Неопределено
		...
		Если ЗначениеЗаполнено(ПараметрыСканирования.ККТФФД12ИСМП) Тогда
			...
			ЗаполнитьВложенныеШтрихкодыДляПроверкиККТ(РезультатОбработки, ДанныеШтрихкода, ПараметрыСканирования);
...
Процедура ПроверитьНаОшибкиПоПравилам(ДанныеПоШтрихкодам, ПравилаПроверкиНаОшибки, ПараметрыСканирования, ЕстьОшибки)
	...
	Если ДанныеПоШтрихкодам.ВложенныеШтрихкоды <> Неопределено Тогда
		...
		Если ПравилаПроверкиНаОшибки.Свойство("КонтрольСтатусов")
			...
			Для Каждого СтрокаДерева Из ПравилаПроверкиНаОшибки.КонтрольСтатусов.СтрокиСОшибками Цикл
				...
				ЗапретитьОтключениеКонтролейСтатусовИВладельцев = ИнтеграцияИСМПКлиентСерверПовтИсп.ПродукцияПодлежитОбязательнойОнлайнПроверкеПередРозничнойПродажей(
				...
				ВидДополнения.ЗапретитьОтключениеКонтролейСтатусовИВладельцев = ЗапретитьОтключениеКонтролейСтатусовИВладельцев;
		...
		Если ПравилаПроверкиНаОшибки.Свойство("КонтрольКоличестваМерногоТовара")
			...
			Для Каждого СтрокаДерева Из ПравилаПроверкиНаОшибки.КонтрольКоличестваМерногоТовара Цикл
				...
				СтрокаДерева.ТекстОшибки = ШтрихкодированиеИС.ТекстОшибкиТребуетсяУточнениеКоличества();
				СтрокаДерева.ЕстьОшибки = Истина;
		...
		ОписаниеОшибокКонтроляЧастичногоВыбытия(ПравилаПроверкиНаОшибки, ПараметрыСканирования);
	...
	Если ПравилаПроверкиНаОшибки.Свойство("КонтрольКоличестваМерногоТовара")
		...
		Для Каждого СтрокаДанных Из ПравилаПроверкиНаОшибки.КонтрольКоличестваМерногоТовара Цикл
			...
			СтрокаДанных.ТекстОшибки = ШтрихкодированиеИС.ТекстОшибкиТребуетсяУточнениеКоличества();
	...
	Если ПравилаПроверкиНаОшибки.Свойство("КонтрольЭтоВесоваяПродукция")
		...
		Для Каждого СтрокаДанных Из ПравилаПроверкиНаОшибки.КонтрольЭтоВесоваяПродукция Цикл
			...
			СтрокаДанных.ТекстОшибки = ШтрихкодированиеИС.ТекстОшибкиТолькоВесоваяПродукция(СтрокаДанных);
	...
	Для Каждого СтрокаДерева Из СтрокиДерева Цикл
		...
		Если ПравилаПроверкиНаОшибки.Свойство("КонтрольПолногоКодаМаркировки") Тогда
			...
			Если СтрокаДанных <> Неопределено Тогда
				...
				Если ИнтеграцияИСМПКлиентСерверПовтИсп.ПродукцияПодлежитОбязательнойОнлайнПроверкеПередРозничнойПродажей(СтрокаДанных.ВидПродукции,
					ПараметрыСканирования.ВидОперацииИСМП,
				...
				ПродукцияПодлежащаяРозничномуКонтролю = 
					ИнтеграцияИСМПКлиентСерверПовтИсп.ПродукцияПодлежитОбязательнойОнлайнПроверкеПередРозничнойПродажей(СтрокаДанных.ВидПродукции,
					ПараметрыСканирования.ВидОперацииИСМП,
	...
	Для Каждого СтрокаДанных Из ДанныеПоШтрихкодам.ДанныеКодовМаркировки Цикл
		...
		Если ПравилаПроверкиНаОшибки.Свойство("КонтрольСтатусов")
			...
			ИначеЕсли ЗначениеЗаполнено(СтрокаДанных.РазрешительныйРежимДатаЗапросаГИСМТ) И СтрДлина(СтрокаДанных.СоставКодаМаркировки.СерийныйНомер) = 8
				И ИнтеграцияИСКлиентСервер.ЭтоМолочнаяПродукцияИСМП(СтрокаДанных.ВидПродукции)
		...
		Если ПравилаПроверкиНаОшибки.Свойство("КонтрольПолногоКодаМаркировки")
			...
			Если ВыполнятьКонтроль
				...
				Если ПараметрыСканирования.ТребоватьПолныйКодМаркировкиИСМП
					Или КодВключаетКриптоХвост
					Или ИнтеграцияИСМПКлиентСерверПовтИсп.ПродукцияПодлежитОбязательнойОнлайнПроверкеПередРозничнойПродажей(
...
Процедура ПроверитьЗаполнениеИдентификатораВЕТИССтроки(СтрокаДанных)
	Если ИнтеграцияИСКлиентСервер.ЭтоПродукцияПодконтрольнаяВЕТИС(СтрокаДанных.ВидПродукции) Тогда
...
Функция ТребуетсяВыборСерии(ДанныеШтрихкода, ПараметрыСканирования) Экспорт
	...
	ВДетализацииНеОбязательныГрупповыеУпаковки = (ПараметрыСканирования.ДетализацияСтруктурыХранения = Перечисления.ДетализацияСтруктурыХраненияИС.ПалетыСМонотоварнымиКоробами);
	...
	ИначеЕсли ДанныеШтрихкода.ВидУпаковки = Перечисления.ВидыУпаковокИС.Групповая
		...
		ЭтоФормаПроверкиИПодбораВДокументаМаркировка = (ТипЗнч(ПараметрыСканирования.СсылкаНаОбъект) = Тип("ДокументСсылка.МаркировкаТоваровИСМП")
	...
	ИначеЕсли ДанныеШтрихкода.ВидУпаковки = Перечисления.ВидыУпаковокИС.Логистическая Тогда
		ВидУпаковкиПодходит = ВДетализацииНеОбязательныГрупповыеУпаковки И ЗначениеЗаполнено(ДанныеШтрихкода.GTIN);
	КонецЕсли;
	
	Если ВидУпаковкиПодходит Тогда
		Возврат ИнтеграцияИС.ТребуетсяВыборСерии(ДанныеШтрихкода, ПараметрыСканирования);
	КонецЕсли;
...
Функция ПравилаПроверкиНаОшибки(ПараметрыСканирования, ДанныеПоШтрихкодам, ПроверенныеШтрихкоды = Неопределено)
	...
	Если ПараметрыСканирования.ДопустимыеСтатусыИСМП.Количество() > 0
		И ИнтеграцияИСМПКлиентСервер.ЗначениеПараметраСканированияЗапрашиватьДанныеСервисаИСМП(ПараметрыСканирования, ДанныеПоШтрихкодам.ОтключитьЗапросВСервисПоОперацииИПродукции)
		И Не ИнтеграцияИСМПКлиентСерверПовтИсп.ДействуетАварийныйРежимДляРозничныхПродаж() Тогда
	...
	Если ДопустимыеСпособыВвода.Количество() > 0 Тогда
		Если ИнтеграцияИСМПКлиентСервер.ЗначениеПараметраСканированияЗапрашиватьДанныеСервисаИСМП(ПараметрыСканирования, ДанныеПоШтрихкодам.ОтключитьЗапросВСервисПоОперацииИПродукции)
			И Не ИнтеграцияИСМПКлиентСерверПовтИсп.ДействуетАварийныйРежимДляРозничныхПродаж() Тогда
	...
	Если ИнтеграцияИСМПКлиентСервер.ЗначениеПараметраСканированияЗапрашиватьДанныеСервисаИСМП(ПараметрыСканирования, ДанныеПоШтрихкодам.ОтключитьЗапросВСервисПоОперацииИПродукции)
		И Не ИнтеграцияИСМПКлиентСерверПовтИсп.ДействуетАварийныйРежимДляРозничныхПродаж()
	...
	Если ПараметрыСканирования.ЗаполнятьСрокГодности
		И ИнтеграцияИСМПКлиентСервер.ЗначениеПараметраСканированияЗапрашиватьДанныеСервисаИСМП(ПараметрыСканирования) Тогда
	...
	Для Каждого ДопустимыйВидПродукции Из ПараметрыСканирования.ДопустимыеВидыПродукции Цикл
		...
		Если ИнтеграцияИСМПКлиентСерверПовтИсп.ПродукцияПодлежитОбязательнойОнлайнПроверкеПередРозничнойПродажей(ДопустимыйВидПродукции,
			ПараметрыСканирования.ВидОперацииИСМП,
			ПараметрыСканирования.ТребуетсяПроверкаСредствамиККТ) Тогда
...
Процедура ЗаполнитьДанныеНеизвестнойМаркируемойПродукцииСЗапросомСведенийИСМП(ДанныеПоШтрихкодам, ПараметрыСканирования)
	...
	Для Каждого СтрокаТаблицы Из ДанныеПоШтрихкодам.ДанныеКодовМаркировки Цикл
		...
		Если Не СтрокаТаблицы.Идентифицирован
			...
			И Не ИнтеграцияИСМПКлиентСерверПовтИсп.ПродукцияПодлежитОбязательнойОнлайнПроверкеПередРозничнойПродажей(СтрокаТаблицы.ВидПродукции, 
				ПараметрыСканирования.ВидОперацииИСМП,
				ПараметрыСканирования.ТребуетсяПроверкаСредствамиККТ)
	...
	Для Каждого СтрокаДанных Из ДанныеПоШтрихкодам.ДанныеКодовМаркировки Цикл
		...
		Если ИнтеграцияИСКлиентСервер.ЭтоУпаковкаПоВиду(СтрокаДанных.ВидУпаковки,, Ложь)
			...
			И (СтрокаДанных.ВидУпаковки = Перечисления.ВидыУпаковокИС.Групповая
				И Не ИнтеграцияИСМПКлиентСерверПовтИсп.ПродукцияПодлежитОбязательнойОнлайнПроверкеПередРозничнойПродажей(СтрокаДанных.ВидПродукции,
					ПараметрыСканирования.ВидОперацииИСМП,
					ПараметрыСканирования.ТребуетсяПроверкаСредствамиККТ)
...
Процедура НормализоватьДанныеДереваУпаковок(ДеревоУпаковок, ПараметрыСканирования, ДанныеКодовМаркировки = Неопределено, ТолькоПересчетНоменклатурыИКоличества = Ложь, ЗаполнятьСтрокиДерева = Ложь) Экспорт
	...
	Если ПараметрыСканирования.ЭтоПроверкаКодовМаркировкиИСМП Тогда
		...
		ШтрихкодированиеМОТП.НормализироватьДанныеДереваУпаковокПоПереданнымКолонкам(ДеревоУпаковок, КоллекцияДополнительныхКолонок, ДобавленныеКолонки);
	КонецЕсли;
...
Процедура ПараметрыСлиянияДанных(ПараметрыЗаполнения, Приемник, Источник) Экспорт
	...
	Если ПараметрыЗаполнения.Кэш.ЗаполняемыеКолонки = Неопределено Тогда
		...
		ИменаКолонокДляЗаполнения = ШтрихкодированиеИС.ИменаКолонокДляЗаполнения();
...
Функция НормализоватьСвойстваКоллекцииВложенныхШтрихкодов(Коллекция, ПараметрыСканирования = Неопределено) Экспорт
	...
	ШтрихкодированиеМОТП.КоллекцияДополнительныхКолонокДереваУпаковокИСМП(ПараметрыДерева, КоллекцияОбязательныхКолонок);
