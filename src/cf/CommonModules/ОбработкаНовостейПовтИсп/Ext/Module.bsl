...
Функция ПолучитьЛентуНовостейПоКоду(ЛентаНовостейКод) Экспорт
	...
	Если ТипЗнч(ЛентаНовостейКод) <> ТипСтрока
			ИЛИ ПустаяСтрока(ЛентаНовостейКод) Тогда
		ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='ПолучитьЛентуНовостейПоКоду: параметр [ЛентаНовостейКод] недопустимого типа [%1] или пустая строка.'"), ТипЗнч(ЛентаНовостейКод));
