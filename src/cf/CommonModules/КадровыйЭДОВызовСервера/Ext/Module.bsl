...
Процедура ЗапонитьНастройкиПодписанияОрганизаций(НастройкиПодписанияОрганизаций) Экспорт
...
Процедура ЗапонитьПодписыватьСертификатамиГоловнойОрганизации(ПодписыватьСертификатамиГоловнойОрганизации) Экспорт
	ОбщегоНазначения.ХранилищеОбщихНастроекСохранить("ЭлектронныйКадровыйДокументооборот",
...
Процедура ОчиститьНастройкиПодписанияПечатныхФорм() Экспорт
	...
	ЗапонитьНастройкиПодписанияОрганизаций(Неопределено);
	ЗапонитьПодписыватьСертификатамиГоловнойОрганизации(Неопределено);
КонецПроцедуры
