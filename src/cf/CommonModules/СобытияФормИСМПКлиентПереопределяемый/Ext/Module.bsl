...
Процедура ПриСозданииНоменклатуры(Владелец, ДанныеСтроки, СтандартнаяОбработка, ВидПродукцииИС) Экспорт
	...
	ИмяРеквизитаНоменклатуры = ИнтеграцияИСМПБПВызовСервера.ИмяРеквизитаНоменклатурыПоВидуПродукцииИС(ВидПродукцииИС);
	ПараметрыФормы.Вставить(ИмяРеквизитаНоменклатуры, Истина);
...
Функция ПараметрыОтбора(ВидПродукцииИС)
	...
	Для Каждого ЭлементМассива Из ВидПродукцииИС Цикл
		ИмяРеквизита = ИнтеграцияИСМПБПВызовСервера.ИмяРеквизитаНоменклатурыПоВидуПродукцииИС(ЭлементМассива);
		ПараметрыОтбора.Добавить(ИмяРеквизита);
	КонецЦикла;
