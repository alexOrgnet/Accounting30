...
Функция ШаблонУведомленияОбИспользованииПЭП(ПараметрыЗаполнения) Экспорт
	...
	Для Каждого Пользователь Из СписокПользователей Цикл
		...
		СтруктураПараметров.Вставить("ФИОСотрудника", ФизическиеЛицаКлиентСервер.ФамилияИнициалы(ДанныеСотрудника.ИмяПолное));
