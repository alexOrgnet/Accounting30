...
Процедура ПроверитьЗаполнение_Раздел1(КонтекстВыполнения)
	...
	Если ВРег(КонтекстВыполнения.ИмяФормы) = ВРег("ФормаОтчета2023Кв1")
		ИЛИ ВРег(КонтекстВыполнения.ИмяФормы) = ВРег("ФормаОтчета2022Кв1") Тогда
		
		Если ВРег(КонтекстВыполнения.ИмяФормы) = ВРег("ФормаОтчета2023Кв1") Тогда
...
Процедура ПроверитьЗаполнение_Раздел2(КонтекстВыполнения)
	...
	Если ВРег(СокрЛП(КонтекстВыполнения.ИмяФормы)) = ВРег("ФормаОтчета2023Кв1") Тогда
	...
	Для Каждого СтраницаРаздела Из ДанныеРаздела Цикл
		...
		Если ВРег(СокрЛП(КонтекстВыполнения.ИмяФормы)) = ВРег("ФормаОтчета2023Кв1")
