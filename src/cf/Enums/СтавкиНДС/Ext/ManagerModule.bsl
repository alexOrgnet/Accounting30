...
Процедура ОбработкаПолученияДанныхВыбора(ДанныеВыбора, Параметры, СтандартнаяОбработка)
	...
	ИначеЕсли Параметры.Свойство("РозничнаяПродажа") Тогда
		
		// Ограниченный список для чека и отчета о розничной продаже
		...
		Иначе
			ДанныеВыбора.Добавить(Перечисления.СтавкиНДС.НДС20);
			ДанныеВыбора.Добавить(Перечисления.СтавкиНДС.НДС10);
			// С 2022 года гостиничные услуги облагаются по ставке 0%
			Если ТекущаяДатаПользователя >= '20220701' Тогда
