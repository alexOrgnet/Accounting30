...
Процедура УстановитьОтбор()
	...
	ПараметрыОтбора.Вставить("РолиИсполнителя",        РолиИсполнителя);
	ПараметрыОтбора.Вставить("ГруппыИсполнителяЗадач", ГруппыИсполнителяЗадач);
...
Процедура СписокПередНачаломДобавления(Элемент, Отказ, Копирование, Родитель, Группа, Параметр)
	...
	Если Копирование Тогда
		Если Элемент.ТекущиеДанные <> Неопределено Тогда
			Отказ = Элемент.ТекущиеДанные.БизнесПроцесс <> Неопределено;
...
&НаСервере
Процедура ОпределитьРолиПользователя()
	...
	ГруппыИсполнителяЗадач = Новый ФиксированныйМассив(
		ОбщегоНазначенияКлиентСервер.СвернутьМассив(Результат.ВыгрузитьКолонку("ГруппаИсполнителейЗадач")));
	РолиИсполнителя        = Новый ФиксированныйМассив(
		ОбщегоНазначенияКлиентСервер.СвернутьМассив(Результат.ВыгрузитьКолонку("РольИсполнителя")));
