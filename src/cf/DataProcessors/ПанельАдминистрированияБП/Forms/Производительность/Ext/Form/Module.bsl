...
&НаКлиенте
Процедура ОтображатьОстаткиИЦеныВСпискеТоварыПриИзменении(Элемент)
...
&НаКлиенте
Процедура ОтображатьОстаткиПоВзаиморасчетамВСпискеКонтрагентовПриИзменении(Элемент)
...
Процедура ОпределитьНедоступныеНастройки()
	...
	Если Не ОбщегоНазначенияБП.ЭтоПростойИнтерфейс() Тогда
		НедоступныеНастройки.Вставить("ОтображатьОстаткиИЦеныВСпискеТовары");
		НедоступныеНастройки.Вставить("ОтображатьОстаткиПоВзаиморасчетамВСпискеКонтрагентов");
	КонецЕсли;
