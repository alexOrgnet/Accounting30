...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ПодключенаИнтернетПоддержка Тогда
		...
		РегистрационныйНомер = РегистрационныйНомерПрограммногоПродукта();
	КонецЕсли;
...
Процедура ДобавитьАвтоВложения()
	...
	Если ДобавитьНастройкиПрограммы Тогда
		...
		НовоеВложение.АдресВоВременномХранилище = Обработки.ОбращениеВТехническуюПоддержку.ИнформацияОНастройкахПрограммы(ПараметрыАвтоВложений);
	КонецЕсли;
...
Функция РегистрационныйНомерПрограммногоПродукта() Экспорт
	...
	УстановитьПривилегированныйРежим(Истина);
	Возврат ОбщегоНазначения.ПрочитатьДанныеИзБезопасногоХранилища(ИнтернетПоддержкаПользователей.ИдентификаторПодсистемы(), "regnumber");
