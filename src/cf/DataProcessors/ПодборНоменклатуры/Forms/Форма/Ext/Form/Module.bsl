...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	ИначеЕсли Источник = "ПодключаемоеОборудование" И ВводДоступен() Тогда
		Если ИмяСобытия = "ScanData" Тогда
			...
			РезультатПоиска = НоменклатураПоШтрихкоду(ДанныеСоСканераСтруктура);
...
&НаСервереБезКонтекста
Функция НоменклатураПоШтрихкоду(ДанныеСоСканераСтруктура)

	ТаблицаШтрихкодов = РегистрыСведений.ШтрихкодыНоменклатуры.НоменклатураПоШтрихкоду(ДанныеСоСканераСтруктура.Штрихкод);
