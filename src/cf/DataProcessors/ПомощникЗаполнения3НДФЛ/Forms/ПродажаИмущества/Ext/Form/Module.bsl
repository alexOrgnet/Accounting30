...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Отчеты.РегламентированныйОтчет3НДФЛ.МожноНеУказыватьНаименованиеИсточникаДохода(ВыбраннаяФорма) Тогда
...
Процедура КомандаОК(Команда)
	...
	СтруктураДанныхОтчетности.Вставить("ВидИмущества",
		?(ВидИмущества = "Доля" И ПроданаТолькоЭтаДоля, "Жилая", ВидИмущества));
...
Функция ОписаниеОперацииПоВидуИмущества(ВидИмущества)
	...
	ИначеЕсли ВидИмущества = ПомощникЗаполнения3НДФЛКлиентСервер.ВидДоходаКриптовалюта() Тогда
...
Процедура УстановитьВидимостьПоВидуИмущества(Форма)
	...
	ИначеЕсли Форма.ВидИмущества = ПомощникЗаполнения3НДФЛКлиентСервер.ВидДоходаКриптовалюта()
		И РасширенныйСписокПрочегоИмущества Тогда
...
Функция УчитыватьИспользованныйВычетНаПрочееИмущество(ВидИмущества)
	...
	ДопустимыйВидИмущества.Добавить("Автомобиль");
	ДопустимыйВидИмущества.Добавить(ПомощникЗаполнения3НДФЛКлиентСервер.ВидДоходаКриптовалюта());
	ДопустимыйВидИмущества.Добавить("ПрочееИмущество");
...
Функция КодВидаДоходаПоВидуПроданногоИмущества(ВидИмущества, ДоходОпределенПоСуммеДоговора, ВыбраннаяФорма)
	...
	КодыВидовДоходовРФ = Отчеты.РегламентированныйОтчет3НДФЛ.КодыВидовДоходовРФ(ВыбраннаяФорма);
	ПереченьДоходовРасширен = ПомощникЗаполнения3НДФЛКлиентСервер.ВычетыРаспределяютсяПоДоходам(ВыбраннаяФорма);
	
	Если ПереченьДоходовРасширен И ВидИмущества = ПомощникЗаполнения3НДФЛКлиентСервер.ВидДоходаКриптовалюта() Тогда
	...
	ИначеЕсли (ВидИмущества = "Жилая" Или ВидИмущества = "Доля") И ДоходОпределенПоСуммеДоговора Тогда
