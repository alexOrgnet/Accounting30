...
Функция КодПрочегоДоходаЗаПределамиРФ(Знач ВыбраннаяФорма, Знач ВидДохода)
	...
	Если ПереченьДоходовРасширен И ВидДохода = ПомощникЗаполнения3НДФЛКлиентСервер.ВидДоходаКриптовалюта() Тогда
		Возврат КодыВидовДоходовЗаПределамиРФ.ОперацииСКриптовалютой;
	ИначеЕсли ПереченьДоходовРасширен И ВидДохода = "Роялти" Тогда
		Возврат КодыВидовДоходовЗаПределамиРФ.Роялти_ЗаПределамиРФ;
	ИначеЕсли ПереченьДоходовРасширен Тогда
		Возврат КодыВидовДоходовЗаПределамиРФ.ИнойДоходПоПрогрессивнойШкале;
	ИначеЕсли КодыВидовДоходовЗаПределамиРФ.Свойство("Иной", КодВидаДохода) Тогда
