...
Функция РассчитатьСуммуПоложенногоВычета(Форма)
	...
	Если Форма.ИспользоватьВычет Тогда
	...
	Результат = Новый Структура("СуммаВычета, РазмерыВычетов, СтруктураДанныхДекларации, СуммаВычетаПоМесяцам");
	Результат.СуммаВычета = Форма.СуммаВычета;
	Результат.РазмерыВычетов = РазмерыВычетов;
	Результат.СтруктураДанныхДекларации = СтруктураДанныхДекларации;
	Результат.СуммаВычетаПоМесяцам = СуммаВычетаПоМесяцам;
