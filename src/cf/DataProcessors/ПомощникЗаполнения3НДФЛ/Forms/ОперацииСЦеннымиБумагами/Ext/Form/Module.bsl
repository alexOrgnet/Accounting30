...
Функция СохранитьДанныеФормы()
	...
	КодыДоходовИИС = Обработки.ПомощникЗаполнения3НДФЛ.КодыВидовДоходовЦенныеБумаги().ИИС;
...
Функция СохранитьДанныеДекларации()
	...
	ТаблицаДоходов.Колонки.Добавить("ВидДоходаДекларация", ОбщегоНазначения.ОписаниеТипаСтрока(2));
...
Функция КодыДоходовПоЦеннымБумагам(ВыбраннаяФорма)
	...
	КодыВидовДоходов = Обработки.ПомощникЗаполнения3НДФЛ.КодыВидовДоходовЦенныеБумаги();
