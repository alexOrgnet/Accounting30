...
Процедура ОткрытьФормуНастройкиИсключений(ИмяПараметраНастройки)
	...
	ОткрытьФорму(
		"Обработка.ПанельАдминистрированияИСМП.Форма.НастройкиКонтроляКодовМаркировки",
...
Процедура НастроитьЭлементыФормы()
	...
	ВключенаНикотиносодержащаяПродукция = ИнтеграцияИСМПВызовСервера.ВестиУчетМаркируемойПродукции(
	...
	Элементы.ГруппаНастройкиРаботыСМернымТоваром.Видимость = ИнтеграцияИС.ЕстьПродукцияТребующаяВзвешивания();
