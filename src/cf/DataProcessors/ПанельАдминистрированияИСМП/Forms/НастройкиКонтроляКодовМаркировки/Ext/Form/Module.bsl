...
Процедура ТаблицаНастроекПредставлениеЗначенияНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ПоказыватьПодсказкуОграниченияИсключений = ТекущиеДанные.Настройка = ПредопределенноеЗначение("Перечисление.ВидыОперацийИСМП.ВыводИзОборотаРозничнаяПродажа")
	...
	Если ВариантОтображения = ВариантПоВидамПродукции() Тогда
		...
		Для Каждого ЭлементВидОперации Из ДопустимыеВидыОпераций Цикл
			...
			Если ЭлементВидОперации.Значение = ПредопределенноеЗначение("Перечисление.ВидыОперацийИСМП.ВыводИзОборотаРозничнаяПродажа")
	...
	Иначе
		...
		Для Каждого ЭлементВидПродукции Из УчитываемыеВидыМаркируемойПродукции Цикл
			...
			Если ОбязательныеТГДляПроверкиПриРозничнойПродаже.НайтиПоЗначению(ВидПродукции) <> Неопределено
...
Процедура УстановитьУсловноеОформление()
	...
	ЭлементУсловногоОформления.Оформление.УстановитьЗначениеПараметра("Текст", ПредставлениеВсеЗначения(Вариант, ОбязательныеТГДляПроверкиПриРозничнойПродаже.Количество()));
