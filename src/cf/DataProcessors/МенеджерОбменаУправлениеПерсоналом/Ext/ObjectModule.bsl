...
Процедура ЗаполнитьТипОбъектаАдресРесурса()
	...
	Описание.Вставить(МенеджерТипОбъекта.МашиночитаемаяДоверенностьКЭДО, 		РесурсМашиночитаемыеДоверенностиКЭДО());
...
Функция ВсеРесурсы() Экспорт
	...
	ВсеРесурсы.Добавить(РесурсМашиночитаемыеДоверенностиКЭДО());
...
Функция РесурсМашиночитаемыеДоверенностиКЭДО()
...
Функция РезультатВыгрузкиНастроек(Объект, ТипОбъекта) Экспорт
	...
	ОбъектВыгружен = РезультатВыгрузкиОбъекта(АдресРесурса, ОбъектDTO);
	БылиОшибки = БылиОшибки Или Не ОбъектВыгружен;
