...
Процедура ОткрытьРаботаСОборудованиемРозливаИСМП(Команда)
	...
	ОткрытьФормуСпискаДокументов("РегистрСведений.КегиНаОборудованииРозливаИСМП.Форма.ФормаСписка", Неопределено);
...
Процедура ОткрытьРаботаСОборудованиемРозливаИСМПОтработайте(Команда)
	...
	ОценкаПроизводительностиКлиент.ЗамерВремени("РегистрСведений.КегиНаОборудованииРозливаИСМП.Форма.ФормаСписка.ОткрытиеОсновногоСписка");
	ОткрытьФормуСпискаДокументов("РегистрСведений.КегиНаОборудованииРозливаИСМП.Форма.ФормаСписка", "ВсеТребующиеДействия");
...
Процедура ОткрытьРаботаСОборудованиемРозливаИСМПОжидайте(Команда)
	...
	ОценкаПроизводительностиКлиент.ЗамерВремени("РегистрСведений.КегиНаОборудованииРозливаИСМП.Форма.ФормаСписка.ОткрытиеОсновногоСписка");
	ОткрытьФормуСпискаДокументов("РегистрСведений.КегиНаОборудованииРозливаИСМП.Форма.ФормаСписка", "ВсеТребующиеОжидания");
...
Процедура ОбработкаНавигационнойСсылкиАварийногоРежима(Элемент, НавигационнаяСсылкаФорматированнойСтроки, СтандартнаяОбработка)
	...
	ИначеЕсли НавигационнаяСсылкаФорматированнойСтроки = "ОтключитьАварийныйРежим" Тогда
		...
		ИнтеграцияИСМПВызовСервера.ОтключитьАварийныйРежимРазрешительнойСистемы();
...
Функция ПолучитьПараметрыАварийногоРежима()
	...
	ПараметрыАварийногоРежима = ИнтеграцияИСМППовтИсп.ДанныеНастройкиАварийногоРежима();
...
Процедура ПослеОбработкиФормыУточненияАварийногоРежима(Результат, ДополнительныеПараметры) Экспорт
	...
	Если Результат.Свойство("АктивностьРежима") Тогда
		...
		Если Результат.АктивностьРежима Тогда
			...
			ИнтеграцияИСМПВызовСервера.ВключитьАварийныйРежимРазрешительнойСистемы(Результат.СрокДействияВЧасах);
