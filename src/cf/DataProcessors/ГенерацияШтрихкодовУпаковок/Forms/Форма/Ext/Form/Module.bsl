...
#Область ЗаполняемыеВнеГенератораИдентификаторы
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ГосИС.ИСМП") Тогда
		Модуль = ОбщегоНазначения.ОбщийМодуль("ИнтеграцияИСМПКлиентСерверПовтИсп");
...
Функция ШтрихкодыНоменклатуры(Отбор)
	...
	ШтрихкодированиеИС.ЗаполнитьПроверяемыеGTIN(ТаблицаНоменклатуры, Штрихкоды, СоответствиеGTIN, Ложь);
