...
Процедура СформироватьПечатныеФормы(МассивОбъектов, ПараметрыПечати, ОбъектыПечати, КоллекцияПечатныхФорм)
	...
	Для Каждого ПечатнаяФорма Из ДанныеПечатныхФорм Цикл
		...
		Для каждого ДанныеЭтикетки Из ПечатнаяФорма.ДанныеДляПечатиЭтикеток Цикл
			...
			МакетЭтикетки = ЗаполненныйТабличныйДокумент(Разрешение, ДанныеЭтикетки, СообщениеОбОшибке).ПолучитьОбласть(1, 1, ДанныеЭтикетки.Высота, ДанныеЭтикетки.Ширина);
			...
			МакетЭтикетки.Область(1,1, ДанныеЭтикетки.Высота, ДанныеЭтикетки.Ширина).Обвести(Линия, Линия, Линия, Линия);
