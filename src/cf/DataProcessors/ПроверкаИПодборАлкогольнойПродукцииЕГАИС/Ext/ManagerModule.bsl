...
Процедура ЗагрузитьДанныеДокументаДлительнаяОперация(Параметры, АдресРезультата) Экспорт
	...
	ДанныеДокумента.Вставить("ЧастичноеВыбытиеДоступно",
		Не Параметры.ПроверкаНеПоДокументу И ШтрихкодированиеИС.ТребуетсяЧастичноеВыбытие(
		ШтрихкодированиеИС.ПараметрыСканирования(Параметры.ПроверяемыйДокумент)));
...
Процедура ЗафиксироватьРезультатПроверкиИПодбора(Параметры, АдресРезультата) Экспорт
	...
	Исключение
		...
		ИнтеграцияЕГАИСВызовСервера.ЗаписатьОшибкуВЖурналРегистрации(СтрСоединить(ТекстыСообщенияЖР));
