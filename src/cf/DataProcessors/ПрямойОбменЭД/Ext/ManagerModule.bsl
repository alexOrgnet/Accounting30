...
Функция ТипДокументаПоСтрокеТакском(ТипДокумента) Экспорт
	...
	Если ФорматированнаяСтрока = "account" Тогда
		ВозвращаемоеЗначение = Перечисления.УдалитьТипыПроизвольныхДокументовЭДО.СчетНаОплату;
	ИначеЕсли ФорматированнаяСтрока = "statement" Тогда
		ВозвращаемоеЗначение = Перечисления.УдалитьТипыПроизвольныхДокументовЭДО.АктВыполненныхРабот;
	ИначеЕсли ФорматированнаяСтрока = "consignment" Тогда
		ВозвращаемоеЗначение = Перечисления.УдалитьТипыПроизвольныхДокументовЭДО.ТоварнаяНакладная;
	ИначеЕсли ФорматированнаяСтрока = "paymentorder" Тогда
		ВозвращаемоеЗначение = Перечисления.УдалитьТипыПроизвольныхДокументовЭДО.ПлатежноеПоручение;
	ИначеЕсли ФорматированнаяСтрока = "contract" Тогда
		ВозвращаемоеЗначение = Перечисления.УдалитьТипыПроизвольныхДокументовЭДО.Договор;
	ИначеЕсли ФорматированнаяСтрока = "statementappendix" Тогда
		ВозвращаемоеЗначение = Перечисления.УдалитьТипыПроизвольныхДокументовЭДО.ПриложениеКАкту;
	ИначеЕсли ФорматированнаяСтрока = "guaranteeletter" Тогда
		ВозвращаемоеЗначение = Перечисления.УдалитьТипыПроизвольныхДокументовЭДО.ГарантийноеПисьмо;
	ИначеЕсли ФорматированнаяСтрока = "formalizedstatementcustomer"
		...
		Тогда
		ВозвращаемоеЗначение = Перечисления.УдалитьТипыПроизвольныхДокументовЭДО.Прочее;
	Иначе
...
Процедура ДополнитьСтруктуруРеквизитовСчета(СтруктураРеквизитов, ЕстьОшибки) Экспорт
	...
	Если Не ЕстьОшибки Тогда
		...
		ЗаполнитьНесопоставленнуюНоменклатуру(СтруктураРеквизитов);
	КонецЕсли;
...
Процедура ЗаполнитьНесопоставленнуюНоменклатуру(Реквизиты)
	
	НесопоставленнаяНоменклатура = ЭлектронноеВзаимодействиеБП.СписокНеСопоставленнойНоменклатуры(
		Реквизиты.Контрагент, Реквизиты.ДанныеРазбора);
	Реквизиты.Вставить("НесопоставленнаяНоменклатура", НесопоставленнаяНоменклатура);
