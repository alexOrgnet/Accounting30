...
Функция ДанныеРаспределенияВычета(Организация, РегистрацияВНалоговомОргане, ИсключаемыйПатент)
	...
	|			ТОГДА Патенты.УдалитьДатаВторогоПлатежа
	|		ИНАЧЕ Патенты.УдалитьДатаПервогоПлатежа
	...
	|	Патенты.УдалитьДатаНачала КАК ПатентДатаНачала,
	|	Патенты.УдалитьДатаОкончания КАК ПатентДатаОкончания,
	|	Патенты.УдалитьДатаВыдачи КАК ПатентДатаВыдачи,
