...
Процедура УстановитьПоляПредставленияСтроки(Форма, ТекущиеДанные)
	...
	ЭтоМолочнаяПродукция   = ИнтеграцияИСКлиентСервер.ЭтоМолочнаяПродукцияИСМП(СтрокаДанных["ВидПродукции"]);
	...
	СкрыватьЭлементыПриОтсутствииДанных.Вставить(
		...
		(ИнтеграцияИСМПКлиентСерверПовтИсп.ПоддерживаетсяЧастичноеВыбытие(СтрокаДанных["ВидПродукции"])
	...
	Если ИнтеграцияИСМПКлиентСерверПовтИсп.ПоддерживаетсяЧастичноеВыбытие(СтрокаДанных["ВидПродукции"])
	...
	Если ЗначениеЗаполнено(СтрокаДанных["ПлановоеКоличествоПотребительскихУпаковок"])
		...
		Если ИнтеграцияИСКлиентСервер.ЭтоПродукцияМОТП(СтрокаДанных.ВидПродукции) Тогда
