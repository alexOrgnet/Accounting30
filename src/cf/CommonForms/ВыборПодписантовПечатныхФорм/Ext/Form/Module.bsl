...
Функция ПользователиСМЧД(СписокПользователей)
	...
	Запрос.Текст =
		...
		|ИЗ
		|	Справочник.СертификатыКлючейЭлектроннойПодписиИШифрования КАК СертификатыКлючейЭлектроннойПодписиИШифрования
		|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Справочник.МашиночитаемыеДоверенностиКЭДО КАК МашиночитаемыеДоверенностиКЭДО
		|		ПО СертификатыКлючейЭлектроннойПодписиИШифрования.ФизическоеЛицо = МашиночитаемыеДоверенностиКЭДО.Представитель
		|			И (МашиночитаемыеДоверенностиКЭДО.Доверитель В (&Организации))
		|ГДЕ
		|	СертификатыКлючейЭлектроннойПодписиИШифрования.Пользователь В(&СписокПользователей)
		...
		|	Справочник.СертификатыКлючейЭлектроннойПодписиИШифрования.Пользователи КАК СертификатыКлючейЭлектроннойПодписиИШифрования
		|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Справочник.МашиночитаемыеДоверенностиКЭДО КАК МашиночитаемыеДоверенностиКЭДО
		|		ПО СертификатыКлючейЭлектроннойПодписиИШифрования.Ссылка.ФизическоеЛицо = МашиночитаемыеДоверенностиКЭДО.Представитель
		|			И (МашиночитаемыеДоверенностиКЭДО.Доверитель В (&Организации))
		|ГДЕ
		|	СертификатыКлючейЭлектроннойПодписиИШифрования.Пользователь В(&СписокПользователей)
		|	И СертификатыКлючейЭлектроннойПодписиИШифрования.Ссылка.Организация = ЗНАЧЕНИЕ(Справочник.Организации.ПустаяСсылка)
