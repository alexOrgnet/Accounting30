...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ПодписыватьСертификатамиГоловнойОрганизации = КадровыйЭДОВызовСервера.ПодписыватьСертификатамиГоловнойОрганизации();
...
Процедура СохранитьНастройкуПодписыватьСертификатамиГоловнойОрганизации(ПодписыватьСертификатамиГоловнойОрганизации)
	...
	КадровыйЭДОВызовСервера.ЗапонитьПодписыватьСертификатамиГоловнойОрганизации(ПодписыватьСертификатамиГоловнойОрганизации);
