...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)           
	...
	ПодробноHTML = "<!DOCTYPE HTML>
			...
			|	</div>
			|    <p>В настоящее время наблюдается нестабильная работа сервера СЭДО СФР. По возможности производите обмен c 20:00 по 08:00 (МСК), избегая пиковых нагрузок." + ?(ЕстьПроблемы, " Ниже перечислены проблемы, возникшие при обмене.", "") + "</p>" 
			...
			|<p>Если СФР выставил штрафы, можно обратиться в фирму 1С за помощью по адресу <a href=""mailto:fran@1c.ru"">fran@1c.ru&nbsp;</a>и самостоятельно обжаловать решение СФР. Письмо-справку о технических проблемах, не зависящих от пользователя, можно запросить по адресу <a href=""mailto:hline@1c.ru"">hline@1c.ru</a>. Порядок обжалования решения СФР описан в <a href=""https://its.1c.ru/db/answersbiz/content/4499/hdoc"">статье</a>.</p>
			|</div>
			|</div>
			|</body>
			|</html>";     
