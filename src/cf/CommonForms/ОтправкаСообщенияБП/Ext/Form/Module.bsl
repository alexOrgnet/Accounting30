...
// Построена на базе ОтправкаСообщения из БСП версии 3.1.7.137
...
Функция СформироватьПараметрыПисьма()
	...
	Если ЗначениеЗаполнено(ОписаниеПолучателяВоВременномХранилище) Тогда
		ПолучателиСообщенияИнформационнойБазы = ПолучитьИзВременногоХранилища(ОписаниеПолучателяВоВременномХранилище);
