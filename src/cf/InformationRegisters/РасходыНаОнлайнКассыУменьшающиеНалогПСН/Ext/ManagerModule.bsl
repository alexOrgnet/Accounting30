...
Функция УменьшениеПлатежейПоПатентам(Организация, РегистрацияВНалоговомОргане) Экспорт
	...
	|	РасходыНаОнлайнКассыУменьшающиеНалогПСН.Патент.УдалитьНомерПатента КАК НомерПатента,
	|	РасходыНаОнлайнКассыУменьшающиеНалогПСН.Патент.УдалитьДатаВыдачи КАК ДатаВыдачиПатента,
	...
	|			ТОГДА РасходыНаОнлайнКассыУменьшающиеНалогПСН.Патент.УдалитьДатаВторогоПлатежа
	|		ИНАЧЕ РасходыНаОнлайнКассыУменьшающиеНалогПСН.Патент.УдалитьДатаПервогоПлатежа
	...
	|		ИНАЧЕ РасходыНаОнлайнКассыУменьшающиеНалогПСН.Патент.УдалитьДатаПервогоПлатежа
	|	КОНЕЦ,
	|	РасходыНаОнлайнКассыУменьшающиеНалогПСН.Патент.УдалитьНомерПатента,
	|	РасходыНаОнлайнКассыУменьшающиеНалогПСН.Патент.УдалитьДатаВыдачи
	|
	|УПОРЯДОЧИТЬ ПО
	|	РасходыНаОнлайнКассыУменьшающиеНалогПСН.Патент.УдалитьДатаОкончания,
	|	РасходыНаОнлайнКассыУменьшающиеНалогПСН.Патент.УдалитьДатаНачала,
	|	Патент,
	|	СрокПлатежа"
	;
...
Функция ПлатежиПодлежащиеУменьшению(Организация, РегистрацияВНалоговомОргане)
	...
	|	СправочникПатенты.УдалитьДатаНачала КАК ДатаНачала,
	|	СправочникПатенты.УдалитьДатаОкончания КАК ДатаОкончания,
	|	СправочникПатенты.УдалитьСуммаПервогоПлатежа КАК СуммаПервогоПлатежа,
	|	СправочникПатенты.УдалитьДатаПервогоПлатежа КАК ДатаПервогоПлатежа,
	|	СправочникПатенты.УдалитьСуммаВторогоПлатежа КАК СуммаВторогоПлатежа,
	|	СправочникПатенты.УдалитьДатаВторогоПлатежа КАК ДатаВторогоПлатежа,
	|	ВЫБОР
	|		КОГДА СправочникПатенты.УдалитьСуммаВторогоПлатежа > 0
	|			ТОГДА ИСТИНА
	|		ИНАЧЕ ЛОЖЬ
	...
	|	И СправочникПатенты.УдалитьДатаНачала >= &НачалоПримененияВычета
	|	И СправочникПатенты.УдалитьДатаОкончания <= &ОкончаниеПримененияВычета
	|	И ВЫБОР
	|			КОГДА СправочникПатенты.УдалитьПостановкаНаУчетВНалоговомОргане = ЗНАЧЕНИЕ(Перечисление.ПостановкаНаУчетВНалоговомОргане.ВДругомНалоговомОргане)
	|				ТОГДА СправочникПатенты.УдалитьНалоговыйОрган = &РегистрацияВНалоговомОргане
