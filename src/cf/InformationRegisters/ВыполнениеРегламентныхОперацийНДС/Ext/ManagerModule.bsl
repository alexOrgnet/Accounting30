...
Процедура ОпределитьНеобходимостьКонтроляОпераций(Организация, ПериодРегистрации, ДеревоОпераций) Экспорт
	...
	ПараметрыПоискаАвансов = Обработки.РегистрацияСчетовФактурНаАванс.ПараметрыЗаполнения();
	ПараметрыПоискаАвансов.Организация		= Организация;
	ПараметрыПоискаАвансов.НачалоПериода	= ПериодРегистрации;
	ПараметрыПоискаАвансов.КонецПериода		= КонецКвартала(ПериодРегистрации);
	ПараметрыПоискаАвансов.ЗаТекущийПериод 	= Истина;
	
	ТаблицаАвансов = Обработки.РегистрацияСчетовФактурНаАванс.ЗаполнитьСтроки(ПараметрыПоискаАвансов);
