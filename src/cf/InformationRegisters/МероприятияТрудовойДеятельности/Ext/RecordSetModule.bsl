...
Процедура ПередЗаписью(Отказ, Замещение)
	...
	Если Не РезультатЗапроса.Пустой() Тогда
		...
		Запрос.Текст =
			...
			|	ТекущийНабор.СрочночтьТрудовогоДоговора КАК СрочночтьТрудовогоДоговора,
			...
			|				ИЛИ ТекущийНабор.СрочночтьТрудовогоДоговора = НовыйНабор.СрочночтьТрудовогоДоговора
			...
			|	Изменения.СрочночтьТрудовогоДоговора КАК СрочночтьТрудовогоДоговора,
	...
	Запрос.Текст =
		...
		|				ИЛИ НовыйНабор.СрочночтьТрудовогоДоговора = МероприятияПрочие.СрочночтьТрудовогоДоговора
	...
	Для Каждого Запись Из ЭтотОбъект Цикл
		...
		Если Не ЗначениеЗаполнено(Запись.ИдМероприятия) Тогда
			...
			Если Запись.ДатаМероприятия >= ПерсонифицированныйУчетКлиентСервер.ДатаПостановленияЕФС1_2023() Тогда
				СтруктураПоиска.Вставить("СрочночтьТрудовогоДоговора");
