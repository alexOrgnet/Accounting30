...
Функция ВидыПродукцииОтбора(ВидПродукцииОтбора)
	...
	ВидыПродукцииОтбора = Новый Массив;
	Если ИнтеграцияИСКлиентСервер.ЭтоМолочнаяПродукцияИСМП(ВидПродукцииОтбора) Тогда
	...
	ИначеЕсли ИнтеграцияИСПовтИсп.ЭтоПродукцияМОТП(ВидПродукцииОтбора) Тогда
