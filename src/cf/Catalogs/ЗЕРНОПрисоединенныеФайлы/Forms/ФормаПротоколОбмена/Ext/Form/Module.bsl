...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИнтеграцияИС.ОтработатьВходящийДокументПротоколаОбмена(ЭтотОбъект, "СсылкаНаОбъект", "СсылкаНаОбъект");
...
Процедура ПоказатьСообщенияОперации(ВыбраннаяСтрока)
	...
	Иначе
		...
		ИнтеграцияИСКлиент.ПоказатьСообщенияОперации(ЭтотОбъект, ИнтеграцияЗЕРНОКлиентСервер.ИмяПодсистемы(), ВыбраннаяСтрока);
