...
Процедура ПрочитатьСодержаниеФайлаКлассификатора(СожержаниеФайла, ДанныеОбработки, ПараметрыОбмена)
	...
	ОбъектXDTO = ИнтеграцияИС.ПроизвольныйОбъектXDTOПоТекстуСообщенияXML(СожержаниеФайла);
	...
	ПреобразованныйОбъектXDTO = ИнтеграцияИС.ОбъектXDTOПоИмениСвойства(ПространстваИмен, "elevators");
