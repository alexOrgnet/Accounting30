...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОбработкаЗагрузкаДанныхИзТиС = Метаданные.Обработки.ЗагрузкаДанныхИзТиС;
	Элементы.ЗагрузкаДанныхИзТиС.Видимость = 
		ПравоДоступа("Использование", ОбработкаЗагрузкаДанныхИзТиС)
		И ОбщегоНазначения.ОбъектМетаданныхДоступенПоФункциональнымОпциям(ОбработкаЗагрузкаДанныхИзТиС);
...
Процедура ЗагрузкаДанныхИзТиС(Команда)
	...
	ОткрытьФорму("Обработка.ЗагрузкаДанныхИзТиС.Форма");
