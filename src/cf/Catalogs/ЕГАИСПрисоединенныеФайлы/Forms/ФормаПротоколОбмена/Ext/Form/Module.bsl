...
Процедура ЗаполнитьПоОснованиюДокументаАктСписанияЕГАИС(ДокументОснование)
	...
	ОбновитьФорматированнуюСтрокуВводаНаОсновании(ТаблицаДокументы, МетаданныеДокумента, СтатусыОформления);
...
&НаСервере
Процедура ЗаполнитьПоОснованиюДокументаУведомлениеОПланируемомИмпортеЕГАИС(ДокументОснование)
...
&НаСервере
Процедура ЗаполнитьПоОснованиюДокументаОтчетОПроизводствеЕГАИС(ДокументОснование)
...
&НаСервере
Процедура ОбновитьФорматированнуюСтрокуВводаНаОсновании(ТаблицаДокументы, МетаданныеДокумента, СтатусыОформления)
...
Процедура ЗаполнитьДеревоФайлов()
	...
	Если Метаданные.Документы.УведомлениеОПланируемомИмпортеЕГАИС.Реквизиты.ДокументОснование.Тип.Типы().Найти(ТипДокумента) <> Неопределено
		...
		ЗаполнитьПоОснованиюДокументаУведомлениеОПланируемомИмпортеЕГАИС(Документ);
		ЭтоДокументОснование = Истина;
	...
	Если Метаданные.Документы.ОтчетОПроизводствеЕГАИС.Реквизиты.ДокументОснование.Тип.Типы().Найти(ТипДокумента) <> Неопределено
		...
		ЗаполнитьПоОснованиюДокументаОтчетОПроизводствеЕГАИС(Документ);
		ЭтоДокументОснование = Истина;
