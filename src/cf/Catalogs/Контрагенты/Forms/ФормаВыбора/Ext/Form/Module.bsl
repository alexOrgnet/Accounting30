...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ГруппаСвойстваКонтрагента.Видимость = ЭтоПростойИнтерфейс;
...
Процедура ОбновитьСвойстваТекущегоКонтрагента()
	...
	ИначеЕсли Элементы.ГруппаСвойстваКонтрагента.Видимость Тогда
		...
		КонтрагентНеоплаченныеСчета = ?(СвойстваКонтрагента.НеоплаченныеСчетаПокупателемКоличество = 0, "0 ",
			СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='%1 на %2'"),
				СвойстваКонтрагента.НеоплаченныеСчетаПокупателемКоличество,
				Формат(СвойстваКонтрагента.НеоплаченныеСчетаПокупателемСумма, "ЧН=0")));
