...
Функция ДанныеОбъекта(ЭлементДанных) Экспорт
	...
	ДанныеМестаХранения.Вставить("ДатаСоздания",                ИнтеграцияИС.ДатаИзСтрокиUNIX(ЭлементДанных.sys_timeFrom));
	ДанныеМестаХранения.Вставить("ДатаИзменения",               ИнтеграцияИС.ДатаИзСтрокиUNIX(ЭлементДанных.sys_changedAt));
