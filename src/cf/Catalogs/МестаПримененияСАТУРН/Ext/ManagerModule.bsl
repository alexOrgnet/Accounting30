...
Функция ДанныеОбъекта(ЭлементДанных) Экспорт
	...
	ДанныеМестаПрименения.Вставить("ДатаСоздания",  ИнтеграцияИС.ДатаИзСтрокиUNIX(ЭлементДанных.sys_timeFrom));
	ДанныеМестаПрименения.Вставить("ДатаИзменения", ИнтеграцияИС.ДатаИзСтрокиUNIX(ЭлементДанных.sys_changedAt));
