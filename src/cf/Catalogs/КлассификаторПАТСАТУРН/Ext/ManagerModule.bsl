...
Функция ДанныеОбъекта(ЭлементДанных) Экспорт
	...
	ДанныеПАТ.Вставить("ДатаСоздания",                    ИнтеграцияИС.ДатаИзСтрокиUNIX(ЭлементДанных.sys_timeFrom));
	ДанныеПАТ.Вставить("ДатаИзменения",                   ИнтеграцияИС.ДатаИзСтрокиUNIX(ЭлементДанных.sys_changedAt));
