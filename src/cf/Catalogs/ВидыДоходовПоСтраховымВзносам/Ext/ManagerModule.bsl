...
Процедура ЗаполнитьВидыДоходовПоСтраховымВзносам()
	...
	ДобавитьНеоблагаемыеВыплатыСтудентам();
...
Процедура ДобавитьНеоблагаемыеВыплатыСтудентам() Экспорт

	ОписатьВидДоходаПоСтраховымВзносам("МатпомощьСтудентовИзСтудотряда",	
		НСтр("ru='Материальная помощь, выплачиваемая студентам студотрядов и облагаемая страховыми взносами частично'"), Ложь, Истина, Истина, Истина, 44, Истина, , Истина);
	ОписатьВидДоходаПоСтраховымВзносам("МатпомощьПриРожденииРебенкаСтудентовИзСтудотряда",	
		НСтр("ru='Материальная помощь при рождении ребенка, выплачиваемая студентам студотрядов и облагаемая страховыми взносами частично'"), Ложь, Истина, Истина, Истина, 45, Истина, , Истина);
	ОписатьВидДоходаПоСтраховымВзносам("НеОблагаетсяЦеликомСтудентовИзСтудотряда",	
		НСтр("ru='Доходы студентов за работу в студотряде, целиком не облагаемые страховыми взносами'"), Ложь, Ложь, Ложь, Ложь, 46); 
