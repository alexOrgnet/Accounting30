...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ВедетсяУчетПрослеживаемыхТоваров Тогда
		ЕстьИсторияРеквизитовПрослеживаемости = Объект.ИсторияПрослеживаемогоТовара.Количество() > 1;
		Если ЕстьИсторияРеквизитовПрослеживаемости Тогда
			АктуальныеРеквизитыПрослеживаемости = Справочники.Номенклатура.ПризнакПрослеживаемостиНаДату(Объект.Ссылка, ТекущаяДатаПользователя);
		КонецЕсли;
		Если АктуальныеРеквизитыПрослеживаемости <> Неопределено Тогда
			Если АктуальныеРеквизитыПрослеживаемости.ПрослеживаемыйТовар Тогда
				ГосударственныйКонтроль = "ПрослеживаемыйТовар";
			ИначеЕсли АктуальныеРеквизитыПрослеживаемости.ПрослеживаемыйКомплект Тогда
		...
		Элементы.ГосударственныйКонтроль.ТолькоПросмотр = ЕстьИсторияРеквизитовПрослеживаемости
			И Не ГосударственныйКонтроль = "";
	КонецЕсли;
	Элементы.ИсторияПрослеживаемогоТовара.Видимость = ЕстьИсторияРеквизитовПрослеживаемости Или Объект.ПрослеживаемыйТовар Или Объект.ПрослеживаемыйКомплект;
	...
	Если Не Параметры.Ключ.Пустая() Тогда
		ЭтоАлкогольнаяПродукция = ИнтеграцияИСМПБПВызовСервера.ЭтоАлкогольнаяПродукция(Объект.Ссылка);
...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	Если Не ЕстьИсторияРеквизитовПрослеживаемости Тогда
	...
	КонецЕсли;
	ТекущийОбъект.БезалкогольноеПиво		   			= ГосударственныйКонтроль = "БезалкогольноеПиво";
	ТекущийОбъект.СоковаяПродукция			   			= ГосударственныйКонтроль = "СоковаяПродукция";
	ТекущийОбъект.Зерно						   			= ГосударственныйКонтроль = "Зерно";
	ТекущийОбъект.ПродуктыПереработкиЗерна	   			= ГосударственныйКонтроль = "ПродуктыПереработкиЗерна";
	ТекущийОбъект.МорепродуктыПодконтрольныеВЕТИС 		= ГосударственныйКонтроль = "МорепродуктыПодконтрольныеВЕТИС";
	ТекущийОбъект.ЗерноВЕТИС							= ГосударственныйКонтроль = "ЗерноВЕТИС";
	ТекущийОбъект.ПродуктыПереработкиЗернаВЕТИС			= ГосударственныйКонтроль = "ПродуктыПереработкиЗернаВЕТИС";
	ТекущийОбъект.ПодконтрольнаяПродукцияСАТУРН			= ГосударственныйКонтроль = "ПодконтрольнаяПродукцияСАТУРН";
...
Процедура ОбработкаПроверкиЗаполненияНаСервере(Отказ, ПроверяемыеРеквизиты)
	...
	Если (ГосударственныйКонтроль = "ПрослеживаемыйТовар" Или ЕстьПрослеживаемыйТоварВИстории)
...
Процедура ГосударственныйКонтрольПриИзменении(Элемент)
	...
	Элементы.ИсторияПрослеживаемогоТовара.Видимость = ЕстьИсторияРеквизитовПрослеживаемости
		Или ГосударственныйКонтроль = "ПрослеживаемыйТовар" Или ГосударственныйКонтроль = "ПрослеживаемыйКомплект";
	Элементы.ГосударственныйКонтроль.ТолькоПросмотр = ЕстьИсторияРеквизитовПрослеживаемости
		И (ГосударственныйКонтроль = "ПрослеживаемыйТовар" Или ГосударственныйКонтроль = "ПрослеживаемыйКомплект");
...
&НаКлиенте
Процедура ГосударственныйКонтрольОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	
	Если ЕстьИсторияРеквизитовПрослеживаемости И 
		(ГосударственныйКонтроль <> "ПрослеживаемыйТовар" Или ГосударственныйКонтроль <> "ПрослеживаемыйКомплект")
		И (ВыбранноеЗначение = "ПрослеживаемыйТовар" Или ВыбранноеЗначение = "ПрослеживаемыйКомплект") Тогда
		СтандартнаяОбработка = Ложь;
		ОбщегоНазначенияКлиент.СообщитьПользователю(
		Нстр("ru='Для установки признаков прослеживаемости используйте историю'"));
	КонецЕсли;
...
Функция ПараметрыОписанияМаркируемогоТовара(Ссылка, ГосударственныйКонтроль)
	...
	ПараметрыОписанияМаркируемогоТовара.ВидПродукции 									= ИнтеграцияИСМПБПВызовСервера.ВидПродукцииИС(ГосударственныйКонтроль);
...
&НаСервере
Функция ИспользуетсяМаркировка(ГосударственныйКонтроль, ИспользуемыеВидыМаркированнойПродукции)
	
	Возврат ИспользуемыеВидыМаркированнойПродукции.Найти(ГосударственныйКонтроль) <> Неопределено;
...
Процедура ПоказатьДополнительныеРеквизитыПоПрослеживаемости()
	...
	Если ГосударственныйКонтроль = "ПрослеживаемыйТовар" И (ЗначениеЗаполнено(Объект.КодТНВЭД)) Тогда
...
Процедура УстановитьУчетПодконтрольнойПродукции()
	...
	ИспользуемаяМаркировкаТоваров = ИнтеграцияИСМПБПВызовСервера.ПолучитьИспользованиеМаркировки(ТекущаяДата());
	Элементы.ГосударственныйКонтроль.СписокВыбора.Очистить();
	...
	Если Объект.ТабачнаяПродукция
		ИЛИ (ПолучитьФункциональнуюОпцию("ВестиУчетМаркируемойПродукцииИСМП") И ИспользуетсяМаркировка("Табак", ИспользуемаяМаркировкаТоваров)) Тогда
	
		Элементы.ГосударственныйКонтроль.СписокВыбора.Добавить("МОТП", НСтр("ru = 'Табачная продукция'"));
	КонецЕсли; 
	
	Если Объект.ОбувнаяПродукция
	    ИЛИ (ПолучитьФункциональнуюОпцию("ВестиУчетМаркируемойПродукцииИСМП") И ИспользуетсяМаркировка("Обувь", ИспользуемаяМаркировкаТоваров)) Тогда
	...
	Если Объект.ЛегкаяПромышленность
		ИЛИ (ПолучитьФункциональнуюОпцию("ВестиУчетМаркируемойПродукцииИСМП") И ИспользуетсяМаркировка("ЛегкаяПромышленность", ИспользуемаяМаркировкаТоваров)) Тогда
	...
	Если Объект.МолочнаяПродукцияПодконтрольнаяВЕТИС ИЛИ ПолучитьФункциональнуюОпцию("ВестиУчетПодконтрольныхТоваровВЕТИС") 
		ИЛИ ПолучитьФункциональнуюОпцию("ВестиУчетПодконтрольныхТоваровВЕТИСБП") 
		ИЛИ (ПолучитьФункциональнуюОпцию("ВестиУчетМаркируемойПродукцииИСМП") И ИспользуетсяМаркировка("МолочнаяПродукцияПодконтрольнаяВЕТИС", ИспользуемаяМаркировкаТоваров)) Тогда
	...
	Если Объект.МолочнаяПродукцияБезВЕТИС
		ИЛИ (ПолучитьФункциональнуюОпцию("ВестиУчетМаркируемойПродукцииИСМП") И  ИспользуетсяМаркировка("МолочнаяПродукцияБезВЕТИС", ИспользуемаяМаркировкаТоваров)) Тогда
	...
	Если Объект.Шины
		ИЛИ (ПолучитьФункциональнуюОпцию("ВестиУчетМаркируемойПродукцииИСМП") И ИспользуетсяМаркировка("Шины", ИспользуемаяМаркировкаТоваров)) Тогда
	
		Элементы.ГосударственныйКонтроль.СписокВыбора.Добавить("Шины", НСтр("ru = 'Шины и автопокрышки'"));
	КонецЕсли; 
	
	Если Объект.АльтернативныйТабак
		ИЛИ (ПолучитьФункциональнуюОпцию("ВестиУчетМаркируемойПродукцииИСМП") И ИспользуетсяМаркировка("АльтернативныйТабак", ИспользуемаяМаркировкаТоваров)) Тогда
	...
	Если Объект.УпакованнаяВода
		ИЛИ (ПолучитьФункциональнуюОпцию("ВестиУчетМаркируемойПродукцииИСМП") И ИспользуетсяМаркировка("УпакованнаяВода", ИспользуемаяМаркировкаТоваров)) Тогда
	
		Элементы.ГосударственныйКонтроль.СписокВыбора.Добавить("УпакованнаяВода", НСтр("ru = 'Упакованная вода'"));
	КонецЕсли; 
	
	Если Объект.Духи
		ИЛИ (ПолучитьФункциональнуюОпцию("ВестиУчетМаркируемойПродукцииИСМП") И ИспользуетсяМаркировка("Духи", ИспользуемаяМаркировкаТоваров)) Тогда
	
		Элементы.ГосударственныйКонтроль.СписокВыбора.Добавить("Духи", НСтр("ru = 'Духи и туалетная вода'"));
	КонецЕсли; 
	
	Если Объект.Велосипеды
		ИЛИ (ПолучитьФункциональнуюОпцию("ВестиУчетМаркируемойПродукцииИСМП") И ИспользуетсяМаркировка("Велосипеды", ИспользуемаяМаркировкаТоваров)) Тогда
	
		Элементы.ГосударственныйКонтроль.СписокВыбора.Добавить("Велосипеды", НСтр("ru = 'Велосипеды'"));
	КонецЕсли; 
	
	Если Объект.КреслаКоляски
		ИЛИ (ПолучитьФункциональнуюОпцию("ВестиУчетМаркируемойПродукцииИСМП") И ИспользуетсяМаркировка("КреслаКоляски", ИспользуемаяМаркировкаТоваров)) Тогда
	
		Элементы.ГосударственныйКонтроль.СписокВыбора.Добавить("КреслаКоляски", НСтр("ru = 'Медицинские изделия'"));
	КонецЕсли; 
	
	Если Объект.Фотоаппараты
		ИЛИ (ПолучитьФункциональнуюОпцию("ВестиУчетМаркируемойПродукцииИСМП") И ИспользуетсяМаркировка("Фотоаппараты", ИспользуемаяМаркировкаТоваров)) Тогда
	...
	Если Объект.Антисептики
		ИЛИ (ПолучитьФункциональнуюОпцию("ВестиУчетМаркируемойПродукцииИСМП") И ИспользуетсяМаркировка("Антисептики", ИспользуемаяМаркировкаТоваров)) Тогда
		
		Элементы.ГосударственныйКонтроль.СписокВыбора.Добавить("Антисептики", НСтр("ru = 'Антисептики'"));
	КонецЕсли;
	
	Если Объект.БАДы
		ИЛИ (ПолучитьФункциональнуюОпцию("ВестиУчетМаркируемойПродукцииИСМП") И ИспользуетсяМаркировка("БАДы", ИспользуемаяМаркировкаТоваров)) Тогда
		
		Элементы.ГосударственныйКонтроль.СписокВыбора.Добавить("БАДы", НСтр("ru = 'БАДы'"));
	КонецЕсли;
	
	Если Объект.НикотиносодержащаяПродукция
		ИЛИ (ПолучитьФункциональнуюОпцию("ВестиУчетМаркируемойПродукцииИСМП") И ИспользуетсяМаркировка("НикотиносодержащаяПродукция", ИспользуемаяМаркировкаТоваров)) Тогда
		
		Элементы.ГосударственныйКонтроль.СписокВыбора.Добавить("НикотиносодержащаяПродукция", НСтр("ru = 'Никотиносодержащая продукция'"));
	КонецЕсли;
	
	Если Объект.Пиво
		ИЛИ (ПолучитьФункциональнуюОпцию("ВестиУчетМаркируемойПродукцииИСМП") И ИспользуетсяМаркировка("Пиво", ИспользуемаяМаркировкаТоваров)) Тогда
	...
	Если Объект.БезалкогольноеПиво
		ИЛИ (ПолучитьФункциональнуюОпцию("ВестиУчетМаркируемойПродукцииИСМП") И ИспользуетсяМаркировка("БезалкогольноеПиво", ИспользуемаяМаркировкаТоваров)) Тогда
		Элементы.ГосударственныйКонтроль.СписокВыбора.Добавить("БезалкогольноеПиво", НСтр("ru = 'Безалкогольное пиво'"));
	КонецЕсли;
	
	Если Объект.СоковаяПродукция
		ИЛИ (ПолучитьФункциональнуюОпцию("ВестиУчетМаркируемойПродукцииИСМП") И ИспользуетсяМаркировка("СоковаяПродукция", ИспользуемаяМаркировкаТоваров)) Тогда
		Элементы.ГосударственныйКонтроль.СписокВыбора.Добавить("СоковаяПродукция", НСтр("ru = 'Соковая продукция'"));
	КонецЕсли;
	
	Если Объект.Зерно ИЛИ ПолучитьФункциональнуюОпцию("ВестиУчетЗернаИПродуктовПереработкиЗЕРНО") Тогда
		Элементы.ГосударственныйКонтроль.СписокВыбора.Добавить("Зерно", НСтр("ru = 'Зерно'"));
		Если ПолучитьФункциональнуюОпцию("ВестиУчетПодконтрольныхТоваровВЕТИС") ИЛИ ПолучитьФункциональнуюОпцию("ВестиУчетПодконтрольныхТоваровВЕТИСБП") Тогда
			Элементы.ГосударственныйКонтроль.СписокВыбора.Добавить("ЗерноВЕТИС", НСтр("ru='Зерно подконтрольное ВетИС (фуражное зерно)'"));
		КонецЕсли;
	КонецЕсли;
	
	Если Объект.ПродуктыПереработкиЗерна ИЛИ ПолучитьФункциональнуюОпцию("ВестиУчетЗернаИПродуктовПереработкиЗЕРНО") Тогда
		Элементы.ГосударственныйКонтроль.СписокВыбора.Добавить("ПродуктыПереработкиЗерна", НСтр("ru = 'Продукты переработки зерна'"));
		Если ПолучитьФункциональнуюОпцию("ВестиУчетПодконтрольныхТоваровВЕТИС") ИЛИ ПолучитьФункциональнуюОпцию("ВестиУчетПодконтрольныхТоваровВЕТИСБП") Тогда
			Элементы.ГосударственныйКонтроль.СписокВыбора.Добавить("ПродуктыПереработкиЗернаВЕТИС", НСтр("ru = 'Продукты переработки зерна, подконтрольные ВетИС'"));
		КонецЕсли;
	КонецЕсли;
	
	Если Объект.МорепродуктыПодконтрольныеВЕТИС ИЛИ ПолучитьФункциональнуюОпцию("ВестиУчетПодконтрольныхТоваровВЕТИС") 
		ИЛИ ПолучитьФункциональнуюОпцию("ВестиУчетПодконтрольныхТоваровВЕТИСБП") ИЛИ ИспользуетсяМаркировка("МорепродуктыПодконтрольныеВЕТИС", ИспользуемаяМаркировкаТоваров) Тогда
			Элементы.ГосударственныйКонтроль.СписокВыбора.Добавить("МорепродуктыПодконтрольныеВЕТИС", НСтр("ru = 'Морепродукты'"));
	КонецЕсли;
	
	Если Объект.ПодконтрольнаяПродукцияСАТУРН ИЛИ ПолучитьФункциональнуюОпцию("ВестиУчетПестицидовАгрохимикатовТукосмесейСАТУРН") Тогда
		Элементы.ГосударственныйКонтроль.СписокВыбора.Добавить("ПодконтрольнаяПродукцияСАТУРН", НСтр("ru = 'Подконтрольная продукция ФГИС Сатурн'"));
	КонецЕсли;
	
	Элементы.ГосударственныйКонтроль.СписокВыбора.СортироватьПоПредставлению(НаправлениеСортировки.Возр);
	Элементы.ГосударственныйКонтроль.СписокВыбора.Вставить(0,"","Нет");
	...
	ИначеЕсли Объект.БезалкогольноеПиво Тогда
		ГосударственныйКонтроль = "БезалкогольноеПиво";
	ИначеЕсли Объект.СоковаяПродукция Тогда
		ГосударственныйКонтроль = "СоковаяПродукция";
	ИначеЕсли Объект.Зерно Тогда
		ГосударственныйКонтроль = "Зерно";
	ИначеЕсли Объект.ПродуктыПереработкиЗерна Тогда
		ГосударственныйКонтроль = "ПродуктыПереработкиЗерна";
	ИначеЕсли Объект.ПродуктыПереработкиЗернаВЕТИС Тогда
		ГосударственныйКонтроль = "ПродуктыПереработкиЗернаВЕТИС";
	ИначеЕсли Объект.ЗерноВЕТИС  Тогда
		ГосударственныйКонтроль = "ЗерноВЕТИС";
	ИначеЕсли Объект.МорепродуктыПодконтрольныеВЕТИС Тогда
		ГосударственныйКонтроль = "МорепродуктыПодконтрольныеВЕТИС";
	ИначеЕсли Объект.ПодконтрольнаяПродукцияСАТУРН Тогда
		ГосударственныйКонтроль = "ПодконтрольнаяПродукцияСАТУРН";
	КонецЕсли;
...
Процедура ВывестиОписаниеМаркируемогоТовараНаСервере()
	...
	ПараметрыОписанияМаркируемогоТовара = ПараметрыОписанияМаркируемогоТовара(Объект.Ссылка, ГосударственныйКонтроль);
	Если Не ЗначениеЗаполнено(ПараметрыОписанияМаркируемогоТовара.ВидПродукции) И ЭтоАлкогольнаяПродукция Тогда
		ПараметрыОписанияМаркируемогоТовара.ВидПродукции = Перечисления.ВидыПродукцииИС.Алкогольная;
	КонецЕсли;
	ОписаниеМаркируемогоТовара = ИнтеграцияИСВызовСервера.ПредставлениеНастройкиПараметровНоменклатуры(ПараметрыОписанияМаркируемогоТовара);
