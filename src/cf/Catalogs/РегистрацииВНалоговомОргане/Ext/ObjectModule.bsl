...
Процедура ПередЗаписью(Отказ)
	...
	Если Проверять Тогда
		...
		СуществующаяЗапись = Справочники.РегистрацииВНалоговомОргане.ПолучитьПоКодамРегистрациюВИФНС(Ссылка, Владелец, Код, КПП, КодПоОКТМО);
...
Процедура ПриЗаписи(Отказ)
	...
	Если КодыРегионовУплатыТорговогоСбора.Найти(Строка(КодРегиона)) <> Неопределено 
