...
Функция ПараметрыВидОплатыПоРеквизитам(Организация, Контрагент, ДоговорКонтрагента) Экспорт
	
	Реквизиты = Новый Структура;
	Реквизиты.Вставить("Организация", Организация);
	Реквизиты.Вставить("ТипОплаты", Перечисления.ТипыОплат.ПлатежнаяКарта);
...
Процедура ПроверитьСоздатьВидОплаты(Объект, СвойстваПлатежа) Экспорт
	...
	Если Объект.СуммаДокумента + Объект.СуммаУслуг > 0 Тогда
