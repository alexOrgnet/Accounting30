...
Процедура ОбновитьЭлементыГруппыПараметрыНазначения(Группа, Представление, Заполнена, Развернута, Видимость)
	...
	Элементы.СоставСтрахователейЗаДваГода.Видимость = ЭтоОбычныйБольничный Или ЭтоБольничныйПоБиР
		Или (Особенности.Версия_2_36 И ЭтоОтпускПоУходу);
	...
	Элементы.ВыборПодтвержденЗастрахованнымЛицом.Видимость = ЭтоОбычныйБольничный Или ЭтоБольничныйПоБиР
		Или ЭтоОтпускПоУходу;
