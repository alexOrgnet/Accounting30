...
Процедура ЗаполнитьПоДокументуОснованию(Основание, ВидОперацииЗаполнения = Неопределено) Экспорт
	...
	ИначеЕсли ТипЗнч(Основание) = Тип("ДокументСсылка.РеализацияТоваровУслуг")
		...
		ЗначенияРеквизитов = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Основание, "Организация, Грузоотправитель, Грузополучатель, ОтпускПроизвел, СопроводительныеДокументы, ЭтапГосконтрактаЕИС");
	Иначе
...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	ТаблицыПоВзаиморасчетам = Документы.КорректировкаРеализации.ПодготовитьТаблицыАвансовОплат(ТаблицаВзаиморасчеты, ПараметрыПроведения.РеализацияРеквизиты);
