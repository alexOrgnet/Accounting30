...
Процедура ДобавитьПоШтрихкодуНаСервере(ШтрихкодВBase64)
	...
	РеализацияТоваровУслугФормы.ДобавитьПоШтрихкодуНаСервере(ЭтотОбъект, ШтрихкодированиеИСКлиентСервер.Base64ВШтрихкод(ШтрихкодВBase64));
...
Процедура УстановитьВидимость(Форма)
	...
	Элементы.ФормаВыгрузитьВГИСМ.Видимость = ВидимостьРеквизитовГИСМ;
