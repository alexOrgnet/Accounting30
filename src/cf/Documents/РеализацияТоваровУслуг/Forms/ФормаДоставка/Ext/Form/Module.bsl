...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЗаполнитьЗначенияСвойств(ЭтаФорма, Параметры,
		...
		|АдресДоставки, СтранаРеализации, ДатаДокумента, СведенияОТранспортировкеИГрузе,
		...
		|КраткоеНаименованиеГруза, СопроводительныеДокументы
		|");
...
Процедура ПриЗакрытии(ЗавершениеРаботы)
	...
	Если ПеренестиВДокумент И Модифицированность Тогда
		СтруктураРезультат = Новый Структура("
			...
			|АдресДоставки, СтранаРеализации, Перевозчик, МаркаАвтомобиля, РегистрационныйЗнакАвтомобиля,
			|МаркаПрицепа, РегистрационныйЗнакПрицепа,
