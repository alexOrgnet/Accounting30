...
Процедура УправлениеФормой(Форма)
	...
	Элементы.ДекорацияПустаяСтрокаПатент1.Видимость = Форма.ПрименяетсяУСНПатент И НЕ Форма.ПрименяетсяТолькоУСНПатент;
	Элементы.ДекорацияПустаяСтрокаПатент2.Видимость = Форма.ПрименяетсяУСНПатент И НЕ Форма.ПрименяетсяТолькоУСНПатент;
...
Процедура ОбновитьИтоги(Форма)
	...
	Если Не ЗначениеЗаполнено(Форма.Работы) Тогда
		Форма.Работы = СтрокаУслуг.Номенклатура;
	КонецЕсли;
