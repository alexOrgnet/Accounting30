...
Процедура ЗаполнитьДоступныеВидыУпаковок()
	...
	Если ИнтеграцияИСКлиентСервер.ВидПродукцииИспользуетГрупповыеУпаковки(Объект.ВидПродукции) Тогда
		Элементы.ВидУпаковки.СписокВыбора.Добавить(
			Перечисления.ВидыУпаковокИС.Групповая);
	КонецЕсли;
	Если ИнтеграцияИСКлиентСервер.ВидПродукцииИспользуетНаборы(Объект.ВидПродукции) Тогда
		Элементы.ВидУпаковки.СписокВыбора.Добавить(
