...
Функция ПоследовательностьОпераций(ДокументСсылка) Экспорт
	...
	ИнтеграцияЕГАИС.ДобавитьОперациюВПоследовательность(Таблица, 0, Исходящий, ОтчетОбИмпорте(), ДокументСсылка);
	ИнтеграцияЕГАИС.ДобавитьОперациюВПоследовательность(Таблица, 0, Входящий,  УведомлениеОРегистрацииДвижения());
	ИнтеграцияЕГАИС.ДобавитьОперациюВПоследовательность(Таблица, 0, Исходящий, ЗапросОтмены(), ДокументСсылка);
...
#КонецОбласти
	...
	ОтчетXDTO = ИнтеграцияЕГАИС.ОбъектXDTO(ПространствоИмен, "RepImportedType_v4");
	...
	ИнтеграцияЕГАИС.ЗаполнитьСвойствоXDTO(Header, "ImportedDate",   Шапка.ДатаВвоза,      СообщениеXML);
	ИнтеграцияЕГАИС.ЗаполнитьСвойствоXDTO(Header, "GTDNUMBER",      Шапка.НомерГТД,       СообщениеXML);
	ИнтеграцияЕГАИС.ЗаполнитьСвойствоXDTO(Header, "GTDDate",        Шапка.ДатаГТД,        СообщениеXML);
	ИнтеграцияЕГАИС.ЗаполнитьСвойствоXDTO(Header, "ContractNUMBER", Шапка.НомерКонтракта, СообщениеXML);
	ИнтеграцияЕГАИС.ЗаполнитьСвойствоXDTO(Header, "ContractDate",   Шапка.ДатаКонтракта,  СообщениеXML);
	ИнтеграцияЕГАИС.ЗаполнитьСвойствоXDTO(Header, "Country",        Шапка.КодСтраны,      СообщениеXML);
	ИнтеграцияЕГАИС.ЗаполнитьСвойствоXDTO(Header, "Note",           Шапка.Примечание ,    СообщениеXML);
	...
	Для Каждого СтрокаТЧ Из ТоварыИтоги Цикл
		...
		ИнтеграцияЕГАИС.ЗаполнитьСвойствоXDTO(Position, "PlannedImport", Детали.ИдентификаторУведомления, СообщениеXML);
