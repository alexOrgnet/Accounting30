...
Процедура ОпределениеПараметровСчетаФактурыНаРеализацию() Экспорт
	...
	ДатаПроверкиПрослеживаемости  = ?(ЗначениеЗаполнено(ДатаИсходногоДокумента), ДатаИсходногоДокумента, Дата);
	ВедетсяУчетПрослеживаемыхТоваров = ПрослеживаемостьБРУ.ВедетсяУчетПрослеживаемыхТоваров(ДатаПроверкиПрослеживаемости);
