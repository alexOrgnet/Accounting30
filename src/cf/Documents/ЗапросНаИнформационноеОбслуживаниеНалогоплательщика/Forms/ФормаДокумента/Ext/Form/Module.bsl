...
Процедура ЗаполнитьСписокВыбораВидаУслуги()
	...
	СписокВыбора.Добавить(ВидыУслугИОН.СправкаОПринадлежностиСуммАгрегированныеДанные);
	СписокВыбора.Добавить(ВидыУслугИОН.СправкаОНаличииСальдо);
	СписокВыбора.Добавить(ВидыУслугИОН.СведенияОбОтрицательномСальдоЕНС);
...
Процедура ЗадатьПравилаОтображенияДат(Форма)
	...
	ПоказыватьПериод = 
		...
		ИЛИ Объект.ВидУслуги = ПредопределенноеЗначение("Перечисление.ВидыУслугПриИОН.СправкаОПринадлежностиСумм")
		ИЛИ Объект.ВидУслуги = ПредопределенноеЗначение("Перечисление.ВидыУслугПриИОН.СправкаОПринадлежностиСуммАгрегированныеДанные")
		ИЛИ Объект.ВидУслуги = ПредопределенноеЗначение("Перечисление.ВидыУслугПриИОН.ПредставлениеАктовСверкиРасчетов")
		ИЛИ Объект.ВидУслуги = ПредопределенноеЗначение("Перечисление.ВидыУслугПриИОН.СведенияОбОтрицательномСальдоЕНС");
