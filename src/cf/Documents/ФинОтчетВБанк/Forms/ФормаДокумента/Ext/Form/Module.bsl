...
Функция НачатьПодготовкуФайловДляПодписи(Знач УникальныйИдентификатор, Знач ПараметрыПодписания)
	...
	ПараметрыВыполнения.КлючФоновогоЗадания = ПараметрыПодписания.Идентификатор;
...
Функция ГотовностьКОтправке(Знач ПараметрыПроверки)
	...
	ПараметрыВыполнения.КлючФоновогоЗадания = Строка(ПараметрыПроверки.Предмет.УникальныйИдентификатор());
