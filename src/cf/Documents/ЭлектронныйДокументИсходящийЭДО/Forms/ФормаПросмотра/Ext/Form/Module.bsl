...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	Если ПараметрыЗаписи.Свойство("ЭтоНовыйДокумент") И ПараметрыЗаписи.ЭтоНовыйДокумент Тогда
		...
		Для Каждого ЭлементСхемы Из ПараметрыЗаписи.ЭлементыСхемыРегламента Цикл
			ОписаниеСообщения = ОписаниеСообщения(ЭлементСхемы);
			ОписанияСообщений.Добавить(ОписаниеСообщения);
		КонецЦикла;
		ПараметрыЗаписи.Вставить("ОписанияСообщений", ОписанияСообщений);
		ЭлектронныеДокументыЭДО.ПередЗаписьюНовогоДокумента(ТекущийОбъект, ОписанияСообщений);
	КонецЕсли;
