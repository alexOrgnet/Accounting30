...
Процедура ПриПолученииДанныхНаСервере()
	...
	Иначе
		...
		Если Объект.ПланируемаяДатаВыплаты > УчетЗарплаты.ДатаРазделенияНДФЛ() Тогда
			Налог = Справочники.ВидыНалоговИПлатежейВБюджет.НалогПоВиду(Перечисления.ВидыНалогов.НДФЛ_Дивиденды);
		Иначе
	...
	Если Объект.ПланируемаяДатаВыплаты > УчетЗарплаты.ДатаРазделенияНДФЛ() Тогда
		НалогСПревышения =
			Справочники.ВидыНалоговИПлатежейВБюджет.НалогПоВиду(Перечисления.ВидыНалогов.НДФЛ_Дивиденды_ДоходыСвышеПредельнойВеличины);
	Иначе
		НалогСПревышения =
