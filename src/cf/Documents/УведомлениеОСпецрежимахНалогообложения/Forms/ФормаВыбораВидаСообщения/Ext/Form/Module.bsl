...
&НаСервере
Процедура ДобавитьВеткуЕГРЮЛ_ЕГРИП(КорневойУровень, ФлагиУчета)
	...
	Если ЗначениеЗаполнено(ФлагиУчета) И Не ФлагиУчета.ИнтеграцияСБанком  Тогда
		...
		Для каждого Вид Из Виды Цикл
			ДобавитьВеткуВДеревоУведомлений(ЭлементыПапки,Вид);
		КонецЦикла;
...
Процедура ДобавитьВеткуПрочее(КорневойУровень, ФлагиУчета)
	...
	КонецЕсли;
	ДобавитьВеткуВДеревоУведомлений(ЭлементыПапки, Перечисления.ВидыУведомленийОСпецрежимахНалогообложения.ОтзывБанковскойГарантии);
	ДобавитьВеткуВДеревоУведомлений(ЭлементыПапки, Перечисления.ВидыУведомленийОСпецрежимахНалогообложения.ЗаменаБанковскойГарантии);
	...
	ДобавитьВеткуВДеревоУведомлений(ЭлементыПапки, Перечисления.ВидыУведомленийОСпецрежимахНалогообложения.ПрибытиеГражданинаРФ);
	ДобавитьВеткуВДеревоУведомлений(ЭлементыПапки, Перечисления.ВидыУведомленийОСпецрежимахНалогообложения.УбытиеИностранца);
	ДобавитьВеткуВДеревоУведомлений(ЭлементыПапки, Перечисления.ВидыУведомленийОСпецрежимахНалогообложения.ПрибытиеИностранца);
	ДобавитьВеткуВДеревоУведомлений(ЭлементыПапки, Перечисления.ВидыУведомленийОСпецрежимахНалогообложения.ЗачетСФР);
	ДобавитьВеткуВДеревоУведомлений(ЭлементыПапки, Перечисления.ВидыУведомленийОСпецрежимахНалогообложения.ВозвратСФР);
	ДобавитьВеткуВДеревоУведомлений(ЭлементыПапки, Перечисления.ВидыУведомленийОСпецрежимахНалогообложения.РегистрацияККТ);
	ДобавитьВеткуВДеревоУведомлений(ЭлементыПапки, Перечисления.ВидыУведомленийОСпецрежимахНалогообложения.НаличиеОбъектовНаУчастке);
	Если ЗначениеЗаполнено(ФлагиУчета) И Не ФлагиУчета.ИнтеграцияСБанком Тогда
...
&НаСервере
Процедура ДобавитьВеткуФСРАР(КорневойУровень, ФлагиУчета)
	Если ЗначениеЗаполнено(ФлагиУчета) И ФлагиУчета.СервисЭлектронныхТрудовыхКнижек Тогда
		Возврат;
	КонецЕсли;
...
&НаСервере
Процедура ДобавитьВеткуСправки(КорневойУровень, ФлагиУчета)
	Если ЗначениеЗаполнено(ФлагиУчета) И ФлагиУчета.СервисЭлектронныхТрудовыхКнижек Тогда
		Возврат;
	КонецЕсли;
...
Процедура СформироватьДерево()
	...
	ДобавитьВеткуЕГРЮЛ_ЕГРИП(КорневойУровень, ФлагиУчета);
	...
	ДобавитьВеткуФСРАР(КорневойУровень, ФлагиУчета);
	ДобавитьВеткуСправки(КорневойУровень, ФлагиУчета);
...
Процедура НаложитьОтборы()
	...
	Если ВыбраноУведомлениеДляРегистрацииНовогоПредприятия() Тогда
		// Создается регистрация нового предприятия
		Элементы.Выбрать.Доступность = Истина;
	Иначе
		Элементы.Выбрать.Доступность = ЗначениеЗаполнено(Организация);
	КонецЕсли;
